"""Genera i deck HTML VOL-05 dai capitoli wiki (M-FC05 Authority e regolazione)."""
...
MODULES = [
    {
        ...
        "dir": WIKI / "moduli" / "m-fc05-authority-indipendenti" / "chapters",
        "files": [
            "01-authority-viste-dal-candidato.md",
            "02-indipendenza-governance-accountability-personale.md",
            "03-regolazione-europea-multilivello-reti-autorita.md",
            "04-ciclo-regolatorio-consultazione-air-vir.md",
            "05-vigilanza-istruttoria-ispezioni-dati-prova.md",
            "06-sanzioni-impegni-rimedi-controllo-giurisdizionale.md",
            "07-economia-industriale-regolazione-econometria-contabilita.md",
            "08-agcm-concorrenza-consumatore-pratiche-scorrette.md",
            "09-arera-energia-gas-acqua-rifiuti-tariffe.md",
            "10-agcom-comunicazioni-media-utenti-piattaforme.md",
            "11-consob-mercati-intermediari-tutela-investitore.md",
            "12-banca-italia-ivass-vigilanza-prudenziale.md",
            "13-garante-privacy-poteri-procedimenti-cooperazione.md",
            "14-anac-prevenzione-vigilanza-whistleblowing.md",
            "15-laboratorio-prove-authority.md",
        ],
    },
]
...
def build_deck(ch: dict, next_ch: dict | None, total: int) -> str:
    ...
    slides.append(
        f"""            <section class="slide ancora active">
                ...
                <div class="pad">
                    <p class="kicker reveal">VOL-05 · Capitolo {n}</p>
...
"""
    ...
    slides.append(slide("ivory", inner, "Capitale Personale · VOL-05", f"02 / {total:02d}"))
    ...
    slides.append(slide("pearl", inner, "Capitale Personale · VOL-05", f"03 / {total:02d}"))
    ...
    for title_s, body_s in nuclei[:9]:
        ...
        slides.append(slide(kind, "\n".join(parts), "Capitale Personale · VOL-05", f"{len(slides)+1:02d} / {total:02d}"))
    ...
    slides.append(slide("pearl", inner, "Capitale Personale · VOL-05", f"{len(slides)+1:02d} / {total:02d}"))
    ...
    slides.append(slide("ivory", inner, "Capitale Personale · VOL-05", f"{len(slides)+1:02d} / {total:02d}"))
    ...
    slides.append(slide("ancora", inner, "Capitale Personale · VOL-05", f"{len(slides)+1:02d} / {total:02d}"))
    ...
    if next_ch:
        ...
        nxt_foot = f"VOL-05 · Capitolo {next_ch['n']}"
    else:
        nxt_inner = """                    <p class="kicker reveal">Dal volume al bando</p>
                    <hr class="gold-rule reveal d1" style="margin: 28px 0 36px;">
                    <h2 class="h-display reveal d2" style="font-size: 64px; max-width: 1500px;">VOL-05 · Fine</h2>
...
<head>
    ...
    <title>VOL-05 · Capitolo {n} — {esc(title)}</title>
...
<body data-edit-key="cp-vol05-{n}" data-volume="VOL-05" data-chapter="{n}" data-chapter-title="{esc(title)}" data-source="{esc(source)}">
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>VOL-05 — Capitoli in ordine · Slide staff</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
...
<body>
    <header>
        ...
        <div>
            <p class="kicker">VOL-05 · Indice M-FC05</p>
            <h1>Authority e regolazione</h1>
        </div>
    </header>
    <main>
        <p class="meta"><a href="../index.html" style="color:#D4AF37;text-decoration:none;">← Catalogo</a> · Cartella = numero volume + slug file wiki · 01–15 pronti</p>
        <ol class="chapters">
{chr(10).join(items)}
        </ol>
        <footer>01–07 metodo e poteri · 08–14 authority · 15 laboratorio</footer>
    </main>
</body>
</html>
"""
...
def main() -> None:
    ...
    manifest = {
        ...
        "spec": "wiki/books/vol-05-authority-regolazione/planning/00-scheda-pipeline.md",
        "order": "modulo unico M-FC05, capitoli 01–15",
        "chapters": chapters,
    }
    ...
    for i, ch in enumerate(chapters):
        ...
        print(f"VOL-05 {ch['n']}  {slides_n} slide  {ch['folder']}")
    print(f"generati {len(chapters)} deck VOL-05")
