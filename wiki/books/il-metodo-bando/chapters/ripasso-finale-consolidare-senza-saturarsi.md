---
id: chapter-ripasso-finale-consolidare-senza-saturarsi
type: chapter
...
canonical: true
tags: ["book-chapter", "extra-chapter", "final-review", "study-method", "workbook"]
...
Non serve ad aprire tutto.

Serve a chiudere bene.
...
- distinguere ripasso, recupero, simulazione e saturazione;
- scegliere quali nuclei tenere vivi negli ultimi giorni;
- usare Diario degli errori e schede operative come regia del ripasso;
- costruire un fascicolo finale leggero e utilizzabile;
...
Il ripasso finale ha una funzione diversa dallo studio ordinario.

Durante lo studio ordinario puoi aprire un capitolo, costruire una scheda, confrontare fonti, fare esercizi, tornare indietro.
...
| Sezione | Contenuto | Limite pratico |
|---|---|---|
...
Nei sette giorni finali fai tre cose:

- chiudi il fascicolo finale;
...
Quali 10 errori non voglio ripetere?
Quale output devo ancora stabilizzare?
```

### Ultimi 3 giorni: ridurre e stabilizzare

Negli ultimi tre giorni il carico deve scendere.
...
- richiami brevi;
- domande a voce;
- mini-quiz sugli errori;
- scalette sintetiche;
- revisione delle checklist;
- una prova parziale leggera, se serve.
...
- quali distrattori mi attirano?
- quali errori sono da concetto?
...
Per ogni nucleo caldo prepara:

```text
definizione -> funzione -> riferimento sicuro -> esempio -> chiusura
```

Non serve scrivere elaborati lunghi ogni giorno.
...
Non ripassare solo in silenzio.

Negli ultimi giorni servono risposte brevi, ordinate e ripetibili:

- 60 secondi per definire;
- 2 minuti per spiegare;
- 3 minuti per collegare.

Registra solo se ti aiuta.

Se registrarti ti blocca, usa una griglia subito dopo:

| Aspetto | Valutazione |
|---|---|
| Sono partito bene? | |
| Ho definito il concetto? | |
| Ho dato una funzione? | |
| Ho fatto un esempio? | |
| Ho chiuso senza divagare? | |

### Se la prova contiene casi o situazionali

Ripassa sequenze, non frasi fatte.
...
- richiede molte ore senza garanzia;
...
La pausa serve a proteggere esecuzione.

Puoi usare tre livelli:

| Energia | Azione utile |
|---|---|
| Alta | richiamo attivo, simulazione breve, scalette |
| Media | schede operative, quiz errori, ripasso orale |
| Bassa | lettura checklist, nuclei caldi, riordino materiali |
| Minima | pausa, logistica, recupero, niente decisioni drastiche |

Il piano finale deve prevedere energia reale.
...
Costruisce il fascicolo finale:

- una pagina con prove, materie e istruzioni del bando;
- 18 nuclei caldi;
- 12 errori ricorrenti dal Diario;
- 8 schede operative essenziali;
- 2 micro-simulazioni da 30 domande;
- checklist documenti e giorno prova.

Scopre che molti errori non dipendono da mancanza di studio, ma da lettura veloce delle negazioni e confusione tra istituti simili.

Negli ultimi tre giorni non apre il nuovo materiale.
...
Rilegge argomenti marginali.

Scarica nuovi file.

Fa simulazioni senza correggerle.

Passa da un gruppo a un video, da una dispensa a un quiz, da un dubbio a un altro.

Alla fine ha studiato molto, ma non sa che cosa portare in prova.

Il Metodo BANDO chiede una scelta diversa:
...
Costruisci il tuo fascicolo finale.
...
Scegli massimo 10 errori dal Diario.

| Errore | Causa | Azione finale |
|---|---|---|
| | memoria / concetto / lettura / tempo / strategia | |
| | memoria / concetto / lettura / tempo / strategia | |
| | memoria / concetto / lettura / tempo / strategia | |
...
```text
Negli ultimi giorni non apro tutto: tengo vivi __________, recupero __________, lascio __________ e proteggo __________.
```
...
- ho riletto solo le parti operative del bando e degli avvisi?
- ho scelto i nuclei caldi?
- ho ridotto il materiale finale a poche sezioni?
- ho usato il Diario degli errori per decidere il ripasso?
- ho fatto richiamo attivo, non solo rilettura?
- ho corretto almeno una simulazione o prova parziale con criterio?
- ho distinto cosa recuperare e cosa lasciare?
