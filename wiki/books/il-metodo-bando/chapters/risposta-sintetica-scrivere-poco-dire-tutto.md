---
id: chapter-risposta-sintetica-scrivere-poco-dire-tutto
type: chapter
title: "Risposta sintetica: scrivere poco, dire tutto"
status: revised_draft
domain: "concorsi pubblici italiani"
topics: ["risposta sintetica concorsuale", "domande aperte concorsi", "risposta concorsuale", "prova scritta", "prova teorico-pratica", "lettura traccia", "strategia punteggio prova concorsuale", "schede operative studio", "diario errori", "parole chiave concorsi"]
...
canonical: true
tags: ["book-chapter", "extra-chapter", "written-exam", "risposta-sintetica", "workbook"]
book_id: il-metodo-bando
outline_section: 43
draft_stage: revised-editorial-draft
last_compiled_from: ["sources/risposta-sintetica-domande-aperte-metodo-bando.md", "topics/risposta-sintetica-concorsuale.md", "topics/risposta-concorsuale.md", "topics/prova-scritta-teorico-pratica.md", "topics/schede-operative-studio.md", "topics/strategia-punteggio-prova-concorsuale.md", "topics/parole-chiave-concorsi.md", "topics/diario-errori.md"]
---

# R19 - Risposta sintetica: scrivere poco, dire tutto
...
- leggere una domanda aperta breve prima di iniziare a scrivere;
- distinguere definire, illustrare, confrontare, indicare, applicare e motivare;
...
- un riassunto casuale del manuale;
- un tema ridotto;
...
1. il candidato ha capito la traccia;
2. conosce il nucleo essenziale;
...
*Figura 43.1 - Mappa risposta sintetica.*
...
Il candidato forte parte dall’output richiesto.
...
Il verbo della traccia decide la forma della risposta.
...
*Figura 43.2 - Lettura della traccia con estrazione delle informazioni utili.*

Per molte risposte sintetiche puoi usare questo schema:

1. definizione essenziale;
2. riferimento sicuro o principio, solo se serve;
3. funzione;
4. elemento chiave o differenza;
5. esempio, applicazione o conseguenza;
6. chiusura collegata alla traccia.

Non devi usare sempre tutti i passaggi nello stesso modo. Devi adattarli allo spazio.

| Spazio | Struttura consigliata |
|---|---|
| 10 righe | Definizione, funzione, punto chiave, chiusura. |
| 20 righe | Definizione, riferimento sicuro, funzione, elementi, esempio breve. |
| 30 righe | Inquadramento, definizione, sviluppo ordinato, confronto o applicazione, chiusura. |
...
## La risposta in 10 righe

La risposta in 10 righe non perdona le deviazioni.
...
| Riga | Funzione |
|---|---|
| 1-2 | Definizione o inquadramento. |
| 3-5 | Funzione o elementi centrali. |
| 6-8 | Applicazione, differenza o conseguenza. |
| 9-10 | Chiusura sulla traccia. |
...
In 20 righe puoi aggiungere struttura.

Schema pratico:

| Blocco | Funzione |
|---|---|
| Apertura | Inquadra tema e definizione. |
| Sviluppo 1 | Spiega funzione e principi collegati. |
| Sviluppo 2 | Inserisce elementi, differenze o passaggi principali. |
...
> Se tolgo questa frase, la risposta perde punteggio o perde solo volume?

Se perde solo volume, probabilmente puoi tagliarla.
...
5. collegamento con principi o procedimento;
6. esempio o applicazione;
7. eventuale confronto;
8. chiusura.

In 30 righe diventa importante la micro-scaletta. Prima di scrivere, dedica un minuto a questa forma:
...
*Figura 43.3 - Schema essenziale della risposta sintetica.*
...
|---|---|
| Verbo | Distinguere |
| Nucleo | Accesso documentale / accesso civico |
| Parole chiave | interesse, trasparenza, controllo diffuso |
| Esempio | richiesta di un atto vs dati da pubblicare |
| Chiusura | non sono strumenti identici |
...
*Figura 43.4 - Micro-scaletta per ordinare una risposta sotto tempo.*
...
## Riferimenti normativi: solo se sicuri
...
*Figura 43.5 - Selezione delle parole chiave che reggono la risposta.*
...
| Verbo | Ho rispettato il verbo operativo? |
| Struttura | La risposta ha inizio, sviluppo e chiusura? |
| Completezza minima | Manca un elemento indispensabile? |
...
La risposta sintetica migliora solo se correggi gli errori giusti.

Non basta scrivere “risposta insufficiente”.
...
| Mancata applicazione | La traccia chiedeva un caso. | Inserire soggetti, passaggi, soluzione. |
| Chiusura assente | La risposta finisce sospesa. | Preparare frasi di chiusura. |
| Tempo | Risposta incompleta per lentezza. | Micro-scalette e simulazioni cronometrate. |
...
|---|---|
| Verbo | Illustrare |
| Oggetto | Funzione della motivazione |
| Perimetro | Provvedimento amministrativo |
| Errore | Eccesso e fuori traccia parziale |
| Azione | Risposta in 20 righe con funzione al centro |
...
*Figura 43.6 - Griglia per controllare una risposta prima della consegna.*

Non migliori la risposta sintetica solo leggendo esempi.

Devi produrla.

Allenamento in quattro passaggi:

1. scegli un nucleo;
2. scrivi una risposta in 10 righe;
3. riscrivi la stessa risposta in 20 righe;
4. riducila di nuovo a 10 righe senza perdere il nucleo.

Questo esercizio insegna proporzione.

Tabella di lavoro:

| Nucleo | 10 righe | 20 righe | Cosa ho aggiunto | Cosa ho tolto |
|---|---|---|---|---|
| | | | | |
...
| Istituto A | Istituto B | Differenza decisiva | Frase di confronto |
|---|---|---|---|
| | | | |
...
*Figura 43.7 - Caso guidato: ridurre una risposta senza perdere precisione.*
...
Scegli un argomento che hai studiato oggi.

Esegui questi passaggi:

1. scrivi una traccia con un verbo operativo, per esempio “definire”, “illustrare” o “confrontare”;
2. sottolinea oggetto e perimetro;
3. prepara una micro-scaletta in 90 secondi;
4. scrivi una risposta in 10 righe;
5. riscrivila in 20 righe;
6. taglia la risposta da 20 righe riportandola a 10;
...
| Controllo | Fatto |
|---|---|
| Ho letto il verbo operativo della traccia. | |
| Ho individuato oggetto, materia e perimetro. | |
| Ho controllato spazio e tempo disponibili. | |
| Ho scelto il formato: 10, 20 o 30 righe. | |
| Ho fatto una micro-scaletta prima di scrivere. | |
| Ho inserito una definizione essenziale. | |
| Ho usato solo riferimenti sicuri e pertinenti. | |
| Ho spiegato la funzione dell’istituto. | |
| Ho aggiunto esempio, applicazione o differenza se richiesti. | |
| Ho evitato premesse generiche. | |
| Ho chiuso tornando alla traccia. | |
| Ho revisionato pertinenza, ordine, lessico e completezza minima. | |
| Ho registrato l’errore principale nel Diario. | |
