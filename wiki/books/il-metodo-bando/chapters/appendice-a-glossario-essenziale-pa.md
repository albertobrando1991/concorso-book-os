---
id: appendix-a-glossario-essenziale-pa
type: chapter
title: Appendice A - Glossario essenziale della PA
status: revised_draft
domain: concorsi pubblici italiani
topics: ["glossario pa", "pubblica amministrazione", "lessico concorsuale", "procedimento amministrativo", "pa digitale", "contratti pubblici", "contabilità pubblica"]
entities: ["Pubblica amministrazione", "ANAC", "AgID", "RUP", "PEC", "SPID", "CIE", "CIG", "CUP", "inPA"]
...
Questa appendice non va letta come un dizionario completo. Va usata come strumento di lavoro.

Nei concorsi pubblici molte domande non sono difficili perché richiedono nozioni rarissime, ma perché usano parole tecniche molto simili tra loro: accesso documentale, accesso civico, procedimento, provvedimento, PEC, firma digitale, CIG, CUP, RUP, PIAO, performance, trasparenza.
...
| Fase | Uso del glossario | Output |
|---|---|---|
| B - Bando | Riconoscere requisiti, prove, domande, portali e sigle. | Lettura più sicura del bando. |
| A - Aree | Collegare il termine alla materia: amministrativo, impiego, digitale, contratti, contabilità. | Mappa delle aree da ripassare. |
| N - Nuclei | Isolare i concetti ad alta resa. | Lista dei termini da sapere davvero. |
| D - Diario | Registrare le parole confuse. | Ripasso mirato sugli errori. |
| O - Output | Usare il lessico in quiz, scritto, orale e caso pratico. | Risposte più precise. |

## Legenda

| Colonna | Come leggerla |
|---|---|
| Termine | Parola o sigla che può comparire nel bando, nel programma o nella prova. |
| Significato essenziale | Definizione breve, non sostitutiva del capitolo. |
| In prova | Uso pratico o errore da evitare. |

## 1. Bando, domanda, prove e graduatoria

| Termine | Significato essenziale | In prova |
|---|---|---|
| Bando | Atto che disciplina il concorso: requisiti, domanda, prove, materie, scadenze, titoli e criteri. | È la fonte operativa primaria: non sostituirlo con riassunti online. |
...
| Valutazione comparativa | Confronto tra candidati sulla base di criteri predeterminati. | Nei concorsi, criteri e punteggi non vanno immaginati: vanno letti negli atti ufficiali. |
...
## 2. Procedimento, atti e diritto amministrativo
...
| Conflitto di interessi | Situazione in cui un interesse personale può interferire con imparzialità e funzione pubblica. | Nei casi situazionali la risposta corretta segnala e gestisce il conflitto. |
...
| PIAO | Piano integrato di attività e organizzazione. | Integra più dimensioni organizzative; non è un semplice piano anticorruzione. |
| DUP | Documento unico di programmazione degli enti locali. | Nei concorsi enti locali collega programmazione, bilancio e obiettivi. |
| PEG | Piano esecutivo di gestione. | Collega obiettivi, risorse e responsabilità gestionale. |
| URP | Ufficio relazioni con il pubblico. | Nei casi pratici richiama comunicazione, informazione e orientamento al cittadino. |
| Whistleblowing | Segnalazione di illeciti o irregolarità secondo canali e tutele previste. | Non confonderlo con una lamentela generica. |

## 4. Trasparenza, anticorruzione e privacy
...
| DPO o RPD | Responsabile della protezione dei dati. | Supporta e sorveglia il rispetto della disciplina privacy; non decide sempre finalità e mezzi. |
| Bilanciamento | Valutazione tra interessi diversi, ad esempio trasparenza e riservatezza. | Nei casi pratici è spesso la parola che salva la risposta. |

## 5. PA digitale, identità, documenti e servizi
...
| Firma elettronica | Categoria ampia di strumenti di sottoscrizione elettronica. | Distingui firma elettronica, avanzata, qualificata e digitale quando il programma lo richiede. |
| PEC | Posta elettronica certificata, con ricevute di invio e consegna. | Non autentica automaticamente il contenuto come una firma digitale. |
| Domicilio digitale | Indirizzo elettronico usato per comunicazioni aventi valore secondo la disciplina digitale. | Non coincide sempre con una casella email ordinaria. |
| SPID | Sistema pubblico di identità digitale. | Serve per identificazione e accesso ai servizi, non per inviare PEC. |
| CIE | Carta di identità elettronica. | può essere usata anche per accesso digitale ai servizi abilitati. |
| CNS | Carta nazionale dei servizi. | Strumento di accesso ai servizi, spesso tramite certificato digitale. |
| ANPR | Anagrafe nazionale della popolazione residente. | Collega dati anagrafici e servizi digitali. |
...
| Cloud PA | Uso di servizi cloud per dati e servizi pubblici secondo regole e qualificazioni. | Collegalo a sicurezza, continuità e strategia digitale. |
| Cybersecurity | Misure per proteggere sistemi, reti, dati e servizi digitali. | Non è solo antivirus: include organizzazione, prevenzione e risposta. |
| RTD | Responsabile per la transizione digitale. | Figura organizzativa collegata alla trasformazione digitale della PA. |
| Piattaforma notifiche digitali o SEND | Sistema per notifiche digitali di atti della PA, secondo disciplina applicabile. | Distinguila da PEC e semplice email. |

## 6. Contratti pubblici e contabilità essenziale
...
| Operatore economico | Soggetto che offre lavori, servizi o forniture sul mercato. | Non coincide con il cittadino utente. |
| RUP | Responsabile unico del progetto nei contratti pubblici. | Non ridurlo al responsabile del procedimento della Legge 241. |
| CIG | Codice identificativo gara o procedura, collegato a tracciabilità e monitoraggio. | Non confonderlo con il CUP. |
...
Nel bando di un concorso comunale compaiono: PIAO, accesso civico, PEC, CIG, RUP, DUP, prova teorico-pratica e inPA.

Un candidato inesperto li legge come sigle sparse. Un candidato Metodo BANDO li ordina così:

| Sigla o termine | Area | Azione di studio |
|---|---|---|
| inPA | domanda e portale | verificare credenziali, ricevuta e comunicazioni |
| PEC | PA digitale | distinguere canale certificato e firma |
| PIAO | organizzazione PA | collegare organizzazione, anticorruzione, performance |
| Accesso civico | trasparenza | distinguere semplice e generalizzato |
| RUP e CIG | contratti pubblici | collegare soggetti, gara e tracciabilità |
| DUP | enti locali e contabilità | ripassare programmazione |
| Prova teorico-pratica | output | allenare casi e risposta strutturata |

Il glossario non gli dice tutto. Gli dice dove guardare e quale confusione evitare.
...
**La PEC equivale sempre a una firma digitale?**

No. La PEC riguarda il canale di trasmissione e le ricevute di invio e consegna. La firma digitale riguarda la sottoscrizione del documento informatico e la sua riconducibilità al firmatario secondo le regole applicabili. In prova, confondere le due cose è un errore frequente.

## Mini-esercizio

Scegli 15 termini del glossario e compila questa griglia.
...
- Imparare le sigle senza sapere a cosa servono.
- Usare parole simili come sinonimi: procedimento, provvedimento, atto, parere.
- Confondere accesso documentale, accesso civico semplice e accesso civico generalizzato.
- Dire che trasparenza significa pubblicare qualunque dato.
- Confondere PEC, firma digitale, SPID e domicilio digitale.
- Confondere CIG e CUP.
- Ridurre il RUP a una figura generica senza collegarlo al ciclo dei contratti.
- Usare termini di contabilità, come impegno e pagamento, come se fossero la stessa fase.
