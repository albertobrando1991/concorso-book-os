---
id: chapter-trasparenza-anticorruzione-privacy
type: chapter
...
![Figura 7.1 - Trasparenza, anticorruzione e privacy: conoscibilità dell’azione amministrativa, prevenzione del rischio e protezione dei dati personali.](../assets/chapter-07/01-trasparenza-anticorruzione-privacy-mappa.png)

*Figura 7.1 - Trasparenza, anticorruzione e privacy: conoscibilità dell’azione amministrativa, prevenzione del rischio e protezione dei dati personali.*
...
| PA digitale e servizi online | Capitolo 10 | Qui si qualificano base giuridica, limiti di diffusione, minimizzazione e responsabilità; il Capitolo 10 spiega gli strumenti tecnici e organizzativi che rendono sicuro il processo digitale. |
...
![Figura 7.2 - Tre accessi: schema decisionale per distinguere accesso documentale, accesso civico semplice e accesso civico generalizzato.](../assets/chapter-07/02-tre-accessi-decisione.png)

*Figura 7.2 - Tre accessi: schema decisionale per distinguere accesso documentale, accesso civico semplice e accesso civico generalizzato.*
...
![Figura 7.3 - Bilanciamento tra accesso e privacy: richiesta, fonte, limiti e soluzione proporzionata.](../assets/chapter-07/03-bilanciamento-foia-privacy.png)

*Figura 7.3 - Bilanciamento tra accesso e privacy: richiesta, fonte, limiti e soluzione proporzionata.*
...
![Figura 7.4 - Sistema anticorruzione: indirizzi ANAC e PNA, sezione PIAO, ruolo del RPCT, misure e monitoraggio.](../assets/chapter-07/04-sistema-anticorruzione-rpct-piao.png)

*Figura 7.4 - Sistema anticorruzione: indirizzi ANAC e PNA, sezione PIAO, ruolo del RPCT, misure e monitoraggio.*
...
![Figura 7.5 - Soggetti privacy nella PA: titolare, responsabile, autorizzati, DPO/RPD, interessato, contitolari e Garante Privacy.](../assets/chapter-07/05-soggetti-gdpr-pa.png)

*Figura 7.5 - Soggetti privacy nella PA: titolare, responsabile, autorizzati, DPO/RPD, interessato, contitolari e Garante Privacy.*
...
| Dati scambiati tramite interoperabilità o PDND | interoperabilità, autorizzazioni, tracciabilità e sicurezza | finalità del trattamento, pertinenza dei dati e responsabilità dell’amministrazione |
| Dato pubblicato o reso riutilizzabile | formato aperto, accessibilità e qualità del dato | obbligo di pubblicazione, limiti, oscuramento e divieto di diffusione eccedente |
| Incidente su un servizio digitale | misure tecniche, controlli di accesso e continuità operativa | qualificazione dell’eventuale data breach, valutazione del rischio e adempimenti privacy |

**Distinzione da ricordare:** la sicurezza informatica protegge sistemi e dati con misure tecniche e organizzative; la protezione dei dati personali impone anche finalità, base giuridica, minimizzazione e tutela delle persone. Un incidente informatico non coincide automaticamente con un data breach, ma può diventarlo quando coinvolge la sicurezza di dati personali.
