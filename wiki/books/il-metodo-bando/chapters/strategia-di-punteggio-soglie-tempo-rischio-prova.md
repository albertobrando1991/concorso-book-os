---
id: chapter-strategia-di-punteggio-soglie-tempo-rischio-prova
type: chapter
...
canonical: true
tags: ["book-chapter", "extra-chapter", "exam-strategy", "scoring", "workbook"]
...
Puoi conoscere la materia e perdere tempo su una domanda bloccante.
...
Misura anche come lo usi nel tempo disponibile.
...
- usare le simulazioni per testare soglia, tempo e rischio;
...
Ogni strategia parte dal bando.
...
Devi trasformarli in una pagina di lavoro.

Se non sai rispondere a queste domande, non sei ancora pronto a simulare:

| Domanda | Risposta da bando/avviso |
|---|---|
...
- si spaventano e cercano di fare tutto perfettamente;
- la ignorano e simulano senza sapere quale punteggio stanno inseguendo.

La soglia va invece trattata come un dato di lavoro.

Chiediti:

1. che cosa serve per superarla?
...
|---|---|---|
| Punteggio basso e molti errori di concetto | conoscenza fragile | ripasso mirato e schede operative |
| Punteggio basso ma molte risposte lasciate per tempo | gestione del tempo debole | simulazioni a giri e timer |
| Punteggio instabile | strategia non consolidata | ripetere simulazioni comparabili |
| Punteggio vicino alla soglia ma errori di lettura | attenzione e consegna | esercizi su parole chiave e revisione |
| Punteggio buono ma troppi dubbi | rischio in prova | lavorare su certezza e classificazione |

La soglia non serve a generare ansia.

Serve a scegliere il prossimo lavoro.
...
|---|---|
| Durata totale | |
| Output richiesto | quiz / scritto / orale / caso / prova mista |
| Numero di domande o parti | |
| Tempo medio teorico | |
| Tempo riservato alla revisione | |
| Tempo massimo su domanda bloccante | |
| Segnale per passare oltre | |

Questa scheda va provata in simulazione.
...
|---|---|---|
| Primo giro | rispondi alle domande sicure e segni le altre | mettere in sicurezza punti rapidi |
...
| Blocco | Funzione | Errore da evitare |
|---|---|---|
| Lettura | capire verbo operativo e perimetro | rispondere alla domanda sbagliata |
| Scaletta | ordinare definizione, funzione, riferimenti, esempio | scrivere a flusso |
| Stesura | produrre testo chiaro e proporzionato | allargare troppo |
| Revisione | controllare pertinenza, lessico, omissioni e forma | consegnare errori evitabili |
...
> quale output vuole la traccia?

Non dalla domanda:

> quante cose so su questo argomento?
...
Una risposta orale efficace non deve essere infinita.
...
La strategia orale non significa recitare.

Significa sapere come rientrare in carreggiata.
...
Non devi simulare per dimostrare che sei pronto.

Devi simulare per diventarlo.

## Strategia per prove miste

Molti concorsi non chiedono un solo output puro.

Possono combinare quiz, inglese, informatica, materie giuridiche, quesiti situazionali, scritto, orale o titoli.

La prova mista richiede una scelta preliminare: non tutte le sezioni hanno lo stesso tempo, lo stesso peso o lo stesso rischio.

Costruisci una tabella:

| Sezione | Peso | Tempo | Rischio | Strategia |
|---|---|---|---|---|
| Materia 1 | | | | |
| Materia 2 | | | | |
| Logica / inglese / informatica | | | | |
| Risposta scritta / caso | | | | |
| Revisione | | | | |

Poi decidi:

- dove mettere il primo investimento di tempo;
- quali sezioni non devono superare un limite;
- quali parti possono essere lasciate al secondo giro;
- dove serve revisione obbligatoria;
- quale errore ricorrente devi controllare.

La prova mista premia il candidato che sa cambiare ritmo senza cambiare metodo.
...
1. primo giro solo domande sicure;
2. secondo giro domande probabili;
3. limite di tempo sulle domande bloccanti;
4. revisione solo su domande segnate, non su tutto in modo ansioso;
5. Diario degli errori separato tra conoscenza, lettura e strategia.
...
| Primo giro: cosa faccio? | |
| Secondo giro: cosa faccio? | |
| Segnale per saltare una domanda | |
| Errore strategico da evitare | |

Poi scrivi una frase operativa:

```text
Durante la prova proteggo __________, non supero __________ su una domanda bloccante, torno su __________ solo dopo avere completato __________.
```

Se non riesci a completarla, devi ancora trasformare il bando in strategia.
...
- ho deciso quanto tempo lasciare alla revisione?
- ho una strategia diversa per quiz, scritto o orale?
