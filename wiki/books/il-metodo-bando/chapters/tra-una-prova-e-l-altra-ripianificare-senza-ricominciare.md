---
id: chapter-tra-una-prova-e-l-altra-ripianificare-senza-ricominciare
type: chapter
title: "Tra una prova e l'altra: ripianificare senza ricominciare"
status: revised_draft
domain: "concorsi pubblici italiani"
topics: ["intervallo tra prove concorsuali", "dopo prova concorsi", "prove concorsuali", "prova a quiz", "prova scritta teorico pratica", "prova orale", "simulazioni concorsuali", "diario errori", "capitale studio riutilizzabile", "strategia punteggio prova concorsuale", "giorno prova concorso", "metodo bando"]
...
canonical: true
tags: ["book-chapter", "extra-chapter", "between-exams", "planning", "workbook"]
...
Puoi uscire convinto di avere sbagliato e poi scoprire di essere passato.
...
Ricostruisce risposte.

Ascolta altri candidati.
...
| Errori probabili | |
| Problemi di tempo | |
| Problemi di lettura o strategia | |
| Istruzioni particolari | |
| Logistica da correggere | |
| Possibile prova successiva | |

Non serve che sia perfetta.
...
| Dato emerso | Significato | Azione |
|---|---|---|
| Ho perso tempo su domande lunghe | strategia da correggere | micro-simulazione con timer |
| Ho sbagliato nuclei ricorrenti | conoscenza fragile | scheda operativa e richiamo |
...
Non devi studiare tutto da capo.

Devi convertire.

| Dal quiz | Verso lo scritto |
|---|---|
| domande ricorrenti | nuclei da spiegare in 10/20 righe |
| errori di concetto | schede definizione-funzione-esempio |
| materie deboli | scalette brevi |
| tempo insufficiente | risposte sintetiche a timer |
| distrattori frequenti | confronti tra istituti simili |
...
Non devi simulare ogni giorno come se la convocazione fosse domani.

Devi tenere vivo il nucleo orale.
...
| Frequenza | Azione |
|---|---|
| Ogni giorno o secondo piano personale | richiamo breve di nuclei comuni |
| 2-3 volte a settimana | schede o domande orali |
| 1 volta a settimana | controllo ordinato avvisi e calendario |
| Dopo ogni avviso | aggiornamento Bando Decoder |
| Ogni 7 giorni | decisione: mantenere, aumentare, ridurre |
...
Deve produrre capitale.

Questo non significa negare la delusione.

Significa non lasciare che la delusione distrugga dati utili.
...
- prepara un nucleo leggero per la fase successiva;
- conserva documenti, avvisi e ricevute;
...
Il risultato ufficiale decide la procedura.

Il tuo piano decide come arrivi al passaggio successivo.
...
| Fonte ufficiale da controllare | |
| Tre nuclei da tenere vivi | |
| Due errori da correggere | |
| Un output da allenare | |
| Materiale da archiviare | |
| Materiale da convertire | |
| Prima micro-simulazione | |
| Data di revisione piano | |

La scheda deve essere breve.

Se diventa un nuovo manuale, non serve.

Deve dirti che cosa fare nella prossima settimana.
...
Il candidato consegna una prova e chiude mentalmente tutto.

Non registra domande.

Non annota errori.

Non salva istruzioni.
...
| Domanda | Risposta |
|---|---|
| Quale prova ho appena sostenuto o sosterro? | |
| Quale fase successiva prevede il bando? | |
| Quali tre nuclei potrebbero tornare? | |
| Quale errore voglio correggere subito? | |
| Quale output devo allenare adesso? | |
| Quando controllo gli avvisi ufficiali? | |
| Che cosa archivio? | |
| Che cosa converto in scheda? | |

Poi scrivi una frase operativa:

```text
Tra questa prova e la prossima non ricomincio da zero: tengo vivo __________, correggo __________ e alleno __________ entro __________.
```
...
- ho compilato una scheda post-prova?
- ho registrato errori di contenuto, tempo, lettura e strategia?
- ho controllato quale prova successiva prevede il bando?
