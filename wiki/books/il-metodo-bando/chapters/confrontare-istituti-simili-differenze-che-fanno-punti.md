---
id: chapter-confrontare-istituti-simili-differenze-che-fanno-punti
type: chapter
title: "Confrontare istituti simili: differenze che fanno punti"
status: revised_draft
domain: "concorsi pubblici italiani"
topics: ["confronto istituti simili", "risposta comparativa concorsi", "risposta concorsuale", "risposta sintetica concorsuale", "prova scritta", "prova orale", "schede operative studio", "diario errori", "parole chiave concorsi"]
entities: ["Metodo BANDO", "Diario degli errori", "Bando Decoder"]
...
canonical: true
tags: ["book-chapter", "extra-chapter", "comparison", "written-exam", "oral-exam", "workbook"]
...
- riconoscere una domanda comparativa;
- evitare la risposta a due monologhi;
- trovare il criterio che distingue due istituti;
- costruire una risposta breve di confronto;
- preparare una risposta orale da 60 secondi;
- usare le differenze per neutralizzare distrattori nei quiz;
- trasformare le confusioni ricorrenti in schede operative;
- aggiornare il Diario degli errori quando confondi istituti vicini.

Questo capitolo non riscrive le singole materie. Ti insegna il metodo per confrontarle.

## Che cosa vuole davvero una domanda di differenza
...
Il candidato medio studia capitoli.
...
| Soggetto | Chi li attiva, li esercita o ne risponde? |
| Fonte | Da quale disciplina o livello regolativo derivano? |
| Presupposto | Quando si applicano? |
| Procedimento | Quali passaggi richiedono? |
| Effetti | Che cosa producono? |
| Limiti | Dove si fermano? |
| Garanzie | Quali tutele o controlli comportano? |
| Lessico | Quale parola-spia li distingue? |
...
| Passaggio | Funzione |
|---|---|
| 1 apertura | Inquadra i due istituti e dice che sono vicini ma distinti. |
| 3 differenze | Seleziona tre criteri: funzione, presupposto, effetti, soggetto o procedimento. |
| 1 chiusura | Nomina la differenza centrale e riporta alla traccia. |
...
## Confronto in 10, 20 e 30 righe

Il confronto cambia in base allo spazio.

| Spazio | Obiettivo | Struttura |
|---|---|---|
| 10 righe | Dire la differenza centrale. | Apertura breve, due criteri, chiusura. |
| 20 righe | Spiegare il confronto con un minimo sviluppo. | Apertura, tre criteri, esempio breve, chiusura. |
| 30 righe | Articolare senza diventare trattato. | Inquadramento, criteri, conseguenze, eventuale caso, chiusura. |

In 10 righe non devi raccontare tutto.
...
| Tipo di confusione | Esempio di segnale | Correzione |
|---|---|---|
...
| Frase pronta | |
| Prossimo ripasso | |
| Quiz o domanda orale collegata | |

Esempio di compilazione neutra:

| Campo | Risposta |
|---|---|
| Coppia confusa | Istituto A / Istituto B |
...
Una scheda di confronto deve stare in una pagina.
...
La scheda funziona se puoi usarla in tre modi:
...
| Elemento | Esito |
|---|---|
| Verbo | Indicare la differenza |
| Richiesta | Funzione ed effetti |
| Errore | Due monologhi separati |
| Cosa manca | Frase comparativa e criterio di distinzione |
...
## Coppie da cercare nel tuo programma

Ogni candidato deve costruire la propria lista, partendo dal bando.

Ecco una traccia di lavoro, da verificare nei capitoli di materia:
...
1. Una domanda di differenza chiede un confine, non due definizioni isolate.
2. Il confronto deve avere un criterio: funzione, oggetto, soggetto, fonte, presupposto, procedimento o effetti.
3. La formula 1-3-1 aiuta: apertura, tre differenze, chiusura.
4. Nei quiz gli istituti simili diventano distrattori forti.
5. Ogni confusione ricorrente va trasformata in una scheda del Diario degli errori.
...
- primo istituto: definizione lunga;
...
Scegli due istituti che tendi a confondere.
...
Poi scrivi tre versioni:

1. risposta in 10 righe;
2. risposta orale da 60 secondi;
3. quiz a quattro opzioni con un distrattore basato sulla confusione.

Se riesci a produrre tutte e tre, la distinzione sta diventando operativa.

## Checklist operativa

| Controllo | Fatto |
|---|---|
| Ho riconosciuto che la traccia chiede un confronto. | |
| Ho evitato due definizioni isolate. | |
| Ho scelto il criterio di distinzione. | |
| Ho selezionato due o tre differenze decisive. | |
| Ho usato almeno una frase comparativa esplicita. | |
| Ho inserito un esempio solo se utile. | |
| Ho chiuso con la differenza centrale. | |
| Ho trasformato la coppia in scheda operativa. | |
| Ho registrato nel Diario il tipo di confusione. | |
| Ho verificato eventuali dettagli normativi nelle fonti consolidate. | |
