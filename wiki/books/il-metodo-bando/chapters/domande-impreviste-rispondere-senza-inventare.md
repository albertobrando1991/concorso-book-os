---
id: chapter-domande-impreviste-rispondere-senza-inventare
type: chapter
title: "Domande impreviste: rispondere senza inventare"
status: revised_draft
domain: "concorsi pubblici italiani"
topics: ["domande impreviste concorsi", "risposta sicura concorsi", "gestione incertezza concorsi", "risposta concorsuale", "prova orale", "prova scritta", "simulazioni concorsuali", "diario errori", "schema risposta orale"]
...
canonical: true
tags: ["book-chapter", "extra-chapter", "uncertainty", "oral-exam", "written-exam", "workbook"]
...
- riconoscere i principali tipi di domanda imprevista;
...
Il candidato fragile reagisce in due modi opposti:
...
|---|---|---|
| Incertezza gestita | Delimita, parte da un punto sicuro, evita dettagli falsi. | Mostra controllo. |
...
Le aree di rischio sono:

- definizioni che sembrano simili;
- procedure con fasi;
...
La domanda imprevista spesso nasce quando due aree si toccano.

### Nuclei

Quando non sai tutto, torna ai nuclei:
...
Il Diario degli errori deve distinguere cinque casi:

| Tipo di incertezza | Segnale | Correzione |
|---|---|---|
| Non sapevo | Tema davvero non studiato. | Inserire nel piano. |
...
La chiusura serve a non lasciare la risposta sospesa.
...
Se non conosci tutte le differenze, formula quella centrale.

### 4. Caso pratico con dati incompleti
...
- quale comunicazione;
- quale controllo;
- quale soluzione proporzionata.

Se un dato manca, puoi dire che la soluzione dipende da quel dato, ma devi comunque impostare il ragionamento.
...
1. riprendo il punto;
2. cambio il parametro richiesto;
3. chiudo.
...
1. respira;
2. torna alla funzione;
3. richiama soggetto o fase;
4. usa un esempio semplice;
5. chiudi senza allungare.
...
Usa questo protocollo in 20 secondi.
...
1. sottolinea il verbo operativo;
2. scrivi una micro-scaletta di tre righe;
3. indica il nucleo sicuro;
4. sviluppa funzione o effetto;
5. se serve, usa un esempio semplice;
6. chiudi tornando alla traccia;
7. elimina dettagli non sicuri.

Domanda di controllo prima di consegnare:

> Questa frase risponde alla traccia o serve solo a riempire spazio?

Se serve solo a riempire spazio, taglia.
...
Una volta a settimana prepara dieci domande laterali.

Non devono essere impossibili. Devono essere scomode.
...
Ma ha perimetro, nucleo, sviluppo e chiusura.
...
1. risposta orale da 45 secondi;
2. risposta scritta da 10 righe;
3. flashcard di recupero;
4. voce del Diario degli errori.

## Checklist anti-invenzione

Prima di chiudere una risposta incerta, chiediti:

- Ho capito il tipo di domanda?
- Ho detto almeno un nucleo sicuro?
- Ho evitato articoli, date o effetti non sicuri?
- Ho usato una funzione, un soggetto, una fase o un esempio?
- Ho evitato formule assolute?
