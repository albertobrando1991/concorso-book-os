...
canonical: true
tags: ["book-chapter", "extra-chapter", "exam-day", "logistics", "workbook"]
...
La prova comincia prima della prima domanda.

Comincia quando decidi come arrivarci.
...
| A - Aree | quali parti della prova affrontero? | preparo ordine mentale e tempi per sezioni o materie |
| N - Nuclei | quali concetti devo richiamare senza aprire nuovi mondi? | ripasso leggero di schede e errori chiave |
| D - Diario | quali errori non devo ripetere sotto pressione? | tengo visibili le contromisure operative |
| O - Output | che cosa devo produrre o selezionare? | eseguo quiz, scritto, orale o caso secondo strategia |

Questa mappa serve a evitare un errore comune: pensare che il giorno della prova riguardi solo la conoscenza.
...
Le ultime 24 ore hanno un compito diverso:

- confermare documenti e logistica;
...
- richiamo attivo breve;
- revisione di schede;
- lettura della scheda prova;
- controllo di errori ricorrenti;
- simulazione leggera solo se non ti svuota;
- preparazione documenti.

Evita invece:

- nuovi capitoli lunghi;
- materiale non verificato;
- confronto ansioso con altri candidati;
...
| Campo | Fonte ufficiale | Verificato |
|---|---|---|
...
| Strumenti ammessi | | |
| Strumenti vietati | | |
| Eventuali codici o credenziali | | |
| Mezzo di trasporto e margine | | |
| Contatto o canale per avvisi | | |

Questa tabella non sostituisce le istruzioni ufficiali.
...
1. controllo documenti e oggetti ammessi;
2. controllo orario e tragitto;
3. ripasso leggero di schede brevi;
4. arrivo con margine;
5. riduzione del confronto inutile;
6. lettura calma delle istruzioni;
7. esecuzione della strategia.

Non devi dimostrare a te stesso che sai tutto prima di entrare.
...
Non devi isolarti in modo rigido.

Devi proteggere la tua traiettoria.
...
Prima leggono una parte.

Poi saltano alla domanda.
...
- divieti o vincoli specifici;
- indicazioni date dalla commissione o dagli addetti.

Se qualcosa sembra diverso da quanto simulato, non reagire in automatico.

Prima leggi.

Poi adatti la strategia.

La simulazione ti prepara al formato probabile.

Le istruzioni reali governano la prova reale.

## Durante la prova: applicare, non reinventare

La prova vera non deve essere il primo luogo in cui provi la tua strategia.

Se hai preparato tre giri nel quiz, usali.

Se hai stabilito un tempo massimo su domanda bloccante, rispettalo.
...
| Segnale | Azione |
|---|---|
| Domanda facile | rispondi e vai avanti |
| Domanda lunga | segna e valuta tempo |
| Domanda bloccante | salta, non negoziare |
| Traccia ampia | fai perimetro e scaletta |
| Vuoto orale | riparti da principio e funzione |
...
```text
fermati -> leggi -> chiedi se consentito -> riparti
```
...
Non trasformare un problema parziale in una prova persa.

### Matrice imprevisti

| Tipo | Esempio | Risposta prudente |
|---|---|---|
| Logistico | aula, fila, ingresso, posto | seguire addetti e istruzioni ufficiali |
...
Quando la prova finisce, il candidato spesso passa subito a una delle due reazioni:
...
- come hai gestito il tempo;
- quali parti erano prevedibili;
- quali errori pensi di avere commesso;
- quali istruzioni erano diverse dalle simulazioni;
- quali materie o output tornano utili per il prossimo concorso;
- quali problemi logistici o di routine vanno corretti.

Non serve scrivere un romanzo.

Serve non perdere informazioni fresche.

Il Diario post-prova comincia qui.
...
Compila questa scheda per il tuo prossimo concorso.

| Campo | Risposta |
|---|---|
| Data e orario ufficiale | |
| Sede e tragitto | |
| Documento e ricevute | |
| Strumenti ammessi | |
| Strumenti vietati | |
| Tre schede da rivedere | |
| Tre errori da non ripetere | |
| Strategia di tempo | |
| Azione se mi blocco | |
| Cosa annotare dopo la prova | |

Poi scrivi la tua frase di esecuzione:
...
Prima di chiudere la preparazione controlla:

- ho letto bando, convocazione e ultimi avvisi ufficiali?
- ho preparato documento, ricevute e materiali consentiti?
...
Questa checklist non sostituisce le istruzioni ufficiali.

Serve a fare in modo che tu le abbia davvero trasformate in azioni.
