---
id: appendix-c-template-bando-decoder
type: chapter
...
Il Bando Decoder non si compila una volta sola. Va aggiornato se cambiano calendario, banca dati, sede, prove, istruzioni, ammessi o documenti.

## Mappa BANDO del template

| Fase | Sezione del Decoder | Decisione prodotta |
|---|---|---|
...
| Informazione | Fonte precisa | Da ricontrollare? |
|---|---|---|
| Requisiti | | |
| Prove | | |
| Materie | | |
...
| Possiedo eventuale esperienza richiesta. | | |
| Rispetto requisiti soggettivi indicati. | | |
| Ho verificato eventuali cause ostative. | | |
| Ho documenti o dichiarazioni necessari. | | |
...
|---|---|---|
| Posso partecipare senza dubbi rilevanti | | Procedo al piano |
| Posso partecipare ma ho dubbi da verificare | | Verifico entro una data precisa |
| Non posso partecipare | | Archivio il bando |

## Pagina 3 - Profilo reale

Il nome del profilo non basta. Devi capire quale lavoro e quale prova sta dietro quel nome.
...
|---|---|---|
| Coerenza con titolo e competenze | | |
| Coerenza con tempo disponibile | | |
| Coerenza con altri concorsi che preparo | | |
| Interesse reale per mansioni/sede | | |
| Capitale di studio riutilizzabile | | |

## Pagina 4 - Domanda, documenti e rischi formali

| Controllo | Risposta |
|---|---|
| Portale o procedura da usare | |
| Credenziali necessarie | |
| Pagamento o contributo richiesto | |
| Allegati richiesti | |
| Dichiarazioni da rendere | |
| Titoli da indicare | |
| Formato documenti | |
| Ricevuta o protocollo da salvare | |
| Email, PEC o domicilio digitale da controllare | |
...
| Ricevuta non salvata | | |
| Comunicazioni non controllate | | |

## Pagina 5 - Prove, punteggi e soglie

| Elemento | Dato del bando | Conseguenza sullo studio |
|---|---|---|
| Preselezione | | |
| Prova scritta | | |
...
## Pagina 7 - Calendario e comunicazioni

| Evento | Data o periodo | Fonte | Promemoria |
|---|---|---|---|
| Scadenza domanda | | | |
| Pubblicazione ammessi | | | |
| Banca dati eventuale | | | |
| Calendario prova | | | |
| Prova scritta/quiz | | | |
| Prova orale | | | |
| Pubblicazione graduatoria | | | |

### Routine controllo comunicazioni

| Fase | Frequenza | Dove controllo |
|---|---|---|
| Prima della domanda | | |
| Dopo invio domanda | | |
| Prima delle prove | | |
...
## Pagina 8 - Strategia iniziale

Questa pagina trasforma il bando in piano.

| Domanda | Risposta |
|---|---|
| Quanti giorni ho davvero? | |
...
| Azione | Entro quando | Fatto |
|---|---|---|
| Salvare bando, avvisi e ricevute | | |
| Verificare requisiti e domanda | | |
| Compilare materie e prove | | |
| Aprire diario errori | | |
| Fare primo blocco di studio | | |
| Programmare prima simulazione | | |
...
| Bassa | Concorso marginale o poco compatibile. | |
| Stop | Requisiti mancanti, scadenze incompatibili o rischio troppo alto. | |

### Decisione scritta

Scrivi una frase. Deve essere netta.
...
Esempio fittizio: istruttore amministrativo comunale, prova scritta a quiz e orale.

| Campo | Risposta esempio |
|---|---|
| Ente | Comune Alfa |
| Profilo | Istruttore amministrativo |
| Prove | Quiz scritto + orale |
| Materie centrali | Amministrativo, enti locali, pubblico impiego, trasparenza |
| Materie killer | Enti locali e accessi |
| Modulo integrativo | Enti locali |
| Output principale | Quiz a tempo e risposte orali brevi |
...
Se hai due concorsi aperti, usa questa tabella.

| Criterio | Concorso A | Concorso B | Scelta |
|---|---|---|---|
| Scadenza | | | |
| Prove | | | |
| Materie comuni | | | |
...
**Se due bandi hanno materie simili, posso usare lo stesso Bando Decoder?**

No. Puoi riusare parte del capitale di studio, ma ogni bando ha scadenze, prove, punteggi, soglie, documenti, comunicazioni e profilo propri. Devi compilare un Decoder per ciascun concorso e poi confrontarli.
