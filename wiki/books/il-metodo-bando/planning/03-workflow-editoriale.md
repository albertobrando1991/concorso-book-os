...
**Avanzati a `publication-ready` (15 file):** Introduzione; Cap. 1 Il nuovo candidato; Cap. 3 Il Metodo BANDO; Cap. 11 Inglese; Cap. 12 Logica; Cap. 13 Metodo di studio; Cap. 14 La prova a quiz; Cap. 16 La prova orale; Cap. 22 Piano 30/60/90; Cap. 23 Diario degli errori; Cap. 24 Checklist operative; Conclusione; Appendici C, D, E.
...
Il perimetro cartaceo corrente comprende quindi 32 sezioni autoriali: 15 già `publication-ready` e 17 ancora soggette al gate umano. I 23 moduli R1-R23 restano nel Ricettario digitale e non entrano nel PDF cartaceo.
