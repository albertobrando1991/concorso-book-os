---
id: chapter-m-fl04-10-commercio-pubblici-esercizi-suap
type: book_chapter
title: "Commercio, pubblici esercizi e SUAP"
status: revised_draft
domain: "concorsi pubblici italiani"
topics: ["commercio", "pubblici esercizi", "suap", "polizia amministrativa", "polizia locale"]
...
A. È sempre l'organo che svolge il sopralluogo.
B. È il punto unico di accesso e coordinamento per le pratiche comprese nel suo ambito.
C. Sostituisce tutte le amministrazioni competenti.
D. È un archivio privo di funzioni procedimentali.

**Risposta corretta: B.** L'unitarietà riguarda l'accesso e il coordinamento. Le competenze tecniche, di vigilanza e decisorie restano distribuite secondo le norme.
...
B. una segnalazione fondata su presupposti legali e soggetta a controllo;
C. una semplice comunicazione senza responsabilità;
D. un titolo utilizzabile per qualsiasi attività.

**Risposta corretta: B.** La SCIA è distinta dall'autorizzazione e opera nei casi previsti dall'art. 19 della legge n. 241/1990 e dalle norme speciali.
...
B. Dall'attività effettivamente svolta e dai fatti osservabili.
C. Dalla volontà di disporre la chiusura.
D. Soltanto dall'insegna.

**Risposta corretta: B.** La qualificazione giuridica viene dopo la descrizione dell'attività reale e il confronto con fonti, titoli e prescrizioni.
...
A. Sì, se contiene fotografie.
B. Sì, quando esiste una pratica SUAP.
C. No, accertamento e provvedimento finale vanno distinti.
D. No, perché la Polizia locale non può mai accertare illeciti commerciali.

**Risposta corretta: C.** La pattuglia documenta e contesta nei limiti delle attribuzioni; la misura sull'attività richiede fonte, presupposti e autorità competente.
