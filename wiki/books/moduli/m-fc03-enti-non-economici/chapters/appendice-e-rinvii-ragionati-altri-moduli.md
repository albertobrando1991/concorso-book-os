---
id: appendix-m-fc03-e-rinvii-ragionati-altri-moduli
type: book_chapter
title: "Rinvii ragionati ad altri moduli"
...
last_compiled_from: [
  ...
  "wiki/books/moduli/m-fc03-enti-non-economici/chapters/appendice-c-schede-rapide-aci-enac-istat-enea-asi-cri.md",
  "wiki/books/moduli/m-fc03-enti-non-economici/chapters/appendice-d-errori-tipici-bandi-epne.md"
]
---
...
L’ente indica il contesto istituzionale. Il profilo descrive il lavoro atteso. Le prove mostrano quali capacità saranno osservate. Le materie dominanti rivelano il centro di gravità della selezione. Se manca uno di questi elementi, la scelta resta provvisoria. Un titolo sintetico come «funzionario» non basta: occorrono il codice del profilo, le attività, il programma e gli eventuali allegati.
...
Tre controlli aiutano a distinguere integrazione e cambio di rotta. Primo: eliminando la materia dubbia, il profilo rimarrebbe riconoscibile come amministrativo EPNE? Secondo: la competenza specialistica è un requisito trasversale o costituisce il mestiere selezionato? Terzo: la prova chiede di applicarla in un caso d’ufficio generale oppure di dimostrare una professionalità autonoma? Se le risposte indicano un nucleo amministrativo stabile, è ragionevole restare nel modulo e integrare.
...
Restare nel modulo non significa ignorare il bando concreto. Le fonti ufficiali della procedura prevalgono sempre sulle categorie editoriali: occorre controllare programma, criteri, titoli, prove e comunicazioni dell’amministrazione. Il modulo organizza lo studio; non sostituisce la lettura degli atti. Analogamente, l’appendice non autorizza a ridurre una materia che il bando valuta in modo autonomo.
...
In questi casi M-FC03 può ancora servire per comprendere organizzazione pubblica, procedimenti, responsabilità e contesto dell’ente. Non prepara però da solo alla dimensione tecnico-scientifica. Il candidato deve esaminare il settore disciplinare, i titoli valutabili, le esperienze richieste e il tipo di prova. Una discussione su progetti, metodi o risultati di ricerca richiede una preparazione diversa da un quesito sull’accesso agli atti.
...
Il profilo **tecnico-ingegneristico** richiede un terzo controllo. Quando il nucleo è progettazione, direzione lavori, manutenzione specialistica, impianti, infrastrutture, sicurezza tecnica, energia o valutazioni ingegneristiche, la famiglia di riferimento è **M-TR03 — Profili tecnico-ingegneristici**. Non va confusa con M-TR01, che ha centro digitale, né con M-IR03, che ha centro scientifico e di ricerca. Un ingegnere informatico addetto alle architetture applicative può convergere verso ICT; un ingegnere civile per opere e impianti verso il percorso tecnico-ingegneristico; un tecnologo impegnato in ricerca sperimentale verso la famiglia ricerca.
...
Si consideri un bando per «tecnologo» presso un ente scientifico. Il termine può indicare un profilo legato a programmi di ricerca, ma il programma concreto potrebbe concentrarsi su infrastrutture digitali oppure su gestione tecnico-amministrativa di progetti. Occorre leggere le attività, non tradurre meccanicamente la denominazione. Lo stesso vale per «specialista tecnico»: senza settore, prove e materie non è possibile stabilire il rinvio.
...
La soglia non si misura dal numero di volte in cui compare la parola «appalti». Bisogna verificare profondità e output. Se la prova chiede nozioni generali e un caso amministrativo semplice, il capitolo applicativo di M-FC03 può essere il perno. Se richiede strategie di gara, gestione specialistica dell’esecuzione, rendicontazione di programmi, milestone, controlli e soluzioni a criticità complesse, il modulo trasversale specialistico deve guidare lo studio. Il nucleo EPNE rimane solo nella misura richiesta.
...
Le parole-spia devono essere lette in gruppo. «Prevenzione» può indicare politiche e procedure amministrative oppure attività tecnico-sanitaria. «Assistenza» può riferirsi a servizi all’utenza oppure a prestazioni professionali. «Valutazione» può essere amministrativa, medico-legale, sociale o tecnica. Il candidato identifica oggetto, destinatario, strumenti e responsabilità dell’attività. Se sono richiesti abilitazione, albo, competenze cliniche o tecniche specifiche, il rinvio professionale è forte.

Lo stesso principio vale per le **carriere speciali**. **M-SP01** è la famiglia di riferimento per forze di polizia e profili collegati; **M-SP02** per vigili del fuoco e percorsi propri; **M-SP04** per carriere prefettizia e diplomatica. Questi concorsi non diventano EPNE perché contengono diritto amministrativo, contabilità o organizzazione. Hanno ordinamenti, prove, requisiti e competenze caratterizzanti. Il nucleo comune può essere riusato, ma la preparazione deve seguire la carriera effettiva.
...
La scheda non serve a moltiplicare i materiali, ma a impedire acquisti e studio senza criterio. La motivazione deve contenere almeno un elemento relativo al profilo, uno alle prove e uno alle materie. Una frase come «scelgo M-TR01 perché compare informatica» è debole; «scelgo M-TR01 perché il profilo amministra infrastrutture cloud, la prova è tecnica e il programma è dominato da reti e cybersecurity» è controllabile.
...
L’errore più frequente è voler restare nel modulo già aperto. Il candidato ha investito tempo in M-FC03 e tenta di adattarlo a ogni bando. Questa inerzia fa perdere il centro della prova. La correzione consiste nell’accettare la modularità: cambiare percorso principale non significa cancellare ciò che si è studiato. Il nucleo comune e le parti pertinenti restano; si smette soltanto di forzare il bando.
