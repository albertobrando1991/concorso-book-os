---
id: chapter-m-tr01-13
type: book_chapter
title: "Laboratorio prove ICT: quiz, scritto tecnico, orale e casi"
status: reviewed-draft
domain: "concorsi pubblici italiani"
topics: ["prove ict", "quiz", "scritto tecnico", "orale", "casi tecnici", "simulazioni concorsuali", "diario degli errori"]
...
A. L'autenticazione assegna i permessi; l'autorizzazione verifica l'identità.
B. L'autenticazione verifica un'identità dichiarata; l'autorizzazione determina le azioni consentite.
C. Entrambe cifrano le credenziali.
D. L'autorizzazione precede sempre l'identificazione.
...
Per un incidente usa **rilevazione → triage → contenimento → recupero → verifica → lezione appresa**.
Per un fornitore usa **obbligo → indicatore → evidenza → scostamento → escalation → rimedio**.
...
**Soluzione:** non inventare il valore. Dichiara che la soluzione dipende dall'obiettivo definito dall'ente e spiega come ricavarlo e verificarlo.
...
Una soluzione forte dichiara assunzioni, rischi ed evidenze.
