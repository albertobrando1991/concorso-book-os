...
## Che cos’è un profilo ICT pubblico

Un profilo ICT pubblico è una posizione professionale nella quale competenze tecnologiche, responsabilità organizzative e finalità dell’amministrazione si combinano per produrre o presidiare servizi. La tecnologia non è il fine: è il mezzo con cui l’ente gestisce dati, procedimenti, comunicazioni, infrastrutture e servizi rivolti a utenti interni o alla collettività.
...
Questa famiglia presidia disponibilità, configurazione, automazione, osservabilità, backup e continuità. Il punto non è memorizzare marchi commerciali, ma comprendere principi e conseguenze delle scelte: isolamento, scalabilità, ridondanza, aggiornamento, ripristino e controllo delle configurazioni.
...
Capacità tecnica e responsabilità di governo, però, non sono la stessa cosa. Produrre un risultato analitico non basta: occorre comprenderne qualità, limiti e uso nel processo amministrativo.
...
Registra l’errore per tipo: definizione, distinzione, procedura, applicazione o esposizione. Aggiungi sempre l’azione correttiva: ripetere, confrontare, svolgere un esercizio o costruire una risposta orale.
...
- Verificare periodicamente disponibilità e integrità degli allegati ufficiali.
- Non trasformare il campione ragionato in frequenze statistiche.
- Collegare eventuali rinvii esterni solo dopo averne verificato la destinazione editoriale precisa.
