---
id: chapter-m-tr04-03-via-vas-valutazioni-ambientali
type: book_chapter
title: "Capitolo 03 — VIA, VAS e valutazioni ambientali"
status: draft
...
format_version: 2
topics: ["VIA","VAS","screening","valutazioni ambientali","D.Lgs. 152/2006"]
entities: ["MASE","Commissione tecnica VIA-VAS","Regioni","autorità competente","proponente"]
source_refs: ["sources/m-tr04-source-bundle-ambiente-protezione-civile-2026","sources/ambiente-controlli-locali-d-lgs-152-2006"]
book_refs: ["vol-11-ambiente-protezione-civile-sostenibilita","m-tr04-ambiente-protezione-civile","il-metodo-bando"]
last_compiled_from: ["wiki/sources/m-tr04-source-bundle-ambiente-protezione-civile-2026.md","wiki/sources/ambiente-controlli-locali-d-lgs-152-2006.md","wiki/books/moduli/m-tr04-ambiente-protezione-civile/planning/05-piano-capitolo-03-via-vas-valutazioni-ambientali.md"]
confidence: 0.68
...
dati_operativi: []
last_manual_writer_run: "2026-08-10T16:36:20.674Z"
---
...
## N-TR04-03-01 · Funzione delle valutazioni ambientali
...
Per controllare la tua risposta, chiudi sempre con una distinzione operativa. La VAS orienta la cornice; la VIA valuta il progetto; lo screening decide se serve la VIA. Ripetere questa terna non basta: devi collegarla al fatto proposto dalla traccia. Se la traccia parla di piano, parti dalla strategia; se parla di opera, parti dal progetto; se chiede una verifica preliminare, spiega perché la soglia di approfondimento è il punto decisivo. Il controllo finale è chiedersi quale decisione viene preparata.

## N-TR04-03-02 · Valutazione Ambientale Strategica
...
In risposta orale, una formulazione efficace può essere questa: “La VAS è la valutazione ambientale riferita a piani e programmi. Essa mira a integrare la considerazione degli effetti ambientali nella fase di formazione della scelta strategica, prima che il piano o il programma determini le condizioni per interventi successivi. Si distingue dalla VIA perché non riguarda direttamente il singolo progetto, ma la cornice pianificatoria o programmatoria entro la quale potranno collocarsi future decisioni”.

Nel diario degli errori, registra soprattutto le confusioni di oggetto. Scrivi “ho trattato un piano come progetto” oppure “ho descritto la VAS come autorizzazione”. Sono errori brevi da annotare, ma pesano molto in una risposta orale. Correggerli significa tornare alla domanda iniziale: che cosa sta decidendo l’amministrazione e in quale fase si trova la scelta? Se manca questo passaggio, la risposta resta descrittiva e non spiega la funzione della valutazione.

## N-TR04-03-03 · Valutazione di Impatto Ambientale
...
Il delta 2026 va tenuto circoscritto. Il decreto-legge 20 febbraio 2026, n. 21, convertito dalla legge 10 aprile 2026, n. 49, ha inserito nell’art. 25 del D.Lgs. n. 152/2006 il comma 7-ter per progetti complessi caratterizzati da fasi realizzative sequenziali relativi alle attività di cui ai punti 7 e 7.1 dell’allegato II alla Parte seconda. Se l’istanza di VIA comprende l’intero ciclo di vita del progetto e il proponente lo richiede espressamente, l’autorità competente può esprimere un unico giudizio di compatibilità ambientale esteso a tutte le fasi. Quando alcuni dati sono acquisibili solo al termine della fase di ricerca, lo studio di impatto ambientale può usare stime e modellizzazioni; il provvedimento favorevole deve però imporre, prima dell’avvio della fase di esercizio, la verifica di coerenza tra stime, modellizzazioni e dati acquisiti e, in caso di scostamento, la valutazione delle azioni correttive. Non è una regola generale per ogni progetto a fasi e non elimina gli altri presupposti della VIA.
...
Per evitare risposte generiche, collega sempre la VIA a un output leggibile: valutazione degli impatti, condizioni, prescrizioni, integrazioni o provvedimento motivato secondo il caso. Non serve allungare la risposta con dettagli tecnici non richiesti. Serve invece mostrare che il progetto non viene esaminato in astratto, ma nel suo contesto, con effetti possibili, misure di gestione e responsabilità della decisione pubblica. La traccia va quindi chiusa con un effetto procedimentale, non con una sigla lasciata sola. Questo rende la risposta valutabile anche quando il caso è sintetico.

## N-TR04-03-04 · Screening e verifica preliminare
...
In una traccia breve, lo screening va spiegato con prudenza. Non dire che “autorizza” il progetto e non dire che “sostituisce” la valutazione. Dì che seleziona il percorso successivo. Questa formulazione è utile perché resta aderente alla funzione del nucleo e impedisce di confondere verifica preliminare, VIA completa e altri titoli necessari per realizzare o gestire l’intervento. Anche nel ripasso, questa distinzione va ripetuta finché diventa automatica. In sede d’esame evita risposte assolute: spiega sempre quale passaggio viene selezionato e perché. Questo evita scorciatoie e mantiene chiara la funzione dello screening.

## N-TR04-03-05 · Procedimento, soggetti e partecipazione
...
Per il candidato, la partecipazione va collegata alla qualità della decisione. Le osservazioni non decidono al posto dell’autorità, ma possono far emergere dati, criticità, alternative o effetti non considerati. Nella risposta scritta conviene quindi evitare due estremi: trattare il pubblico come un semplice spettatore oppure presentarlo come titolare della decisione finale. Il punto è il contributo all’istruttoria. Questa frase chiude bene anche una risposta sintetica, perché collega soggetti, istruttoria e decisione. Se manca questo collegamento, la partecipazione resta una parola isolata.

## N-TR04-03-06 · Uso concorsuale: distinguere, applicare, rispondere
...
Le valutazioni ambientali servono a integrare la tutela dell’ambiente nella decisione pubblica prima che la scelta diventi definitiva.
La VAS riguarda piani e programmi, quindi opera a livello strategico e pianificatorio.
La VIA riguarda progetti, opere e interventi determinati, quindi valuta impatti concreti.
Lo screening verifica preliminarmente se un progetto debba essere sottoposto a VIA completa.
La risposta d’esame deve distinguere oggetto, fase, autorità, partecipazione ed esito motivato.
...
**Risposta corretta: B.**
La VAS opera a livello strategico e riguarda piani e programmi, cioè decisioni che orientano scelte future.
...
**Risposta corretta: A.**
La VIA valuta la compatibilità ambientale di un progetto determinato prima della sua realizzazione o autorizzazione definitiva.
...
**Risposta corretta: B.**
Lo screening è una verifica preliminare di assoggettabilità. Non coincide con la VIA completa.
...
**Risposta corretta: C.**
La VAS riguarda piani e programmi; la VIA riguarda progetti. Gli strumenti possono collegarsi, ma non sono intercambiabili.
...
**Risposta corretta: C.**
La distinzione parte dall’oggetto: piano o programma per la VAS, progetto per la VIA.
