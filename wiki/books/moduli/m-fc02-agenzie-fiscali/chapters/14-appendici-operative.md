...
asset_refs:
  ...
  - "books/moduli/m-fc02-agenzie-fiscali/assets/chapter-14/03-diritto-ue-doganale-mappa-operativa.png"
...
canonical: true
tags: ["book-chapter","module-code-m-fc02","text-frozen","appendices","workbook","illustrated"]
...
![Figura 14.1 - Mappa BANDO delle appendici: allerta del bando, glossario, strumenti e output si collegano in un unico percorso operativo.](../assets/chapter-14/01-mappa-bando-appendici-operative.png)
...
![Figura 14.2 - Dall'allerta del bando all'output: il glossario e gli strumenti servono a decidere che cosa studiare, dove e con quale prova.](../assets/chapter-14/05-allerta-bando-glossario-output.png)
...
Usa la prima mappa per qualificare la condotta e separare le possibili conseguenze. Passa alla seconda soltanto dopo avere individuato la fonte applicabile: il raccordo tra diritto unionale e nazionale è un controllo distinto dalla qualificazione dell'illecito.
