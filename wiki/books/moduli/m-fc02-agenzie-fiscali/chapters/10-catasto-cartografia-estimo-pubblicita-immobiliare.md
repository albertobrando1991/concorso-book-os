...
last_compiled_from: ["wiki/sources/catasto-pubblicita-immobiliare-estimo-m-fc02.md", "wiki/sources/catasto-cartografia-estimo-pubblicita-immobiliare-aggiornamento-2026-07-18.md", "wiki/sources/bandi-rappresentativi-m-fc02-agenzie-fiscali-2023-2026.md", "wiki/topics/catasto-pubblicita-immobiliare-concorsi.md", "wiki/entities/agenzia-delle-entrate.md"]
---
...
L'immobile va letto sotto quattro profili: quello fisico-cartografico lo colloca sul territorio; quello catastale lo censisce e gli attribuisce dati reddituali; quello estimativo ne analizza il valore; la pubblicità immobiliare rende conoscibili le vicende giuridiche previste dalla legge.

## Obiettivo del capitolo

Al termine del capitolo devi saper:

1. distinguere catasto terreni e catasto fabbricati;
2. leggere gli identificativi catastali e una visura;
3. spiegare classamento, categoria, classe, consistenza e rendita;
4. collegare PREGEO, DOCFA e voltura alle rispettive funzioni;
5. descrivere la cartografia catastale e gli atti geometrici;
6. applicare i principi essenziali dell'estimo;
7. usare correttamente le quotazioni OMI;
8. distinguere trascrizione, iscrizione e annotazione;
9. separare visura catastale e ispezione ipotecaria.

## Mappa BANDO

| Passaggio | Applicazione al capitolo |
|---|---|
| **Bando** | Cerca catasto, cartografia, estimo, topografia, OMI, pubblicità immobiliare, imposte ipotecarie e servizi telematici. |
| **Aree** | Collega tecnica catastale, diritto civile, fiscalità immobiliare, procedimento amministrativo, geomatica e valutazione. |
| **Nuclei** | Particella, subalterno, classamento, rendita, DOCFA, PREGEO, voltura, trascrizione, iscrizione, annotazione. |
| **Diario** | Registra gli errori di funzione: dato catastale/titolo, rendita/valore, voltura/trascrizione, visura/ispezione. |
| **Output** | Ricostruisci un aggiornamento catastale e spiega oralmente le verifiche prima di acquistare un immobile. |

![Figura 10.1 - Mappa BANDO Territorio e SPI: catasto, cartografia, estimo, OMI e pubblicità immobiliare come mappa da concorso.](../assets/chapter-10/01-mappa-bando-territorio-spi.png)

## 1. Funzione e natura del catasto
...
### Perché questa materia è Agenzia delle Entrate

I servizi immobiliari dell'Agenzia seguono quattro funzioni collegate: **identificare** il bene nei dati catastali, **rappresentarlo** nella cartografia, **valutarlo** con strumenti estimativi e OMI, **rendere conoscibili** le vicende giuridiche mediante i Servizi di pubblicità immobiliare. Il collegamento fra banche dati non elimina le differenze di funzione, effetto e responsabilità.

![Figura 10.2 - Sistema Territorio Agenzia Entrate: identificare, rappresentare, valutare e rendere conoscibili le vicende immobiliari.](../assets/chapter-10/02-sistema-catasto-cartografia-estimo-spi.png)

## 2. Catasto terreni e catasto fabbricati
...
In una visura occorre verificare la coerenza tra identificativo, indirizzo, categoria, consistenza, planimetria e intestazione: cercare soltanto il nome del proprietario non basta. Un subalterno soppresso, una variazione non allineata o un indirizzo incompleto possono richiedere approfondimenti senza implicare, da soli, un vizio del titolo.
...
![Figura 10.3 - Identificativo, classamento e rendita: dal Comune al subalterno, poi categoria, classe, consistenza e rendita catastale.](../assets/chapter-10/03-identificativo-classamento-rendita.png)
...
PREGEO è la procedura per predisporre e trattare gli atti geometrici del catasto terreni. Si usa, tra l'altro, per tipi di frazionamento, tipi mappali e altri aggiornamenti cartografici previsti.

Il tipo di frazionamento divide una particella in nuove porzioni. Il tipo mappale inserisce o modifica la rappresentazione di un fabbricato e collega il terreno al successivo censimento urbano. Rilievo, punti fiduciali, misure, libretto e proposta di aggiornamento devono rispettare le specifiche tecniche vigenti.

I controlli automatici non eliminano la responsabilità sul rilievo e sulla sua corretta interpretazione. Errori di inquadramento, contorno o corrispondenza con lo stato dei luoghi possono propagarsi nelle banche dati e compromettere pratiche successive. L'atto aggiorna la geometria e la cartografia; non risolve da solo un confine controverso né sostituisce il titolo giuridico.

## 7. Voltura e intestazioni catastali

La voltura aggiorna le intestazioni catastali in seguito a trasferimenti, successioni, costituzioni o modificazioni di diritti. Può derivare dai flussi degli atti telematici o essere presentata nei casi in cui l'aggiornamento non avvenga automaticamente.
...
| Procedura | Oggetto | Soggetto o presupposto | Output | Controllo e limite |
|---|---|---|---|---|
| DOCFA | Unità immobiliari urbane | Professionista e nuova costruzione o variazione | Dati, elaborati e proposta di classamento | Controllo catastale; non sana profili edilizi |
| PREGEO | Geometria del catasto terreni | Rilievo e atto geometrico | Aggiornamento di mappa e particelle | Controlli tecnici; non decide il confine giuridico |
| Voltura | Intestazioni catastali | Titolo o fatto già intervenuto | Aggiornamento di soggetti, quote e diritti | Non trasferisce né rende valido il diritto |
| Docte | Variazioni colturali | Dichiarazione o aggiornamento previsto | Aggiornamento dei dati colturali | Specifiche e canali da verificare |

![Figura 10.4 - Servizi e procedure del Territorio: visura, planimetria, voltura, rettifica, cartografia, ispezione e OMI.](../assets/chapter-10/04-servizi-procedure-territorio.png)

## 8. Cartografia catastale e rappresentazione del territorio

La cartografia catastale rappresenta particelle, fabbricati, acque, strade e altri elementi rilevanti secondo convenzioni e scale. È organizzata in fogli di mappa e viene oggi gestita in formato digitale e vettoriale, pur conservando la relazione con documenti storici e sistemi di riferimento originari.

La mappa catastale non coincide necessariamente con una carta topografica generale o con la cartografia urbanistica comunale. La prima privilegia identificazione particellare e aggiornamento fiscale; le altre rispondono a finalità territoriali, tecniche o pianificatorie differenti.

Georeferenziare significa collegare la rappresentazione a un sistema di coordinate. Trasformazioni tra sistemi richiedono cautela: precisione grafica originaria, deformazioni dei fogli e qualità dei punti di appoggio condizionano il risultato. Una sovrapposizione GIS visivamente convincente non prova da sola un confine giuridico.

## 9. Estimo: metodo prima del numero

L'estimo formula giudizi economici motivati su beni, diritti o danni. Una stima non consiste nel scegliere un prezzo plausibile; richiede definizione dello scopo, data di riferimento, diritto valutato, caratteristiche del bene, mercato pertinente e procedimento coerente.

Il procedimento comparativo confronta il bene con immobili simili oggetto di scambio, correggendo le differenze rilevanti. Il procedimento reddituale capitalizza un reddito ordinario. Il procedimento del costo considera il costo di riproduzione o sostituzione, depurato quando necessario. In casi complessi possono essere usati procedimenti finanziari o di trasformazione.

Finalità e dati disponibili orientano la scelta. Un'abitazione in un mercato attivo si presta al confronto; un impianto speciale può richiedere il ricorso al costo o al reddito. La relazione di stima espone fonti, assunzioni, calcoli e limiti, così che il risultato possa essere controllato.

### Esempio numerico guidato

Si deve stimare, a fini esclusivamente didattici, il valore di mercato di un appartamento di 80 m². Dopo aver scelto tre compravendite ipotetiche comparabili e aver corretto le differenze rilevanti, si ottengono valori unitari omogeneizzati di 2.050, 2.120 e 1.980 euro al metro quadrato.

1. **Scopo e data:** valore di mercato alla data indicata nella traccia.
2. **Procedimento:** confronto con beni simili; i dati sono ipotetici e non rappresentano quotazioni correnti.
3. **Sintesi unitaria:** (2.050 + 2.120 + 1.980) / 3 = 2.050 euro/m².
4. **Calcolo:** 80 × 2.050 = 164.000 euro.
5. **Conclusione:** 164.000 euro è il risultato del modello assunto, non un valore certo; qualità dei comparabili, superficie, diritti, stato e data possono richiedere altri aggiustamenti.

Il procedimento parte dal quesito, rende confrontabili i dati, sviluppa il calcolo e ne dichiara i limiti. La rendita catastale non entra automaticamente nella media; una quotazione OMI può servire come controllo di coerenza, ma non sostituisce i comparabili né la motivazione.
...
|---|---|---|
| Catasto / pubblicità immobiliare | Il primo identifica e classifica; la seconda rende conoscibili vicende giuridiche. | Le banche dati dialogano, ma non coincidono. |
| Visura / ispezione ipotecaria | La visura espone dati catastali; l'ispezione consulta formalità, note e titoli. | Prima si individua la domanda e poi la banca dati. |
| Rendita / OMI / stima | Sono dato catastale, intervallo orientativo e giudizio estimativo. | Nessuno dei tre è sinonimo degli altri. |
| Mappa / planimetria | La mappa rappresenta particelle; la planimetria l'unità urbana. | Rappresentazioni diverse per oggetti diversi. |
| Voltura / trasferimento | La voltura aggiorna l'intestazione; il diritto deriva dal titolo o fatto giuridico. | Non attribuire effetti civilistici alla procedura catastale. |
...
Usare la quotazione OMI come valore certo. L'intervallo OMI riguarda immobili ordinari di una zona e di un semestre; la stima puntuale deve considerare le caratteristiche specifiche, il diritto valutato e la finalità della valutazione.
...
**1. La voltura catastale:**
A. trasferisce la proprietà;
B. aggiorna l'intestazione sulla base di un titolo o fatto;
C. costituisce un'ipoteca;
D. sostituisce il DOCFA.
**Risposta corretta: B.**

**2. La rendita catastale:**
A. coincide sempre con il prezzo;
B. è un reddito ordinario catastale;
C. deriva dall'ispezione ipotecaria;
D. prova la proprietà.
**Risposta corretta: B.**

**3. L'iscrizione nei registri immobiliari riguarda tipicamente:**
A. l'ipoteca;
B. il classamento;
C. la planimetria;
D. la zona OMI.
...
**4. Le quotazioni OMI:**
A. sostituiscono ogni perizia;
B. sono intervalli orientativi per zone e tipologie;
C. certificano la rendita;
D. provano il titolo.
**Risposta corretta: B.**
...
- [ ] Distinguo catasto terreni e fabbricati.
- [ ] Leggo foglio, particella e subalterno.
- [ ] Spiego categoria, classe, consistenza e rendita.
- [ ] Distinguo DOCFA, PREGEO e voltura.
- [ ] Conosco funzione e limiti della cartografia catastale.
- [ ] Scelgo il procedimento estimativo in base allo scopo.
- [ ] Uso OMI come dato orientativo, non come perizia.
