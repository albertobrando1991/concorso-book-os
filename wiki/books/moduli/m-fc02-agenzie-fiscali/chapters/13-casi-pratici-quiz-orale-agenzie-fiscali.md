...
source_refs: ["sources/m-fc02-dossier-redazionale-agenzie-fiscali.md", "sources/bandi-rappresentativi-m-fc02-agenzie-fiscali-2023-2026.md", "sources/prove-concorsuali-quiz-scritto-orale-dpr-487-1994.md", "sources/capitolo-17-18-corpus-casi-pratici-quesiti-situazionali-2026-05-30.md", "sources/banca-dati-ufficiale-quiz-metodo-bando.md", "sources/domande-impreviste-risposta-sicura-metodo-bando.md", "sources/d-p-r-9-maggio-1994-n-487-accesso-agli-impieghi-pubblici-e-concorsi.md", "sources/d-p-r-16-giugno-2023-n-82-modifiche-al-d-p-r-487-1994-sui-concorsi.md"]
asset_refs:
  - "books/moduli/m-fc02-agenzie-fiscali/assets/chapter-13/01-mappa-bando-performance-finale.png"
  - "books/moduli/m-fc02-agenzie-fiscali/assets/chapter-13/02-quiz-quattro-mosse-parole-spia.png"
  - "books/moduli/m-fc02-agenzie-fiscali/assets/chapter-13/03-casi-ae-adm-ader-griglia.png"
  - "books/moduli/m-fc02-agenzie-fiscali/assets/chapter-13/04-orale-90-secondi-domande-trappola.png"
...
last_compiled_from: ["wiki/sources/m-fc02-dossier-redazionale-agenzie-fiscali.md", "wiki/sources/bandi-rappresentativi-m-fc02-agenzie-fiscali-2023-2026.md", "wiki/sources/prove-concorsuali-quiz-scritto-orale-dpr-487-1994.md", "wiki/sources/capitolo-17-18-corpus-casi-pratici-quesiti-situazionali-2026-05-30.md", "wiki/sources/banca-dati-ufficiale-quiz-metodo-bando.md", "wiki/sources/domande-impreviste-risposta-sicura-metodo-bando.md", "wiki/sources/d-p-r-9-maggio-1994-n-487-accesso-agli-impieghi-pubblici-e-concorsi.md", "wiki/sources/d-p-r-16-giugno-2023-n-82-modifiche-al-d-p-r-487-1994-sui-concorsi.md", "wiki/topics/prova-a-quiz.md", "wiki/topics/prova-orale.md", "wiki/topics/casi-pratici.md"]
---
...
Il Diario errori fiscale, la griglia orale e il piano 30/60/90 raccolgono lo studio in una routine misurabile.
...
Questo capitolo è un banco di prova, non una lezione finale da sottolineare.

Alla prima lettura si riconosce la struttura: quiz, casi, orale, diario e piano. Nella lettura operativa il candidato compila le tabelle con il proprio bando, il profilo e le materie. Dopo una simulazione torna invece alle sole pagine utili per correggere gli errori.

Una pagina è stata usata bene quando produce una domanda, una risposta, una scheda o una decisione di studio.
...
| Catasto e pubblicità immobiliare | Rendita, classamento, voltura, registri, dati immobiliari. | Leggere il problema immobiliare senza confondere catasto e proprietà. | Spiegare funzione informativa e fiscale del sistema. |
| Contabilità e impresa | Bilancio, costi, ricavi, crediti, debiti, documentazione. | Interpretare dati d'impresa utili a controllo, riscossione o dogane. | Collegare bilancio civilistico e rilevanza fiscale senza sovrapporli. |
...
![Figura 13.2 - Quiz M-FC02 in quattro mosse: lettura, esclusione, scelta e controllo delle parole-spia prima della risposta.](../assets/chapter-13/02-quiz-quattro-mosse-parole-spia.png)
...
Dopo la scelta, assegna al quesito una sigla:
...
Le risposte F tornano nel ripasso come gli errori. Il solo punteggio, infatti, non mostra le lacune nascoste da una scelta casuale.

## Batteria di quiz trasversali
...
A. è sempre necessaria una successiva cartella; B. l'atto può costituire titolo per la riscossione; C. AdER determina l'imposta; D. il pagamento è facoltativo.
...
A. è il metodo primario, con le rettifiche previste; B. è sempre il prezzo non verificabile; C. coincide con la tariffa; D. dipende dall'origine preferenziale.
**Risposta: A.**

**6. Il deposito fiscale delle accise:**
A. rende i prodotti esenti; B. consente operazioni in sospensione; C. elimina la garanzia; D. è un deposito doganale ordinario.
**Risposta: B.** Sospensione ed esenzione non coincidono.

**7. Nel gioco pubblico, il concessionario:**
A. opera entro il titolo; B. sostituisce ADM; C. crea liberamente giochi; D. può derogare al divieto per minori.
**Risposta: A.**
...
A. coincide sempre con l'utile; B. deriva dal risultato corretto fiscalmente; C. coincide con la cassa; D. è la somma dei crediti.
**Risposta: B.**
...
| Istituto | Quale atto, potere, adempimento o procedura è rilevante? | Distingue nozione e applicazione. |
...
**Errore da evitare.** Dire che ogni comunicazione dell'Agenzia delle Entrate è automaticamente un accertamento definitivo. Questo errore rivela una confusione tra funzione di assistenza, controllo e potere impositivo.
...
I casi seguenti applicano la stessa griglia a scenari più specifici. Importi e circostanze hanno funzione esclusivamente didattica.

### Caso AE: anomalia tra fatture, ricavi e banca
...
**Competenza.** L'Agenzia delle Entrate può analizzare e controllare la posizione con i poteri previsti. Occorre individuare ufficio, periodo e procedimento.
...
Sottrarre gli accrediti bancari dalle fatture e chiamare il risultato «evasione». Lo scostamento è un segnale, non una prova autosufficiente.

### Caso ADM: origine preferenziale non dimostrata
...
Un contribuente riceve una cartella per tributo comunale. Afferma di aver già pagato una parte prima della formazione del ruolo e, per il residuo, chiede una dilazione.

**Svolgimento guidato
**

**Fatti.** Separare importo già pagato e debito residuo; verificare cartella, data di notifica, ricevuta e carichi inclusi.
...
**Regola.** Il pagamento anteriore alla formazione del ruolo può rientrare nella sospensione legale se sono soddisfatti requisiti e termine. La rateizzazione non annulla il debito.

**Istruttoria.** Presentare documentazione per la sospensione della parte contestata; verificare importo, difficoltà, piano e regime temporale per il residuo.
...
Un utente alza la voce e pretende l'accesso immediato ai dati fiscali del fratello, sostenendo di avere una delega «a casa». La sala è affollata.
...
| Spiegare requisiti, spostare il confronto in modo riservato e indicare come presentare la delega | Adeguata | Unisce legalità, servizio e protezione dei dati. |
| Chiedere a un collega di usare le proprie credenziali | Gravemente inadeguata | Viola sicurezza e responsabilità degli accessi. |
...
Per ritrovare ordine, la risposta dichiara subito il perimetro:

> Il caso va distinto su tre piani: il piano soggettivo, per individuare l'amministrazione e il contribuente; il piano procedimentale, per collocare l'atto o l'adempimento; il piano sostanziale, per capire quale obbligo o potere è coinvolto.

L'apertura chiarisce il metodo, ma acquista valore solo quando viene applicata ai fatti del caso.
...
| Conclusione | Risposta pratica. | "La soluzione non è automatica: dipende dalla qualificazione dell'atto e dal canale previsto." |

La griglia rende la risposta leggibile senza irrigidirla in un modulo burocratico.

![Figura 13.3 - Casi pratici AE, ADM e AdER: una griglia unica per separare fatto, soggetti, materia, sequenza e output.](../assets/chapter-13/03-casi-ae-adm-ader-griglia.png)

## L'orale: non una recita, ma una prova di governo della materia
All'orale la commissione valuta la conoscenza del tema, l'ordine dell'esposizione e la capacità di fermarsi. Parlare a lungo senza costruire una risposta resta l'errore più frequente.

Una risposta orale efficace dura spesso meno di quanto il candidato immagina. La struttura consigliata è la risposta da 90 secondi:
...
![Figura 13.4 - Risposta orale da 90 secondi: definizione, funzione, soggetti, sequenza, esempio e limite per non divagare.](../assets/chapter-13/04-orale-90-secondi-domande-trappola.png)

## Durata della risposta e protocollo anti-invenzione

### Struttura della risposta orale
...
### Risposte da due e quattro minuti

La versione da due minuti contiene definizione, tre nuclei e un esempio. Quella da quattro aggiunge fonte, procedimento, distinzione e criticità. Allenare entrambe evita risposte troppo brevi o incontrollate.
...
### Palestra di domande da commissario e rilanci
...
### Domande impreviste: protocollo anti-invenzione
...
Un errore è risolto solo quando viene verificato una seconda volta. Se sbaglio oggi una domanda sulla differenza tra accertamento e riscossione, non basta leggere la soluzione: devo rispondere di nuovo domani, poi inserirla in una domanda orale e infine riconoscerla in un caso.
...
| Materia | Tributario, dogane, riscossione, contabilità, civile/commerciale, catasto, organizzazione. |
...
Questa scheda deve restare breve. Se diventa un quaderno parallelo, il candidato smette di usarla. La sua forza è la ripetizione.

## Mini-simulazione finale M-FC02
La simulazione finale riproduce la pressione della prova e produce dati utili. La struttura base proposta dura 90 minuti e comprende quattro blocchi.

| Blocco | Durata | Attività | Output |
|---|---:|---|---|
...
![Figura 13.5 - Simulazione, diario e piano 30/60/90: la prova finale produce dati, correzioni e priorità di studio.](../assets/chapter-13/05-simulazione-diario-piano-30-60-90.png)

## Piano 30/60/90 M-FC02
Il piano 30/60/90 è utile quando il concorso non è immediato o quando il candidato deve costruire una preparazione completa. Va sempre corretto con il calendario ufficiale.
...
- Preparare schede su dogane, accise, catasto, contabilità, civile e commerciale applicato.
...
2. Nei concorsi delle Agenzie fiscali la distinzione tra AE, ADM e AdER è parte della risposta, non un dettaglio.
...
**Passaggio 1: diagnosi.** Il problema non è solo contenutistico. Ci sono almeno tre cause:
...
| Dogane/IVA | Quando il problema è doganale e quando è tributario interno? | Caso breve con merce, operatore, documento, controllo. |
...
Se la risposta è no, va cambiato il modo di usare il materiale già disponibile.
...
L'esercizio è completato solo quando è fissata una data di verifica.
