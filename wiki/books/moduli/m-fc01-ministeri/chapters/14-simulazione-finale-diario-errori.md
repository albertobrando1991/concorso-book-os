...
source_refs: ["sources/m-fc01-dossier-redazionale-ministeri-pcm-avvocatura.md", "sources/inpa-formez-ripam-concorsi-funzioni-centrali.md", "sources/prove-situazionali-concorsi-ripam-maeci-sna.md", "sources/prove-concorsuali-quiz-scritto-orale-dpr-487-1994.md"]
...
# Simulazione finale e diario degli errori
...
Al termine devi saper configurare una simulazione partendo dal bando e dalle materie effettive; distinguere dato ufficiale, scelta di allenamento e punto da verificare; svolgere una sessione realistica senza inventare regole di prova; correggere risultato, metodo e strategia; classificare gli errori per causa reale; costruire un diario utilizzabile nei giorni successivi; trasformare il diario in recupero mirato e nuova simulazione.
...
Una simulazione è una prova di allenamento costruita per osservare una prestazione in condizioni controllate. Serve a verificare ciò che il candidato sa produrre, rendere visibili gli errori di contenuto o di processo e fornire dati per il recupero. Non sostituisce il bando e non crea regole ufficiali: formato, criteri e vincoli derivano dagli atti pubblicati.

Il diario completa la simulazione. Registra la causa dell'errore, l'intervento scelto e un secondo tentativo; distingue così la semplice correzione dalla verifica dell'apprendimento. I sette nuclei seguenti sviluppano questa sequenza nel perimetro M-FC01.
...
|---|---|---|---|
| Fonte | Bando, avviso, diario | Scheda personale | Testo vigente e comunicazioni successive |
...
|---|---|---|
| Prima | Leggi consegna, prepara timer e fogli | Aprire appunti "per sicurezza" |
| Giro 1 | Rispondi al sicuro | Bloccarti su una domanda |
| Giro 2 | Lavora sui dubbi | Cambiare per impulso |
| Giro 3 | Controlla completezza | Riscrivere tutto |
| Dopo | Correggi e classifica | Giudicarti solo dal punteggio |
...
|---|---|---|
| Risultato | Quante risposte o output sono adeguati? | Rifare solo i quesiti sbagliati dopo 48 ore |
| Contenuto | Che cosa non era chiaro? | Ripasso mirato su nucleo e distinzione |
| Tempo | Dove ho perso minuti? | Allenamento a giri o schema in 3 minuti |
| Strategia | Ho seguito un ordine efficace? | Regola dei dubbi e controllo finale |
| Esposizione | Ho spiegato in modo concorsuale? | Risposta in 10 righe o orale in 2 minuti |
...
|---|---|---|
| Lacuna | "Non lo sapevo" | Studio mirato e definizione |
| Confusione | "Ho invertito due concetti" | Tabella comparativa |
| Lettura | "Non ho visto il vincolo" | Verbo, limite, soggetto |
| Richiamo | "Lo sapevo ma non usciva" | Recall breve e distanziato |
| Applicazione | "La teoria c'era, il caso no" | Caso fatto-regola-azione |
| Tempo | "Mi sono bloccato" | Giri e timer |
| Strategia | "Ho cambiato senza motivo" | Regola dei dubbi |
| Esposizione | "Non si capiva" | Schema, 10 righe, orale breve |
...
|---|---|---|
| Data | Giorno della simulazione | 09/08 |
| Nucleo | Tema specifico | PIAO e performance |
| Prova | Quiz, breve, caso, orale | Caso |
| Errore | Fatto osservabile | Ho saltato il vincolo di competenza |
| Causa | Categoria | Lettura/applicazione |
| Correzione | Regola utile | Prima ruolo, poi azione |
| Nuovo output | Verifica concreta | Caso da 12 righe |
| Scadenza | Giorno di recupero | Entro 3 giorni |
| Secondo tentativo | Esito | Chiuso / da rifare |

**Scheda compilabile**

| Data | Nucleo | Prova | Errore | Causa | Correzione | Nuovo output | Scadenza | 2° tentativo |
|---|---|---|---|---|---|---|---|---|
| | | | | | | | | |
| | | | | | | | | |
| | | | | | | | | |
...
|---|---|---|
| Lacuna | Scheda essenziale | Quiz nuovo |
| Confusione | Tabella comparativa | Risposta "distingui" |
| Lettura | Consegne annotate | Quesiti con vincoli |
| Richiamo | Recall senza appunti | Mini-quiz a freddo |
| Applicazione | Micro-caso | Caso diverso |
| Tempo | Timer e giri | Sessione breve |
| Strategia | Protocollo dubbi | Simulazione controllata |
| Esposizione | 10 righe / 2 minuti | Traccia orale |

**Piano di recupero sintetico**
...
| 5 | Orale breve |
| 6 | Mini-simulazione mirata |
| 7 | Secondo tentativo e decisione |
...
**1. Nella configurazione di una simulazione, quale dato non deve essere inventato dal candidato?**

A. Il numero di nuclei da ripassare nella settimana.
B. La durata ufficiale della prova, se non ancora indicata negli atti.
...
**4. Quale coppia descrive meglio la differenza tra lacuna e richiamo?**

A. Lacuna: non conosco; richiamo: conosco ma non recupero in tempo.
B. Lacuna: sbaglio per fretta; richiamo: sbaglio per lettura.
C. Lacuna: sbaglio orale; richiamo: sbaglio quiz.
D. Lacuna: errore lieve; richiamo: errore grave.
...
**8. Quale nuova prova verifica meglio il recupero di un errore applicativo?**

A. Rileggere la soluzione appena vista.
B. Rifare identico il quesito subito dopo.
C. Affrontare un caso diverso che richiede la stessa regola.
D. Saltare il tema per evitare frustrazione.

**Risposta corretta: C.** Il recupero vero si vede nel trasferimento: stessa regola, contesto diverso.
...
Stai preparando un concorso per un profilo amministrativo in un'amministrazione centrale. Nella simulazione svolgi un caso: un ufficio riceve una richiesta urgente di chiarimento da un cittadino su una pratica collegata a un procedimento seguito da un'altra struttura. Tu hai accesso ad alcune informazioni generali, ma non sei responsabile del procedimento. Devi indicare come ti comporti.
...
| Criterio | Presente? |
|---|---|
| Identifica il proprio ruolo | |
| Non promette esiti | |
| Orienta verso canale competente | |
| Rispetta riservatezza | |
| Prevede traccia o coinvolgimento responsabile | |
...
"Spieghi come imposterebbe una simulazione finale per un concorso nelle Funzioni Centrali e come utilizzerebbe il diario degli errori nei giorni successivi."

**Scaletta attesa**

1. Partire dal bando: prove, materie, criteri e punti da verificare.
2. Costruire una matrice materia-output: quiz, risposta breve, caso, situazionale, orale.
3. Svolgere la sessione con consegna, timer, giri di risposta e correzione differita.
4. Correggere risultato, contenuto, tempo, strategia ed esposizione.
5. Classificare gli errori per causa.
6. Compilare diario con nuovo output, scadenza e secondo tentativo.
7. Trasformare i pattern in piano di recupero e nuova simulazione.

**Criterio di buona esposizione**

La risposta deve essere ordinata, non generica. Deve evitare numeri ufficiali inventati e deve mostrare il passaggio decisivo: la simulazione non finisce con il punteggio, ma con una scelta di recupero.

## Diario e recupero

Compila ora il diario della verifica precedente.

| Errore | Causa | Correzione | Nuovo output | Scadenza | 2° tentativo |
|---|---|---|---|---|---|
| | | | | | |
| | | | | | |
| | | | | | |
...
Chiudi il modulo solo quando hai una nuova prova mirata. La simulazione finale non serve a stabilire se "sei portato" per il concorso. Serve a rendere visibili gli errori, correggerli e trasformarli in capitale di studio riutilizzabile.
