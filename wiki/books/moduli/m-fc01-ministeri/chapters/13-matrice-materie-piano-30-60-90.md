...
source_refs: ["sources/m-fc01-dossier-redazionale-ministeri-pcm-avvocatura.md", "sources/ccnl-comparti-aree-famiglie-professionali-pa.md", "sources/bandi-rappresentativi-profili-concorsuali-inpa-agenzie-enti-2025-2026.md"]
...
format_version: 2
dati_operativi: []
last_compiled_from: [sources/m-fc01-dossier-redazionale-ministeri-pcm-avvocatura.md, sources/ccnl-comparti-aree-famiglie-professionali-pa.md, sources/bandi-rappresentativi-profili-concorsuali-inpa-agenzie-enti-2025-2026.md, books/il-metodo-bando/chapters/sistema-adattabile.md]
---
...
Alla fine saprai costruire una matrice per Ministeri, Presidenza del Consiglio e Avvocatura dello Stato; attribuire priorità senza inventare probabilità; collegare ogni materia a un output; adattare il lavoro a 30, 60 o 90 giorni; ridurre il programma senza eliminare ciò che il bando rende necessario.

## Mappa BANDO

| Passaggio | Domanda | Prodotto |
|---|---|---|
| B — Bando | Che cosa è richiesto e con quale prova? | Estratto verificato di bando e avvisi |
| A — Aree | Quali materie formano il core e quali dipendono dal profilo? | Mappa delle aree |
| N — Nuclei | Che cosa devo comprendere e saper usare? | Matrice delle priorità |
| D — Diario | Dove perdo punti, tempo o chiarezza? | Registro degli errori e delle decisioni |
| O — Output | Che prestazione devo produrre? | Quiz, risposta orale, caso, schema o simulazione |
...
| Campo | Che cosa registrare | Errore da evitare |
|---|---|---|
| Fonte | Bando, allegato o avviso e versione | Usare una pagina non aggiornata |
...
> 3. Ogni materia ha profondità e output.
> 4. Il rischio personale modifica il tempo, non il bando.
> 5. Un dato incerto resta VERIF.

**Domanda da commissario.** Perché due candidati allo stesso profilo possono avere piani diversi? Il perimetro ufficiale è comune, ma diagnosi, errori, tempo e livello di partenza sono individuali. Non possono invece differire arbitrariamente sulle materie obbligatorie.

**Errore tipico.** Scrivere studiare amministrativo per dieci giorni. La correzione indica nucleo, prestazione e verifica: procedimento, spiegazione di tre minuti, dieci quesiti commentati, revisione degli errori.

**Mini-esercizio.** Prendi una voce del bando e completa i nove campi. Se non sai indicare fonte, prova o output, non assegnare ancora ore.

## N-FC01-13-02 · CORE, ALTA, MEDIA, MOD e VERIF
...
| Situazione | Etichetta | Decisione |
|---|---|---|
| Nucleo esplicito e trasversale | CORE | Studiare subito e richiamare ogni settimana |
| Nucleo strettamente legato al profilo | ALTA o MOD | Allenare nel formato della prova |
| Approfondimento subordinato | MEDIA | Trattare dopo il core |
...
> 3. MOD rappresenta il delta del profilo.
> 4. MEDIA è comprimibile, non inutile.
> 5. VERIF impedisce di trasformare dubbi in fatti.

**Domanda-trappola.** Se una materia ricorre in molti bandi campione, è CORE nel mio? No. I campioni mostrano variabilità; il perimetro nasce dagli atti della tua procedura.
...
| Profilo ipotetico | Domanda di matrice | Output utile |
|---|---|---|
| Amministrativo | Quali istituti devo distinguere e applicare? | Quiz commentato, orale, mini-caso |
| Contabile | Quale processo o distinzione specialistica è richiesta? | Schema ricostruito e caso breve |
| PCM | Quale specificità organizzativa è esplicita? | Confronto e risposta orale |
...
| Blocco | Funzione | Prodotto |
|---|---|---|
| Acquisizione | Comprendere un nucleo nuovo | Schema essenziale o spiegazione |
| Richiamo | Ricostruire senza testo | Domande, mappa a memoria |
| Applicazione | Usare il nucleo nella prova | Quiz, caso, orale |
...
| Giorno/blocco | Nucleo | Priorità | Output | Esito | Decisione |
|---|---|---|---|---|---|
| | | | | | |
| | | | | | |
| | | | | | |
...
La colonna Decisione è obbligatoria. Le opzioni sono: mantenere, aumentare, ridurre, spostare, verificare. Scrivere recuperare tutto non è una decisione. Se un nucleo CORE è debole, si aumenta il richiamo o si cambia esercizio; se un dettaglio MEDIA assorbe tempo senza migliorare la prova, si riduce.

Caso: Paolo dispone di cinque sere e del sabato, ma dopo due settimane completa meno della metà del piano. Scopre di aver collocato teoria nuova in ogni sera e simulazioni soltanto al sabato. Ricostruisce la settimana: due sere per acquisizione, due per richiamo e applicazione, una per recupero; il sabato alterna simulazione e correzione. Il monte ore non cresce, ma la catena produce informazioni.

> **Da sapere in 5 righe**
> 1. Si pianifica sul tempo osservato, non ideale.
> 2. Energia e tipo di attività devono combaciare.
> 3. Ogni settimana contiene output e correzione.
> 4. Il recupero protegge il piano dagli imprevisti.
> 5. Si riduce ampiezza prima di eliminare la verifica.

**Domanda-trappola.** Una settimana piena è più efficace? Non necessariamente. Se non contiene richiamo, applicazione e decisione, misura occupazione e non apprendimento.

**Errore tipico.** Trasferire automaticamente ogni attività saltata alla settimana seguente. Così il debito cresce. Occorre riclassificare: CORE da recuperare, MEDIA da ridurre, attività duplicata da eliminare.

**Mini-esercizio.** Registra per sette giorni tempo previsto, tempo reale e prodotto. Costruisci la settimana successiva sul dato reale.
...
Nei primi giorni compila la matrice, segna VERIF e scegli un solo materiale principale per area. Esegui domande su CORE e MOD anche se non hai ancora studiato: la diagnosi stabilisce da dove partire. Classifica gli errori per causa. Una risposta casualmente corretta con ragionamento fragile resta un rischio.

### Seconda fase: CORE minimo e delta M-FC01

Costruisci una base sui nuclei comuni effettivamente richiesti, poi inserisci organizzazione e profilo ministeriale. Ogni unità termina con un output. Non aspettare la fine della materia: dopo una spiegazione, ricostruisci; dopo una distinzione, confronta; dopo un processo, applica a un caso.

| Periodo | Obiettivo | Evidenza |
|---|---|---|
| Avvio | Matrice e diagnosi | Perimetro, VERIF, errori iniziali |
| Sviluppo | CORE e primi MOD | Output su ogni nucleo |
| Chiusura | Richiamo e prova parziale | Checkpoint del giorno 30 |
...
> 3. Il MOD entra presto, senza divorare il CORE.
> 4. Ogni nucleo produce una prestazione.
> 5. Il giorno 30 obbliga a decidere.

**Domanda da commissario.** Perché fare quesiti prima di completare la teoria? Per misurare il punto di partenza, riconoscere gli errori e scegliere profondità e output. Non è una certificazione finale.

**Errore tipico.** Rimandare la prova finché il programma non è finito. Si scoprono troppo tardi lentezza, incomprensioni e formato inadeguato.

**Mini-esercizio.** Scrivi tre criteri del checkpoint: uno di copertura, uno di prestazione e uno di decisione. Evita formule come studiare di più.

## N-FC01-13-06 · Giorni 31–60: consolidamento e prove
...
|---|---|---|
| Quiz | Conoscenza, distrattore, tempo | Ripasso o drill mirato |
| Orale | Struttura, precisione, collegamenti | Nuova esposizione focalizzata |
...
> 2. Ogni formato di prova richiede criteri propri.
> 3. Il diario deve generare una nuova verifica.
> 4. Il checkpoint del giorno 60 misura la tenuta.
> 5. I tagli proteggono CORE, MOD e correzione.

**Domanda-trappola.** Un punteggio crescente dimostra che la materia è pronta? Non sempre: può dipendere da domande già viste o nascondere debolezze in un altro output.

**Errore tipico.** Fare molte prove senza analizzare le cause. La quantità misura esposizione; è la correzione che modifica la prestazione.

**Mini-esercizio.** Scegli tre errori recenti e assegna a ciascuno causa, intervento e data del nuovo controllo.
...
|---|---|---|
| CORE debole | Fondazione instabile | Richiamo e prova mirata |
| MOD debole | Delta profilo a rischio | Blocco applicativo aggiuntivo |
| MEDIA debole | Rischio subordinato | Ridurre profondità o rinviare |
...
> 2. La simulazione vale solo se viene corretta.
> 3. I nuovi avvisi aggiornano righe precise.
> 4. Il taglio protegge ciò che decide la prova.
> 5. Finire il manuale non equivale a essere pronti.
...
## Errori tipici da sorvegliare

- Trattare un bando campione come previsione del proprio.
- Usare etichette di priorità senza evidenza e senza conseguenza pratica.
...
Una materia compare in bandi campione, ma non negli atti della tua procedura. Come la classifichi?

A. CORE.
B. ALTA.
C. Fuori matrice o VERIF se esiste un dubbio documentato.
D. MOD.

**Risposta corretta: C.** I campioni non sostituiscono il bando. VERIF richiede un motivo e una scadenza, non una vaga possibilità.

### Quiz 2

Quale sequenza è corretta?

A. Ore → manuale → materia → prova.
B. Bando → profilo e prova → nuclei e output → calendario.
C. Quiz → punteggio → bando → calendario.
D. Materia preferita → CORE → avvisi.

**Risposta corretta: B.** Il calendario traduce decisioni già fondate sugli atti e sulla prestazione.
...
Qual è il primo taglio corretto quando il tempo diminuisce?

A. Simulazioni.
B. Materie obbligatorie difficili.
C. Materiali duplicati e contenuti non richiesti.
D. Correzione degli errori.

**Risposta corretta: C.** Simulazione e correzione rendono osservabile la preparazione; le materie obbligatorie non spariscono.

### Quiz 5

Che cosa rende utile una voce del diario?

A. La lunghezza.
B. Causa, correzione e nuova verifica.
C. Il numero di colori.
D. La copia della soluzione.

**Risposta corretta: B.** La voce deve modificare una decisione o un comportamento.

### Quiz 6

Una casella VERIF senza data o evento di controllo è:
...
Il vantaggio principale di un piano da 90 giorni è:

A. Studiare ogni dettaglio.
B. Usare più manuali.
C. Disporre di più cicli di prova e correzione.
D. Evitare la diagnosi.

**Risposta corretta: C.** Più tempo migliora la possibilità di correggere, non elimina la necessità di scegliere.

### Quiz 8

Il CCNL delle funzioni centrali:

A. sostituisce il bando;
B. assegna mansioni identiche a tutti;
C. aiuta a interpretare aree e famiglie, restando subordinato agli atti della procedura;
D. decide la forma della prova.

**Risposta corretta: C.** È un riferimento professionale, non la fonte esclusiva del perimetro concorsuale.
...
| Fonte | Profilo/prova | Nucleo | Priorità | Profondità | Output | Rischio | Verifica |
|---|---|---|---|---|---|---|---|
| | | | | | | | |
| | | | | | | | |
| | | | | | | | |
...
- Ho usato codice profilo e atti aggiornati.
- Ogni nucleo ha priorità, profondità e output.
- I VERIF hanno un prossimo controllo.
- Il calendario contiene richiamo, prova e correzione.
- I checkpoint producono decisioni.
- I tagli proteggono CORE, MOD e prestazione.
- Il piano può essere compresso senza perdere la sua logica.
