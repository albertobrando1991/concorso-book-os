---
id: chapter-m-fl01-08-welfare-locale-servizi-sociali-isee-minori-servizi-educativi
type: book_chapter
title: "Welfare locale, servizi sociali, ISEE, minori e servizi educativi"
...
2. collocare la L. 328/2000 nel sistema integrato di interventi e servizi sociali;
3. distinguere Comune, ambito territoriale sociale, Regione, Stato e INPS;
4. usare l’ISEE come strumento di accesso e non come sinonimo automatico di diritto al beneficio;
5. impostare l’istruttoria di una domanda per contributo, servizio o agevolazione;
6. distinguere avviso, domanda, graduatoria, concessione, diniego e controllo;
...
Studia il capitolo con una griglia a cinque colonne:
...
Questa griglia evita due errori:
...
| --- | --- | --- |
| B - Bando | Il programma richiama servizi sociali, servizi alla persona, ISEE, minori, educativi, asili nido, welfare, fragilità o contributi? | Attiva il blocco welfare locale. |
| A - Aree | La traccia è giuridica, amministrativa, contabile, privacy o di sportello? | Collega procedimento, regolamento, avviso, dati e atto finale. |
| N - Nuclei | Quale nucleo serve: L. 328/2000, ISEE, ambito, LEPS, 0-6, minori, privacy? | Seleziona la fonte giusta senza invadere il servizio sociale professionale. |
| D - Diario | Quale errore fai? | Confondere ISEE e diritto automatico, bisogno e requisito, pubblicazione e privacy. |
| O - Output | Che cosa devi produrre? | Caso guidato, check-list istruttoria, risposta orale, schema atto-procedimento. |

La domanda tipica non sarà sempre teorica. Può essere:

- “Un cittadino chiede un contributo economico”;
- “Una famiglia presenta domanda per il nido comunale”;
- “Un minore è seguito dai servizi sociali”;
- “Un’associazione gestisce un servizio per conto del Comune”;
...
Nel lavoro di un Comune il welfare può riguardare:

- accesso allo sportello sociale;
- contributi economici o agevolazioni tariffarie;
- assistenza domiciliare;
- interventi per persone con disabilità;
- sostegno a persone anziane o non autosufficienti;
- servizi per minori e famiglie;
- servizi educativi per l’infanzia;
- inserimenti in strutture o servizi convenzionati;
- progetti personalizzati;
- compartecipazione alla spesa;
- controlli sui requisiti dichiarati.
...
- gli interventi sociali non sono episodi isolati;
- il sistema coinvolge più livelli istituzionali;
- la programmazione è essenziale;
- il territorio è il luogo in cui il bisogno viene letto e trattato;
...
Questa formulazione è utile perché distingue tre piani:

- piano dei principi;
- piano dell’organizzazione;
- piano del procedimento.
...
Il livello statale definisce cornici, fondi, piani e livelli essenziali. INPS rileva soprattutto per ISEE e prestazioni nazionali. Il terzo settore può essere coinvolto in gestione, co-programmazione, co-progettazione o attuazione di interventi, secondo le regole applicabili e senza confondere collaborazione con affidamento privo di regole.

Schema sintetico:

| Soggetto | Funzione nel welfare locale | Rischio da evitare |
| --- | --- | --- |
| Comune | Accesso, regolamenti, istruttorie, servizi, atti, controlli e relazione con l’utente. | Pensare che ogni beneficio sia discrezionale e informale. |
| Ambito territoriale sociale | Programmazione e gestione coordinata tra Comuni, rafforzamento dei servizi, integrazione territoriale. | Ignorare il livello associato quando il bando lo richiama. |
| Regione | Programmazione, indirizzi, discipline regionali, riparto e standard dei servizi. | Applicare una regola nazionale dove serve la norma regionale. |
| Stato | Cornici, LEPS, fondi, piani nazionali, misure generali. | Citare fondi senza collegarli al procedimento locale. |
| INPS | ISEE, DSU, prestazioni nazionali e scambi informativi nei casi previsti. | Trattare l’ISEE come certificato comunale. |
...
Per un profilo comunale non occorre recitare l’elenco dei LEPS; occorre comprenderne il significato operativo:

- la programmazione sociale non è solo locale;
- le risorse hanno vincoli e finalità;
- gli ambiti territoriali sociali sono decisivi;
...
Una persona o una famiglia può accedere al servizio tramite domanda, sportello sociale, avviso pubblico, segnalazione, presa in carico professionale o canale digitale. In ogni caso l’ufficio deve trasformare il bisogno in procedimento.

La sequenza ordinaria è:

1. individuazione del servizio o beneficio;
2. verifica della fonte: legge, regolamento comunale, atto regionale, avviso, progetto, fondo;
3. presentazione della domanda o attivazione della presa in carico;
4. controllo di identità, residenza, nucleo, requisiti e documentazione;
5. eventuale acquisizione dell’ISEE o verifica dell’attestazione;
6. istruttoria tecnica e amministrativa;
7. formazione di graduatoria o valutazione individuale;
8. adozione dell’atto: concessione, ammissione, esclusione, diniego, compartecipazione;
...
- l’avviso richiede ISEE ordinario o specifico?
- l’attestazione è valida?
- l’ISEE è coerente con il tipo di prestazione?
- sono necessari altri requisiti oltre all’ISEE?
- occorre verificare dichiarazioni ulteriori?
...
Gli atti e i passaggi più frequenti sono:

| Passaggio | Funzione | Esempio |
| --- | --- | --- |
| Regolamento | Stabilisce criteri locali generali. | Regolamento per contributi economici o accesso ai servizi educativi. |
| Avviso | Apre una procedura o raccoglie domande. | Bando per contributo affitto, bonus comunale, iscrizione nido. |
| Domanda | Attiva il procedimento su istanza. | Richiesta di beneficio o servizio. |
| Istruttoria | Verifica requisiti, documenti, ISEE, priorità. | Controllo residenza, nucleo, soglia ISEE, condizioni dichiarate. |
| Valutazione sociale | Esamina il bisogno quando la disciplina lo prevede. | Relazione o progetto dell’assistente sociale. |
| Graduatoria | Ordina i richiedenti secondo criteri predeterminati. | Graduatoria per nido o contributo con risorse limitate. |
| Concessione | Ammette al beneficio o al servizio. | Determinazione di assegnazione contributo. |
| Diniego/esclusione | Respinge per mancanza requisiti o risorse. | Esclusione motivata da graduatoria o carenza documentale. |
| Controllo | Verifica veridicità e permanenza dei requisiti. | Controlli su DSU, residenza, composizione nucleo. |
| Revoca/decadenza | Interviene quando mancano o cessano requisiti. | Recupero o decadenza secondo regolamento. |

Una traccia teorico-pratica può chiedere di redigere una nota istruttoria. In quel caso devi costruire una sequenza pulita: fonte, domanda, requisiti, dati, valutazione, esito, atto.

### Presa in carico e progetto personalizzato
La presa in carico non è una formula generica. Indica un processo attraverso cui il servizio competente legge il bisogno, valuta la situazione e costruisce un percorso di intervento, spesso con più soggetti coinvolti.

Per il candidato amministrativo è importante non invadere il merito professionale. L’assistente sociale o l’equipe valutano il bisogno secondo competenze tecniche. L’ufficio amministrativo deve invece garantire:

- corretta apertura del fascicolo;
- tracciabilità delle comunicazioni;
- rispetto della competenza;
- gestione degli atti;
- copertura amministrativa e contabile quando serve;
- riservatezza;
- conservazione documentale;
- monitoraggio e controlli.

Quando la presa in carico porta a un beneficio economico, a un servizio, a un inserimento o a un progetto, occorre distinguere:

- valutazione professionale del bisogno;
- presupposti amministrativi;
- disponibilità delle risorse;
- atto di autorizzazione o concessione;
...
Nel contesto comunale il tema può comparire in molti modi:

- contributi a famiglie con minori;
- sostegno educativo domiciliare o territoriale;
- servizi per l’infanzia;
- segnalazioni e collaborazione con servizi specialistici;
- interventi per disagio familiare;
- rapporti con autorità giudiziaria minorile nei casi previsti;
...
Il sistema 0-6 comprende servizi educativi per l’infanzia e scuola dell’infanzia, con l’obiettivo di sostenere educazione, cura, relazione, gioco, continuità educativa, pari opportunità e riduzione delle disuguaglianze territoriali, economiche e sociali.

Per il Comune questo si traduce in:

- gestione diretta o indiretta di servizi educativi;
- regolamenti di accesso;
- iscrizioni;
- graduatorie;
- tariffe e agevolazioni;
- rapporti con gestori;
- coordinamento con Regione e sistema scolastico;
- qualità del servizio;
- sicurezza e tutela dei minori;
- trattamento di dati personali di bambini e famiglie.

In prova può comparire un caso su asilo nido comunale:
...
La graduatoria non è un elenco “socialmente intuitivo”. Deve derivare da criteri predeterminati: ISEE, residenza, composizione del nucleo, presenza di minori, disabilità, situazioni lavorative, condizioni sociali, ordine di arrivo solo se previsto e compatibile con la disciplina del servizio.

La tariffa o compartecipazione deve essere collegata alla disciplina del servizio. L’ISEE può servire a differenziare il costo a carico dell’utente o a determinare una soglia di accesso. Ma serve sempre una base regolamentare o un atto che definisca criteri e modalità.
...
- programmazione del bisogno;
- scelta dello strumento giuridico;
- eventuale co-programmazione o co-progettazione;
- affidamento o convenzione quando applicabile;
- accreditamento o autorizzazione;
...
Una pratica sociale può contenere:

- dati anagrafici;
- situazione economica;
- composizione familiare;
- condizioni abitative;
- dati su disabilità o salute;
- informazioni su minori;
- relazioni sociali;
- dati giudiziari o informazioni molto delicate nei casi previsti;
- valutazioni professionali.

Il GDPR usa la categoria di “categorie particolari di dati personali” per dati come salute, vita sessuale, origine, convinzioni, ecc. Nei concorsi può comparire ancora la parola “dati sensibili”, ma conviene conoscere il linguaggio attuale.
...
- comunicazioni solo quando necessarie e consentite;
- oscuramento o limitazione in caso di pubblicazione o accesso agli atti.

Attenzione alla trasparenza: un beneficio pubblico può richiedere atti amministrativi, ma non autorizza a pubblicare dettagli sulla fragilità della persona. La pubblicazione deve rispettare norme su trasparenza e protezione dei dati.
...
3. individuare controinteressati;
4. valutare dati personali e categorie particolari;
5. oscurare ciò che non è necessario;
...
| Caso | Procedimento | Atto/output | Attenzione |
| --- | --- | --- | --- |
| Contributo economico | Domanda, ISEE, requisiti, istruttoria, disponibilità risorse. | Concessione, diniego, graduatoria o liquidazione. | Controlli su dichiarazioni e motivazione. |
| Asilo nido comunale | Avviso/iscrizione, ISEE, criteri, punteggio, graduatoria. | Ammissione, lista d’attesa, tariffa. | Dati di minori e criteri pubblici. |
| Assistenza domiciliare | Domanda o presa in carico, valutazione bisogno, progetto. | Attivazione servizio, compartecipazione, revisione. | Dati sanitari/sociali e ruolo professionale. |
| Minore in situazione fragile | Segnalazione, valutazione servizio competente, raccordo istituzionale. | Progetto, intervento, comunicazione agli enti competenti. | Riservatezza, interesse del minore, competenze. |
| Agevolazione tariffaria | Domanda, ISEE, verifica regolamento. | Tariffa ridotta o esclusione. | ISEE non basta senza disciplina del servizio. |
| Servizio gestito da terzo | Programmazione, affidamento/convenzione/accreditamento, controllo. | Contratto, convenzione, report, liquidazione. | Responsabilità pubblica e trattamento dati. |

### Caso guidato: domanda per contributo e presa in carico
Una famiglia residente nel Comune presenta domanda per un contributo economico straordinario. Allegata alla domanda c’è un’attestazione ISEE valida. Dalla documentazione emergono difficoltà economiche, presenza di due minori e una situazione abitativa instabile. Il regolamento comunale prevede che il contributo sia concesso nei limiti delle risorse disponibili, previa istruttoria dell’ufficio e valutazione del servizio sociale.

Come si imposta la pratica?

Primo passaggio: individuare la fonte.

L’ufficio deve verificare regolamento comunale, eventuale avviso, fondi disponibili, criteri di accesso e competenza del servizio. Non basta la domanda del cittadino.

Secondo passaggio: aprire l’istruttoria.

Si verificano identità, residenza, nucleo, completezza della domanda, validità ISEE, requisiti ulteriori e documentazione. Se mancano elementi essenziali, si può chiedere integrazione secondo le regole del procedimento.

Terzo passaggio: distinguere requisito economico e valutazione sociale.

L’ISEE documenta la condizione economica, ma non sostituisce la valutazione complessiva prevista dal regolamento. Se il servizio sociale deve valutare il caso, l’ufficio amministrativo deve acquisire l’esito nel rispetto delle competenze e della riservatezza.

Quarto passaggio: decidere e motivare.

Se i requisiti ci sono e le risorse consentono l’intervento, si adotta l’atto di concessione o ammissione al beneficio. Se mancano requisiti o risorse, si motiva il diniego o l’esclusione. Se esiste graduatoria, si applicano i criteri predeterminati.

Quinto passaggio: proteggere i dati.

La pratica contiene dati su minori, condizione economica e situazione familiare. Le comunicazioni devono essere limitate agli interessati legittimati; eventuali pubblicazioni devono evitare dati eccedenti.

Risposta sintetica da prova:

> La domanda va trattata come procedimento amministrativo di welfare locale. L’ufficio verifica la fonte regolamentare, apre l’istruttoria, controlla residenza, nucleo, ISEE e requisiti, acquisisce la valutazione del servizio sociale se prevista, applica criteri e risorse disponibili, adotta un atto motivato di concessione, esclusione o diniego e tutela i dati personali, soprattutto per la presenza di minori e informazioni sulla fragilità familiare.

### Come rispondere all’orale
Una domanda generale sul welfare locale può essere risolta con questa scaletta:

1. definizione: sistema locale di interventi e servizi sociali, educativi e di sostegno a persone e famiglie;
2. fonte base: L. 328/2000 per sistema integrato;
3. organizzazione: Comune, ambito territoriale sociale, Regione, Stato, INPS, terzo settore;
4. strumenti: regolamento, avviso, domanda, ISEE, istruttoria, graduatoria, beneficio, progetto;
...
B. sostituisce la domanda dell’interessato;
C. costituisce un elemento dell’istruttoria, da leggere con gli altri requisiti e con le risorse disponibili;
D. impedisce ogni controllo successivo.

**Risposta corretta: C.** L’ISEE misura la situazione economica equivalente e può essere requisito, criterio di priorità o parametro tariffario. Il diritto al beneficio dipende però dalla disciplina della misura, dagli altri requisiti, dall’eventuale graduatoria e dalle risorse. L’attestazione non sostituisce l’istruttoria e non esclude i controlli.

### Quiz 2 — Valutazione sociale e decisione amministrativa

La valutazione professionale dell’assistente sociale:

A. può concorrere alla presa in carico e alla decisione, restando distinta dai presupposti e dagli atti amministrativi;
B. coincide sempre con l’atto finale di concessione;
C. rende inutili regolamento, istruttoria e motivazione;
D. può essere sostituita da un controllo automatico dell’ISEE.

**Risposta corretta: A.** La valutazione professionale riguarda il bisogno e il progetto di intervento; l’amministrazione deve inoltre verificare competenza, requisiti, regole, risorse e forma dell’atto. Distinguere i due piani evita sia l’arbitrio sia l’invasione delle competenze professionali.

### Quiz 3 — Ruolo dell’ambito territoriale sociale

Quale affermazione descrive meglio l’ambito territoriale sociale?

A. è il livello nel quale più Comuni possono programmare e gestire in modo coordinato funzioni e servizi sociali;
B. È sempre un ufficio statale periferico;
C. sostituisce in ogni caso la Regione;
D. rilascia l’attestazione ISEE al posto dell’INPS.

**Risposta corretta: A.** L’ambito favorisce programmazione coordinata, omogeneità e capacità amministrativa tra Comuni. Assetto, funzioni e strumenti dipendono dalla disciplina applicabile. Non è una sovraordinazione generale sui Comuni, non sostituisce la Regione e non trasforma l’ISEE in un documento locale.
...
B. il solo valore ISEE;
C. il regolamento, l’avviso e gli eventuali strumenti specifici previsti per situazioni particolari;
D. l’ordine verbale di un amministratore.

**Risposta corretta: C.** L’ufficio deve applicare regole predeterminate e verificare se la disciplina consente riaperture, liste successive, priorità o interventi diversi. La fragilità richiede attenzione, ma non autorizza deroghe informali. Se la misura ordinaria non è accessibile, il servizio valuta gli altri canali previsti.
