---
id: chapter-m-fl01-13-territorio-patrimonio-edilizia-lavori-interfaccia-amministrativa
type: book_chapter
title: "Territorio, patrimonio, edilizia e lavori: interfaccia amministrativa"
status: revised_draft
domain: "concorsi pubblici italiani"
topics: ["enti locali", "territorio", "edilizia", "urbanistica", "sue", "suap", "patrimonio", "beni pubblici", "lavori pubblici", "contratti pubblici", "procedimento amministrativo", "metodo bando"]
...
- quale ufficio è coinvolto;
- quale procedimento si apre;
- quale atto deve essere adottato;
- quale documento entra nel fascicolo;
- quale controllo è necessario;
- quale profilo va rinviato al tecnico;
- quale collegamento esiste con patrimonio, contratti, bilancio e trasparenza.
...
2. distinguere SUE, SUAP, ufficio tecnico, patrimonio, lavori pubblici, Polizia locale e responsabile finanziario;
3. riconoscere i titoli edilizi e le segnalazioni come oggetti amministrativi, senza trasformare il capitolo in edilizia tecnica;
4. collegare una pratica edilizia a protocollo, responsabile del procedimento, istruttoria, pareri, termini, accesso e fascicolo;
5. distinguere il bene comunale come bene demaniale, patrimoniale indisponibile o patrimoniale disponibile;
6. impostare un caso su uso, concessione, manutenzione o tutela di un bene comunale;
7. leggere i lavori pubblici come intersezione tra programmazione, progettazione, procurement, esecuzione, contabilità e patrimonio;
8. sapere quando rinviare a VOL-10 e ai moduli tecnici specialistici.
...
| --- | --- | --- |
| B - Bando | Il programma richiama edilizia, urbanistica, SUAP, SUE, patrimonio, lavori pubblici, beni comunali, polizia edilizia o manutenzioni? | Attiva il blocco territorio-patrimonio-lavori. |
| A - Aree | La traccia è amministrativa, tecnica, patrimoniale, contrattuale, contabile o di controllo? | Collega procedimento, TUEL, DPR 380/2001, SUAP, Codice civile beni pubblici e Codice contratti. |
| N - Nuclei | Quale nucleo devo trattare senza eccedere? | Sportello, titolo edilizio, bene pubblico, uso del bene, lavori, RUP, fascicolo. |
...
- governo locale degli spazi;
- pratiche edilizie;
- insediamenti produttivi;
- occupazione e uso di aree;
- patrimonio immobiliare comunale;
- manutenzione di edifici e strade;
- lavori pubblici;
...
| Capitolo precedente | Collegamento con il territorio |
| --- | --- |
| Capitolo 4 sugli atti | Delibere, determinazioni, ordinanze, pareri e provvedimenti tecnici. |
| Capitolo 5 sul procedimento | Istanza, responsabile, comunicazioni, termini, accesso e fascicolo. |
| Capitolo 6 sui servizi digitali | Pratiche online, portali, protocollazione, fascicolo informatico. |
| Capitolo 10 sulla contabilità | Impegni, liquidazioni, investimenti, manutenzioni e pagamenti. |
| Capitolo 11 su entrate e patrimonio | Beni comunali, canoni, inventario, valorizzazione e uso. |
| Capitolo 12 sul procurement | Affidamenti, RUP, CIG, esecuzione e controlli. |
...
| Regime | Attenzione amministrativa |
| --- | --- |
...
1. registrazione della segnalazione;
2. verifica della competenza comunale;
3. sopralluogo o accertamento, se necessario;
4. relazione tecnica o verbale;
5. confronto con titoli edilizi esistenti;
6. eventuale avvio del procedimento;
...
- ricezione telematica della pratica;
...
| Bene | Lettura amministrativa |
| --- | --- |
| Strada, piazza, area di uso pubblico | Possibile regime demaniale o pubblicistico; uso tramite autorizzazione/concessione secondo disciplina. |
| Scuola, biblioteca, sede comunale, impianto sportivo destinato a servizio | Patrimonio indisponibile o bene vincolato a servizio pubblico, secondo caso. |
| Immobile non destinato a servizio pubblico | Possibile patrimonio disponibile, con gestione patrimoniale più vicina al diritto comune ma sempre vincolata a interesse pubblico, trasparenza e contabilità. |
| Bene mobile assegnato a ufficio | Inventario, consegnatario, custodia, eventuale responsabilità. |
...
- ufficio deve aggiornare inventario o consegnatari.

La risposta deve passare da una tabella minima.
...
- danni a beni pubblici;
- mancata manutenzione;
- responsabilità per custodia;
- squilibri di bilancio;
- contenzioso con utenti o concessionari;
...
M-FL01 non entra nel dettaglio tecnico, ma deve fissare il ciclo.
...
| Affidamento | Quale procedura o strumento si usa secondo Codice contratti? |
...
- riparazione urgente in una scuola;
- manutenzione stradale;
- adeguamento di edificio comunale;
- abbattimento barriere architettoniche;
- sistemazione di impianto sportivo;
- messa in sicurezza di un immobile;
- piccoli lavori su sede comunale.

Il candidato deve evitare due scorciatoie:

1. trattare ogni intervento come spesa minuta;
2. trattare ogni intervento come appalto complesso.

La risposta va graduata.

| Situazione | Lettura |
| --- | --- |
| Piccolo intervento minuto nei limiti regolamentari | Valutare se rientra in gestione semplificata o economale, con grande prudenza. |
| Manutenzione programmabile | Programmazione, copertura, RUP, affidamento, esecuzione e verifica. |
...
| --- | --- | --- | --- |
| Pratica edilizia privata | SUE, ufficio tecnico | Istanza, SCIA, CILA, permesso, fascicolo edilizio | Completezza, istruttoria, termini, titoli, vigilanza. |
| Attività produttiva | SUAP, commercio, tecnico, altri enti | Procedimento unico, ricevuta, autorizzazione, conferenza | Coordinamento enti, requisiti, controlli successivi. |
| Dehors o suolo pubblico | SUAP/commercio, patrimonio, Polizia locale, entrate | Concessione/autorizzazione, canone, planimetria | Uso conforme, pagamento, viabilità, decoro. |
| Bene comunale assegnato a terzi | Patrimonio, servizio competente, finanziario | Concessione, convenzione, locazione, regolamento | Destinazione, canone, scadenze, inventario. |
| Segnalazione abuso edilizio | Ufficio tecnico, Polizia locale | Segnalazione, verbale, relazione, avvio procedimento | Accertamento, titolo esistente, atto repressivo se dovuto. |
| Manutenzione immobile comunale | Tecnico, lavori pubblici, patrimonio, finanziario | Relazione, determina, affidamento, fascicolo lavori | Copertura, esecuzione, verifica, liquidazione. |
| Lavoro pubblico | Lavori pubblici, RUP, finanziario, contratti | Programma, progetto, affidamento, contratto, collaudo | Tempi, qualità, contabilità, trasparenza, aggiornamento bene. |
...
- attività produttiva;
- profili edilizi;
- possibile uso di suolo pubblico;
- eventuali profili di commercio, igiene, sicurezza, impatto acustico o insegna;
...
3. individuare i procedimenti collegati;
4. richiedere integrazioni se necessarie;
...
#### 4. Controlli
I controlli non finiscono con la ricevuta.

Occorre verificare:

- conformità urbanistico-edilizia;
- correttezza della segnalazione o del titolo;
- rispetto delle condizioni su occupazione o insegna;
- pagamento di canoni dovuti;
- eventuali prescrizioni;
- uso effettivo conforme.
...
- sala civica?
- immobile destinato a servizio pubblico?
- bene disponibile?
...
- durata;
- priorità o graduatorie;
- canone, tariffa, rimborso spese o esenzione se prevista;
- responsabilità per danni;
- assicurazione o cauzione se richiesta;
...
> Durante forti piogge si verifica infiltrazione nel tetto di una scuola comunale. Il responsabile deve attivare un intervento urgente per evitare danni e interruzione del servizio.

#### 1. Oggetto
Non è una semplice spesa qualunque. Riguarda:

- bene comunale destinato a servizio pubblico;
- sicurezza e continuità del servizio scolastico;
- intervento tecnico;
- eventuale urgenza;
- affidamento di lavori o servizio tecnico;
...
6. lavori pubblici: leggere il ciclo da fabbisogno a programmazione, RUP, affidamento, esecuzione, verifica e pagamento;
7. Polizia locale: vigilanza, sopralluoghi, verbali e controlli sul territorio;
8. limite: rinviare a VOL-10 per urbanistica, edilizia tecnica, progettazione e lavori avanzati.
...
- B. Attivare il SUAP quale interfaccia dell'impresa, raccordandolo con l'ufficio competente per i profili edilizi.
- C. Inviare tutto alla Polizia locale.
- D. Trattare separatamente le pratiche senza coordinamento.

**Risposta corretta: B.** L'oggetto prevalente è una vicenda dell'attività produttiva; il profilo edilizio non scompare, ma viene acquisito nel procedimento coordinato. A confonde bene fisico e funzione amministrativa; C attribuisce alla vigilanza un compito istruttorio generale; D scarica sul richiedente il raccordo che lo sportello unico deve organizzare.

### Quiz 2 — Sportello e competenza

Quale affermazione descrive meglio il rapporto fra sportello unico e uffici coinvolti?

- A. Lo sportello unico assorbe sempre ogni competenza tecnica e decisoria.
- B. Lo sportello serve solo a protocollare e non coordina nulla.
- C. Lo sportello riceve e coordina secondo il regime applicabile; gli uffici restano responsabili delle valutazioni e degli atti attribuiti.
- D. La competenza dipende soltanto dal nome dell'ufficio nell'organigramma.

**Risposta corretta: C.** Un unico punto di accesso semplifica la relazione con cittadino o impresa, ma non cancella il riparto delle attribuzioni. A confonde coordinamento e assorbimento; B riduce lo sportello a casella postale; D ignora legge, regolamenti e contenuto concreto della funzione.
...
- B. Il verbale documenta i fatti; l'ufficio competente li confronta con titoli e disciplina, quindi il responsabile adotta l'eventuale provvedimento.
- C. L'esposto del vicino dimostra già l'abuso.
- D. La Polizia locale sostituisce sempre la relazione tecnica.

**Risposta corretta: B.** Accertamento materiale, valutazione tecnico-giuridica e decisione hanno funzioni distinte. Il verbale è importante, ma non coincide necessariamente con la qualificazione completa né con l'atto finale. A, C e D saltano l'istruttoria, la competenza e le garanzie del procedimento.
...
- C. Qualificazione e destinazione del bene, regolamento applicabile e compatibilità dell'uso richiesto.
- D. Se l'immobile può essere trattato come proprietà privata senza vincoli.

**Risposta corretta: C.** Il regime del bene orienta titolo, procedura, durata, canone e controlli. Il consenso politico informale non sostituisce competenza e atto; il metodo di pagamento viene dopo la decisione sull'uso; anche il patrimonio disponibile resta sottoposto alle regole dell'amministrazione pubblica.

### Quiz 6 — Manutenzione urgente

Una infiltrazione interessa il tetto di una scuola. Quale affermazione è corretta?

- A. L'urgenza consente sempre di chiamare una ditta e formare gli atti in seguito.
- B. Un intervento su una scuola è sempre spesa economale.
- C. Occorre mettere in sicurezza, documentare e motivare l'urgenza, individuare competenza e copertura, affidare e verificare l'intervento secondo il regime applicabile.
- D. Il responsabile finanziario sceglie la soluzione tecnica.

**Risposta corretta: C.** La tempestività deve convivere con responsabilità e tracciabilità. A normalizza una regolarizzazione successiva; B confonde urgenza e spesa minuta; D attribuisce al controllo contabile una valutazione tecnica. Il fascicolo deve rendere leggibili rischio, decisione, affidamento ed esito.

### Quiz 7 — Chiusura del fascicolo

Quando può dirsi amministrativamente chiuso un intervento su un bene comunale?

- A. Quando è stato individuato l'operatore economico.
- B. Quando arriva la fattura.
- C. Dopo esecuzione verificata, liquidazione e pagamento, conservazione dei documenti e aggiornamenti patrimoniali eventualmente necessari.
- D. Appena il RUP viene nominato.

**Risposta corretta: C.** Affidamento e fattura sono passaggi intermedi. Il risultato deve essere controllato e il fascicolo deve documentare esecuzione, spesa e conseguenze sul bene. Le risposte A, B e D riducono il lavoro pubblico a un singolo atto e ignorano la fase esecutiva.
...
| Situazione | Porta principale | Uffici da coinvolgere | Output |
| --- | --- | --- | --- |
| Cittadino presenta SCIA per lavori interni. | | | |
| Impresa apre laboratorio con opere interne. | | | |
| Associazione chiede palestra comunale per sei mesi. | | | |
| Bar chiede dehors su area pubblica. | | | |
| Segnalazione di veranda abusiva. | | | |
| Infiltrazione urgente in scuola comunale. | | | |

Soluzione guida:

| Situazione | Porta principale | Uffici da coinvolgere | Output |
| --- | --- | --- | --- |
| Cittadino presenta SCIA per lavori interni. | SUE. | Ufficio tecnico. | Protocollazione, fascicolo, verifica e controlli. |
| Impresa apre laboratorio con opere interne. | SUAP con raccordo SUE/tecnico. | SUAP, tecnico, eventuali enti competenti. | Procedimento unitario, pratiche edilizie collegate, controlli. |
| Associazione chiede palestra comunale per sei mesi. | Patrimonio/servizio sport. | Patrimonio, sport, finanziario. | Concessione o convenzione, condizioni, canone/tariffa, fascicolo. |
| Bar chiede dehors su area pubblica. | SUAP/commercio e patrimonio. | SUAP, patrimonio, Polizia locale, entrate. | Autorizzazione/concessione, planimetria, canone, controlli. |
| Segnalazione di veranda abusiva. | Vigilanza edilizia. | Ufficio tecnico, Polizia locale. | Accertamento, relazione/verbale, avvio procedimento, atto conseguente. |
| Infiltrazione urgente in scuola comunale. | Lavori/patrimonio. | Tecnico, lavori pubblici, finanziario, RUP. | Relazione, affidamento, intervento, verifica, liquidazione. |
...
- So distinguere SUE, SUAP, ufficio tecnico, patrimonio e lavori pubblici?
- So riconoscere quando una pratica immobiliare passa dal SUAP e non solo dal SUE?
- So parlare di permesso, SCIA e CILA senza inventare dettagli tecnici non verificati?
- So descrivere la sequenza amministrativa di una pratica edilizia?
- So collegare Polizia locale e ufficio tecnico nella vigilanza edilizia?
- So qualificare un bene comunale per regime e destinazione?
- So impostare un caso di uso di sala, palestra, suolo pubblico o immobile comunale?
...
- D.P.R. 6 giugno 2001, n. 380, Testo unico dell'edilizia, nel testo vigente, per titoli, agibilità e vigilanza edilizia.
