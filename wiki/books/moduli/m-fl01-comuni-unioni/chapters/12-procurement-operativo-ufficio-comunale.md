...
- B. Definire il fabbisogno e verificarne programmazione e copertura.
- C. Acquisire il CIG.
- D. Attendere la prima fattura.

**Risposta corretta: B.** L'acquisto nasce dal bisogno pubblico. Operatore, CIG e fattura appartengono a fasi successive. Un servizio ricorrente richiede inoltre una valutazione complessiva che impedisca di mascherarlo come serie di piccole urgenze.

### Quiz 2 — RUP e responsabile finanziario

Quale affermazione descrive correttamente i ruoli?

- A. Il responsabile finanziario verifica la qualità tecnica del servizio.
- B. Il RUP è sempre un soggetto esterno.
- C. Il RUP presidia il progetto; il responsabile finanziario controlla i profili contabili.
- D. Il RUP coincide necessariamente con il tesoriere.

**Risposta corretta: C.** Le funzioni possono incontrarsi nel procedimento, ma restano distinte. Il controllo della copertura non sostituisce quello sulla prestazione e il tesoriere esegue i pagamenti ordinati dall'ente.
...
- B. Oggetto, importo, contraente, ragioni della scelta e requisiti.
- C. Una procedura aperta simulata.
- D. Il pagamento anticipato integrale.

**Risposta corretta: B.** L'atto rende controllabile la scelta. Può essere concentrato con l'affidamento, ma la semplificazione documentale non elimina contenuto, motivazione e copertura.
...
- A. Consip e MEPA sono sinonimi.
- B. Il MEPA sostituisce il Codice dei contratti.
- C. Acquisti in Rete è il portale e il MEPA è uno degli strumenti disponibili.
- D. Usare una convenzione elimina la verifica del fabbisogno.

**Risposta corretta: C.** Consip opera nel programma di razionalizzazione; il portale dà accesso alle iniziative; il MEPA è uno strumento. In ogni caso l'ufficio deve verificare pertinenza, copertura e risultato.

### Quiz 7 — Liquidazione

Quando può essere liquidata la fattura di un servizio?

- A. Appena arriva al protocollo.
- B. Dopo che il tesoriere ha scelto il capitolo.
- C. Dopo la verifica di titolo, prestazione, importo, regolarità ed esigibilità.
- D. Solo alla fine dell'esercizio.

**Risposta corretta: C.** La fattura non prova da sola l'esatto adempimento. Il responsabile competente verifica la prestazione; il servizio finanziario presidia la successiva regolarità contabile e l'ordinazione.
