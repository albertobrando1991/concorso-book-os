...
last_compiled_from: [
  ...
  "wiki/sources/bandi-rappresentativi-vol-04-giustizia-upp.md",
...
1. fascicolo: capire che cosa contiene e in quale stato si trova;
2. ricerca: individuare la risposta giuridica utile alla questione;
3. udienza: preparare materiali essenziali prima e dopo il momento processuale;
4. scheda: trasformare informazioni sparse in documento operativo.

Questi quattro assi non sono separati. Una buona scheda nasce da una lettura ordinata del fascicolo. Una ricerca utile nasce da una questione ben formulata. Una udienza preparata bene richiede fascicolo, cronologia, termini, domande, eccezioni, prove e provvedimenti precedenti. Una bozza efficace, nei limiti del ruolo, richiede materiali puliti.

Il candidato che capisce questa catena studia meglio e risponde meglio.

### Obiettivo operativo del capitolo
Al termine del capitolo devi saper fare sette operazioni:

1. descrivere le mansioni AUPP senza formule generiche;
2. leggere un fascicolo con una griglia ordinata;
3. distinguere fatti, atti, questioni, norme e adempimenti;
4. svolgere una ricerca utile e non dispersiva;
5. compilare una scheda fascicolo o una scheda udienza;
...
| Blocco | Contenuto |
|---|---|
| Identificazione | Ufficio, fase, parti, materia, stato |
| Cronologia | Atti principali in ordine |
| Questioni | Punti giuridici o processuali da trattare |
| Prossima azione | Udienza, ricerca, bozza, comunicazione, verifica |
...
- orientare rapidamente chi la legge;
...
| Sezione | Contenuto |
|---|---|
| Dati essenziali | Ufficio, fase, materia, parti/soggetti, stato |
| Oggetto | Che cosa riguarda il fascicolo |
| Cronologia | Atti e passaggi principali |
...
|---|---|
| Atto introduttivo depositato | Quale domanda o contestazione emerge? |
...
- fascicoli individuati;
- stato del procedimento chiaro;
...
| Campo | Contenuto |
|---|---|
| Fascicolo | Identificazione e stato |
| Udienza | Data, fase, oggetto operativo |
...
Applica il Metodo BANDO al lavoro dell'AUPP.

| Lettera | Domanda da porsi | Applicazione AUPP |
|---|---|---|
| B - Bando | Il profilo richiede UPP, fascicolo, udienza o supporto al magistrato? | Traduco la formula in mansioni e output |
| A - Aree | Quali aree devo collegare? | Ordinamento giudiziario, processo operativo, digitale, cancelleria |
| N - Nuclei | Quali nuclei non posso sbagliare? | Fascicolo, cronologia, questione, ricerca, scheda, udienza, bozza |
| D - Diario | Dove rischio errore? | Riassunto troppo lungo, ricerca dispersiva, bozza confusa con decisione |
| O - Output | Che cosa devo produrre? | Scheda fascicolo, scheda udienza, scheda ricerca, risposta orale |

Questa mappa serve a evitare lo studio passivo. Ogni volta che ripassi l'AUPP, devi chiederti quale output sapresti compilare.

### Laboratorio: modello di scheda fascicolo
Usa questo modello come base di allenamento.

| Campo | Da compilare |
|---|---|
| Identificazione | Ufficio, fase, materia, riferimento fascicolo |
| Soggetti | Parti o soggetti rilevanti |
| Oggetto | Sintesi in una o due righe |
| Stato | Fase attuale e prossima scadenza/udienza |
| Cronologia essenziale | Atti principali in ordine |
...
> Un magistrato assegna all'AUPP un fascicolo da preparare per un'udienza fissata a breve. Nel fascicolo sono presenti atto introduttivo, difese, documenti, un provvedimento precedente e una questione giuridica ricorrente. Il candidato deve spiegare come procedere.
...
| Fase | Azione |
|---|---|
| Identificazione | Colloco ufficio, fase, parti e oggetto |
...
> Una ricerca AUPP deve partire dalla questione concreta e restituire un quadro selezionato. Non basta allegare materiali. Occorre indicare norma o istituto, orientamenti pertinenti, rilevanza per il fascicolo e limiti della ricerca, lasciando al magistrato la valutazione decisoria.
...
3. individua atti e provvedimenti rilevanti;
...
> L'AUPP non deve riscrivere il fascicolo, ma renderlo leggibile e utilizzabile per l'ufficio.
...
Se una frase non aiuta a rispondere a queste domande, probabilmente va ridotta o spostata.

### Mini-esercizio
Leggi l'estratto sintetico:

> Nel fascicolo risultano un atto introduttivo, una memoria difensiva, tre documenti, un provvedimento precedente, un'udienza fissata e una questione su un termine processuale. Il magistrato chiede una scheda breve.
...
- Identificazione del fascicolo: ufficio, fase, parti/soggetti, oggetto e stato.
- Cronologia essenziale: atto introduttivo, memoria, documenti, provvedimento precedente, udienza fissata.
...
- So spiegare le mansioni dell'AUPP come output concreti?
- So leggere un fascicolo distinguendo contesto, cronologia, questioni e compito?
- So costruire una scheda fascicolo breve ma tracciabile?
- So preparare una scheda udienza?
- So fare una ricerca mirata senza accumulare materiale inutile?
- So distinguere bozza preparatoria e decisione?
