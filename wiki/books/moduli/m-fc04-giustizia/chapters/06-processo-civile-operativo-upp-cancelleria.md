...
last_compiled_from: [
  ...
  "wiki/books/moduli/m-fc04-giustizia/chapters/03-uffici-giudiziari-ordinamento-lavoro-ufficio.md",
  "wiki/books/moduli/m-fc04-giustizia/chapters/04-ufficio-per-il-processo-struttura-progetto-flussi.md",
  "wiki/books/moduli/m-fc04-giustizia/chapters/05-lavoro-aupp-fascicolo-udienza-ricerca-scheda.md",
...
1. descrivere il processo civile come flusso di ufficio;
2. collegare atto introduttivo, iscrizione, ruolo e fascicolo;
3. distinguere comunicazioni, notificazioni e depositi in chiave operativa;
4. spiegare che cosa controlla la cancelleria e che cosa prepara l'UPP;
5. leggere l'udienza come fase prima-durante-dopo;
...
| Cosa studiare | Come studiarlo |
|---|---|
| Atto introduttivo | Come ingresso della controversia nel sistema ufficio |
| Iscrizione e ruolo | Come registrazione, tracciamento e organizzazione |
| Fascicolo | Come contenitore operativo di atti, documenti e provvedimenti |
| Depositi | Come alimentazione del fascicolo, spesso telematica |
| Comunicazioni e notificazioni | Come passaggi che danno conoscenza o impulso |
| Udienza | Come evento preparato e seguito dall'ufficio |
| Provvedimenti | Come atti del magistrato con effetti successivi |
...
|---|---|---|
| Avvio | Atto introduttivo | Quale domanda entra e con quale forma? |
| Registrazione | Iscrizione/ruolo | Come viene tracciato il procedimento? |
| Fascicolo | Atti/documenti | Che cosa contiene il fascicolo e cosa manca? |
| Contraddittorio | Depositi/difese | Quali parti compaiono e quali questioni emergono? |
| Trattazione | Udienza | Che cosa deve essere preparato? |
| Decisione o passaggio | Provvedimento | Quale atto del giudice produce effetti? |
...
- deposito o notificazione dell'atto secondo le regole applicabili;
- iscrizione a ruolo, quando prevista;
- apertura o alimentazione del fascicolo;
- acquisizione dei dati essenziali;
- pagamento o verifica degli oneri se dovuti;
...
|---|---|---|
| Atto introduttivo | Domanda, parti, questioni, rito | Deposito, dati, iscrizione, registro |
| Documenti allegati | Rilevanza per la causa | Acquisizione e ordinamento nel fascicolo |
| Termine o data | Punto di attenzione per la scheda | Scadenza o adempimento da tracciare |
...
### Depositi, costituzione e alimentazione del fascicolo
Dopo l'avvio, il fascicolo viene alimentato. Entrano difese, memorie, documenti, istanze, provvedimenti e comunicazioni. Il candidato deve imparare a vedere il fascicolo come un organismo in movimento.

La costituzione delle parti e i depositi successivi hanno due effetti:

1. arricchiscono il contenuto giuridico e documentale del fascicolo;
2. generano controlli e aggiornamenti per l'ufficio.

L'UPP deve chiedersi:

- quali difese sono state proposte?
- quali eccezioni o questioni emergono?
- quali documenti sono centrali?
- quali atti sono ripetitivi o accessori?
- quale materiale serve per l'udienza o per il provvedimento?

La cancelleria deve presidiare:

- corretta acquisizione del deposito;
...
|---|---|---|
| Prima | Ruolo, fascicoli, comunicazioni, stato del procedimento | Scheda udienza, cronologia, questioni, ricerca |
...
| Ambito | Cosa cambia per l'ufficio |
|---|---|
...
Le impugnazioni vanno lette come apertura di una fase successiva. Per la cancelleria possono comportare iscrizione, fascicolo, comunicazioni, trasmissioni o adempimenti. Per l'UPP possono richiedere scheda sul provvedimento impugnato, motivi, questioni, precedenti e stato del fascicolo.

Anche qui vale il limite: non studiare l'impugnazione come se dovessi scrivere un ricorso. Studiala come flusso che l'ufficio deve riconoscere.
...
- l'UNEP svolge un ruolo autonomo per notificazioni ed esecuzioni;
- le spese e i contributi possono diventare rilevanti;
- le opposizioni possono riportare questioni davanti al giudice.
...
|---|---|---|
| B - Bando | Il programma parla di processo civile, UPP, cancelleria o PCT? | Capisco il livello richiesto |
| A - Aree | Quali aree collego? | Ordinamento giudiziario, procedura civile, cancelleria, digitale, UNEP |
| N - Nuclei | Quali parole non posso sbagliare? | Atto, iscrizione, ruolo, fascicolo, deposito, comunicazione, notificazione, udienza, provvedimento |
...
> In un ufficio civile viene depositato un atto introduttivo. Il fascicolo viene iscritto, sono presenti documenti allegati e viene fissata udienza. Il candidato deve spiegare quali passaggi interessano cancelleria e UPP.
...
|---|---|
| Atto introduttivo | Avvia o alimenta il procedimento secondo il rito |
| Iscrizione | Consente tracciamento e organizzazione nel registro/ruolo |
| Fascicolo | Raccoglie atti, documenti, provvedimenti e dati |
...
> In una simulazione orale il candidato dice: "La cancelleria notifica sempre tutti gli atti del processo civile". Il commissario chiede di correggere.

La risposta deve essere prudente. Non bisogna reagire con un elenco rigido. Bisogna distinguere.
...
| Regola pratica | Verificare chi deve attivarsi, quale atto, quale destinatario e quale mezzo |
...
- La cancelleria presidia registri, ruolo, fascicolo, comunicazioni, dati e servizi.
- L'UPP prepara schede, cronologie, ricerche e materiali utili al magistrato, senza decidere.
- Comunicazione, notificazione, deposito e termine non sono sinonimi: sono punti di controllo diversi.
- Riforma civile, correttivo 2024 e PCT vanno studiati sul testo vigente, evitando numeri o formule non verificati.
...
Se la tua risposta non collega queste parole, manca il taglio UPP-cancelleria.

### Mini-esercizio
Leggi l'estratto sintetico:

> Una causa civile viene iscritta a ruolo. Nel fascicolo sono presenti atto introduttivo, documenti, difese e un provvedimento di fissazione udienza. Prima dell'udienza emerge un dubbio su una comunicazione e su un termine.
...
- Fase del flusso: causa iscritta, fascicolo alimentato, udienza da preparare.
- Atti da individuare: atto introduttivo, difese, documenti, provvedimento di fissazione.
- Controllo di cancelleria: ruolo, fascicolo, stato comunicazioni, dati e scadenze.
- Supporto UPP: scheda fascicolo, cronologia, questioni, ricerca mirata sul termine.
...
- So descrivere una causa civile come flusso d'ufficio?
- So collegare atto introduttivo, iscrizione, fascicolo e ruolo?
- So distinguere deposito, comunicazione, notificazione e termine?
- So spiegare cosa fa la cancelleria e cosa prepara l'UPP?
