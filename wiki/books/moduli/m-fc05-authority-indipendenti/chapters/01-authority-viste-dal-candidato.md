...
last_compiled_from: ["wiki/books/vol-05-authority-regolazione/index.md", "wiki/sources/vol-05-bandi-authority-2022-2025.md", "wiki/sources/authority-indipendenti-leggi-istitutive.md", "wiki/topics/authority-indipendenti-regolazione.md", "wiki/entities/agcm.md", "wiki/entities/arera.md", "wiki/entities/agcom.md", "wiki/entities/consob.md"]
asset_refs:
  - "books/moduli/m-fc05-authority-indipendenti/assets/chapter-01/01-mappa-bando-authority.png"
  - "books/moduli/m-fc05-authority-indipendenti/assets/chapter-01/02-authority-settori-poteri.png"
...
![Figura 1.1 — Mappa BANDO delle authority: dal bando al percorso di studio, fino all'output da allenare.](../assets/chapter-01/01-mappa-bando-authority.png)
...
![Figura 1.3 — Percorsi G, E e P: priorità, linguaggi e rischi di studio per i tre profili del modulo.](../assets/chapter-01/03-percorsi-g-e-p.png)
...
![Figura 1.4 — Bando Decoder M-FC05: campi essenziali per ordinare ente, profilo, materie, rischi e output.](../assets/chapter-01/05-bando-decoder-authority.png)
