...
draft_stage: ready-for-chapter-planning
module_code: M-SA02
...
### Obiettivo
Trasformare il Metodo BANDO in un percorso operativo per infermieri, ostetriche, fisioterapisti, TPALL e OSS. L'OSS è un sub-verticale distinto, confermato da sei bandi, ancora subordinato a fonti tecniche e regionali controllate.
...
### Fonti e gate prima della scrittura
...
- [[sources/bandi-rappresentativi-m-sa02-professioni-sanitarie-2025-2026|Corpus di 16 bandi M-SA02]].
- [[sources/bandi-rappresentativi-oss-2025-2026|Cluster di 6 bandi OSS]].
- [[sources/sicurezza-terapia-triage-assistenza-infermieristica-ministero|Sicurezza infermieristica, terapia e triage]].
- [[sources/iss-snlg-gravidanza-fisiologica-2023-2026|Gravidanza fisiologica ISS-SNLG]] e [[sources/sicurezza-travaglio-parto-morte-materna-ministero|sicurezza del parto]].
- [[sources/riabilitazione-fisioterapia-iss-ministero|Riabilitazione e fisioterapia, inclusi esercizio e lombalgia]].
- [[sources/epidemiologia-base-iss|Epidemiologia di base ISS]].
- [[sources/sorveglianza-passi-protocollo-operativo-iss|Protocollo operativo PASSI]].
- [[sources/programmi-screening-oncologici-dati-passi-iss|Screening oncologici e dati PASSI]].
- [[sources/premal-definizioni-caso-risposta-segnale-epidemiologico|PREMAL, definizioni di caso e risposta al segnale]].
- [[sources/territorio-cot-continuita-pdta-persona-fragile-toscana|COT, continuità ospedale-territorio e PDTA della persona fragile in Toscana]].
- [[books/moduli/m-sa02-professioni-sanitarie/planning/08-pacchetto-esercizi-pico-grade-applicabilita|Pacchetto di cinque esercizi PICO/GRADE/EtD/applicabilità]].
- [[books/moduli/m-sa02-professioni-sanitarie/planning/04-scenario-risposta-segnale-epidemiologico|Scenario epidemiologico completo con griglia]].
- [[sources/tpall-aia-campionamenti-acque-aria-suolo-rifiuti-alimenti|AIA e campionamenti TPALL multiprocedurali]].
- [[sources/tpall-emissioni-convogliate-bat-ael-metodi-snpa-arpa|Emissioni convogliate, BAT-AEL, odori e repertori SNPA/ARPA]].
- [[sources/lesioni-da-pressione-linea-guida-snlg-protocolli-regionali|Lesioni da pressione e procedure infermiere/OSS]].
- [[sources/deterioramento-clinico-news2-sepsi-regioni|NEWS2, deterioramento clinico e sepsi]].
- [[sources/als-adulto-erc-irc-2025|ALS adulto ERC 2025, traduzione e adattamento IRC]].
- [[sources/assistenza-generale-oss-pasto-mobilizzazione-eliminazione|Assistenza al pasto, rischio da movimentazione e gestione del catetere]].
- [[sources/ausili-trasferimento-oss-manuali-dispositivo-veneto-2026|Laboratori OSS Veneto 2026 e manuali Birdie EVO/Universal Slings]].
- [[sources/puerperio-neonato-supporto-vitale-oms-irc-iss|Puerperio, cure neonatali, NLS e sorveglianza ISS 0-2 anni]].
- [[sources/emergenze-ostetriche-eclampsia-sepsi-tromboembolia-itoss|Eclampsia, sepsi materna e tromboembolismo ISS-ItOSS]].
...
## Testo editoriale
I capitoli 01, dedicato alla mappa dei profili, dei requisiti e delle prove, 03, dedicato ad autonomia, responsabilità e deontologia, 04, dedicato ad assistenza infermieristica, tecniche assistenziali e supporto OSS, 05, dedicato a valutazione clinica, triage, urgenza ed emergenza, 06, dedicato a prevenzione, continuità assistenziale e presa in carico, 07, dedicato a evidenze scientifiche, PICO, GRADE e applicabilità, 08, dedicato a igiene pubblica, epidemiologia, sorveglianza e screening, e 09, dedicato a controlli TPALL, verbalizzazione, campionamento e sanzioni, hanno completato il ciclo della fase C, dagli step 08-12. Il target 10 è dichiarato nella scheda pipeline e resta da scrivere. Le cinque review `REV-OSS`, `REV-OST`, `REV-FIS`, `REV-EPI` e `REV-TPA` restano aperte e obbligatorie allo step 15 prima del congelamento editoriale.
