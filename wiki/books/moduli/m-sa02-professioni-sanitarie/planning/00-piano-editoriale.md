...
## Testo editoriale
I capitoli 01, dedicato alla mappa dei profili, dei requisiti e delle prove, 03, dedicato ad autonomia, responsabilità e deontologia, 04, dedicato ad assistenza infermieristica, tecniche assistenziali e supporto OSS, e 05, dedicato a valutazione clinica, triage, urgenza ed emergenza, hanno completato il ciclo della fase C, dagli step 08-12. I cinque target 06-10 sono dichiarati nella scheda pipeline e restano da scrivere. Le cinque review `REV-OSS`, `REV-OST`, `REV-FIS`, `REV-EPI` e `REV-TPA` restano aperte e obbligatorie allo step 15 prima del congelamento editoriale.
