---
id: chapter-m-fl02-01-il-sistema-territoriale-multilivello
type: book_chapter
title: "Il sistema territoriale multilivello"
status: revised_draft
domain: "concorsi pubblici italiani"
topics: ["regioni e governo locale", "enti territoriali", "sussidiarieta", "funzioni locali", "metodo bando"]
entities: ["Regione", "Provincia", "Citta metropolitana", "Comune", "Stato"]
source_refs: ["sources/costituzione-repubblica-italiana-testo-vigente.md", "sources/d-lgs-18-agosto-2000-n-267-enti-locali.md", "sources/legge-56-2014-province-citta-metropolitane.md", "sources/bandi-inpa-vol-02-campione-2026.md", "sources/vol-02-dossier-redazionale-enti-locali-polizia-locale.md"]
book_refs: ["m-fl02-regioni-province-citta-metropolitane", "vol-02-enti-locali-polizia-locale", "il-metodo-bando"]
asset_refs:
  - "books/moduli/m-fl02-regioni-province-citta-metropolitane/assets/chapter-01/01-mappa-bando-sistema-multilivello.png"
  - "books/moduli/m-fl02-regioni-province-citta-metropolitane/assets/chapter-01/02-architettura-stato-regione-area-vasta-comune.png"
  - "books/moduli/m-fl02-regioni-province-citta-metropolitane/assets/chapter-01/03-sussidiarieta-differenziazione-adeguatezza.png"
  - "books/moduli/m-fl02-regioni-province-citta-metropolitane/assets/chapter-01/04-catena-avviso-regionale-comuni.png"
  - "books/moduli/m-fl02-regioni-province-citta-metropolitane/assets/chapter-01/05-area-vasta-funzione-atto.png"
confidence: 0.88
...
last_compiled_from: ["wiki/books/vol-02-enti-locali-polizia-locale/front-matter/06-indice.md", "wiki/books/moduli/m-fl02-regioni-province-citta-metropolitane/index.md", "wiki/sources/costituzione-repubblica-italiana-testo-vigente.md", "wiki/sources/legge-56-2014-province-citta-metropolitane.md", "wiki/topics/regioni-e-governo-locale.md"]
---
...
![Figura 18.1 - Mappa BANDO del sistema multilivello: dal bando al livello competente, fino ad atto, controllo e output.](../assets/chapter-01/01-mappa-bando-sistema-multilivello.png)
...
![Figura 18.2 - Architettura territoriale multilivello: Stato, Regione, area vasta e Comune non sono una gerarchia semplice.](../assets/chapter-01/02-architettura-stato-regione-area-vasta-comune.png)
...
![Figura 18.3 - Tre principi per allocare le funzioni: sussidiarietà, differenziazione e adeguatezza decidono la scala.](../assets/chapter-01/03-sussidiarieta-differenziazione-adeguatezza.png)
...
![Figura 18.4 - Catena di un avviso regionale: programma, avviso, beneficiario, attuazione, rendicontazione e monitoraggio.](../assets/chapter-01/04-catena-avviso-regionale-comuni.png)
...
![Figura 18.5 - Area vasta, funzione e atto: Province e Città metropolitane governano funzioni sovracomunali.](../assets/chapter-01/05-area-vasta-funzione-atto.png)
...
A. I diversi livelli territoriali sono autonomi nei limiti dell’ordinamento e operano secondo competenze e funzioni differenziate.  
B. Regione, Provincia e Comune sono uffici periferici dello Stato.  
C. Tutti gli enti territoriali esercitano le stesse funzioni su scale diverse.  
D. La Regione è sempre gerarchicamente sovraordinata agli enti locali.

**Risposta corretta: A.** Autonomia non significa indipendenza, ma nemmeno inserimento in una catena gerarchica ordinaria. Occorre individuare la fonte, la competenza, la funzione e gli strumenti di coordinamento applicabili. Le altre risposte cancellano proprio le differenze che il candidato deve riconoscere.
...
B. se l’organo politico approva ogni atto;  
C. se l’ente dispone della scala e della capacità necessarie per esercitare efficacemente la funzione;  
D. se il servizio è vicino al cittadino.

**Risposta corretta: C.** La vicinanza è importante nella sussidiarietà, ma non basta. L’adeguatezza obbliga a confrontare compito, dimensione territoriale, mezzi e capacità organizzativa. Una funzione sovracomunale può richiedere coordinamento o una scala più ampia anche quando produce effetti immediati sui cittadini.
...
A. errato, perché la legge n. 56/2014 ne ha riordinato assetto e funzioni senza eliminarle dall’ordinamento;  
B. corretto per effetto della legge n. 56/2014;  
C. corretto soltanto nelle Regioni ordinarie;  
D. corretto se esiste una Città metropolitana.

**Risposta corretta: A.** La formula dell’abolizione è una tipica trappola concorsuale. La disciplina vigente va letta come riordino degli enti di area vasta. La presenza di una Città metropolitana non autorizza generalizzazioni su tutte le Province o su ogni territorio.

### Quiz 6

In un caso sulla mobilità che interessa numerosi Comuni, quale ragionamento è più solido?

A. Occorre individuare scala del problema, funzioni attribuite, soggetti coinvolti, atti di pianificazione e coordinamento e disciplina applicabile.  
B. La competenza è sempre del singolo Comune perché il servizio raggiunge i cittadini.  
C. La competenza è sempre statale perché la mobilità è una materia unitaria.  
D. È sufficiente nominare la sussidiarietà.

**Risposta corretta: A.** I principi non sostituiscono l’analisi. Bisogna applicarli alla dimensione dei flussi e verificare la disciplina della funzione. Una risposta valida distingue pianificazione, gestione, finanziamento e controllo, senza attribuire automaticamente tutto a un solo livello.
