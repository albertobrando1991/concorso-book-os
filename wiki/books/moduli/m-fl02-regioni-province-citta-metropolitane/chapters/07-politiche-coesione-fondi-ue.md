---
id: chapter-m-fl02-07-politiche-coesione-fondi-ue
type: book_chapter
title: "Politiche di coesione e fondi UE"
status: revised_draft
domain: "concorsi pubblici italiani"
topics: ["politiche di coesione", "fondi UE", "programmazione regionale", "OpenCoesione", "FESR", "FSE+", "FSC", "metodo bando"]
entities: ["Regione", "OpenCoesione", "Autorita di Gestione", "Comitato di sorveglianza", "Ragioneria generale dello Stato", "Beneficiario"]
source_refs: ["sources/politiche-coesione-2021-2027-programmi-regionali.md", "sources/pagamenti-tracciabilita-contratti-pnrr-rendicontazione.md", "sources/pnrr-regis-dnsh-monitoraggio-territoriale.md", "sources/bandi-inpa-vol-02-campione-2026.md"]
book_refs: ["m-fl02-regioni-province-citta-metropolitane", "vol-02-enti-locali-polizia-locale", "il-metodo-bando"]
confidence: 0.88
updated_at: 2026-07-20T12:35:00+02:00
...
last_compiled_from: ["wiki/books/moduli/m-fl02-regioni-province-citta-metropolitane/index.md", "wiki/books/moduli/m-fl02-regioni-province-citta-metropolitane/chapters/05-programmazione-bilancio-controlli-regionali.md", "wiki/books/moduli/m-fl02-regioni-province-citta-metropolitane/chapters/06-tecnica-legislativa-air-vir-drafting.md", "wiki/sources/politiche-coesione-2021-2027-programmi-regionali.md", "wiki/sources/pagamenti-tracciabilita-contratti-pnrr-rendicontazione.md", "wiki/sources/pnrr-regis-dnsh-monitoraggio-territoriale.md"]
---

# Politiche di coesione e fondi UE

## Specifica struttura madre

### Obiettivo
Spiegare le politiche di coesione in chiave regionale e concorsuale, collegando programma, avviso, beneficiario, progetto, spesa, monitoraggio, controlli e rendicontazione.

### Nuclei
- Programmazione 2021-2027 e ruolo dei Programmi regionali.
- Fondi strutturali, cofinanziamento nazionale, risorse nazionali di coesione e confine con FSC.
- Regione come amministrazione che programma, seleziona, attua, controlla, monitora e rendiconta.
- Avvisi, beneficiari, operazioni, spese ammissibili, indicatori, CUP, tracciabilità e documenti.
- OpenCoesione, Sistema Nazionale di Monitoraggio e trasparenza sull'attuazione.
- Confini con il futuro volume specialistico su appalti, PNRR e fondi UE.

### Output operativo
Catena programma-avviso-beneficiario-controllo; caso su contributo finanziato da fondi UE; check-list documentale; risposta orale su programma, progetto e rendicontazione.
...
## Scheda di lavoro
Il capitolo evita due estremi. Non deve diventare una spiegazione politica generica della coesione europea, ma non deve nemmeno trasformarsi in un manuale specialistico di europrogettazione. Nel modulo M-FL02 il valore concorsuale sta nella catena amministrativa: programma, priorità, azione, avviso, beneficiario, operazione, spesa, indicatore, monitoraggio, controllo, rendicontazione.

Il capitolo precedente ha spiegato che una politica regionale deve stare dentro programmazione, bilancio e controlli. Questo capitolo aggiunge la variabile coesione: quando le risorse arrivano da Programmi regionali FESR, FSE+, plurifondo o da risorse nazionali di coesione, l'ufficio deve ragionare in termini di vincolo di destinazione, ammissibilità della spesa, selezione trasparente, tracciabilità, monitoraggio e conservazione delle evidenze.

## Testo editoriale

### Apertura editoriale
Nei concorsi regionali, le politiche di coesione compaiono spesso senza essere nominate in modo diretto. La traccia parla di avviso pubblico, contributo alle imprese, formazione, occupazione, digitalizzazione dei Comuni, infrastrutture territoriali, rigenerazione urbana, interventi per aree interne, progetti sociali, capacità amministrativa, monitoraggio, rendicontazione o OpenCoesione. Dietro quelle parole può esserci un Programma regionale finanziato da fondi europei o da risorse nazionali di coesione.
...
1. spiegare che cosa sono le politiche di coesione in chiave concorsuale;
2. distinguere Accordo di Partenariato, Programma, priorità, azione, avviso e operazione;
3. riconoscere il ruolo regionale come Autorità di Gestione o amministrazione titolare/attuatrice secondo il programma;
4. collegare FESR, FSE+, programmi plurifondo, JTF, FSC e cofinanziamento senza confonderli;
5. impostare la procedura di un avviso regionale finanziato da fondi di coesione;
6. controllare beneficiari, spese ammissibili, indicatori, CUP, tracciabilità e documentazione;
7. spiegare monitoraggio, OpenCoesione e Sistema Nazionale di Monitoraggio;
8. costruire una risposta orale o una scheda pratica su programma-avviso-progetto-controllo.

Il capitolo resta manualistico. I dettagli avanzati su regolamenti UE, audit, appalti complessi, aiuti di Stato, costi semplificati, rendicontazione analitica e piattaforme operative appartengono a moduli specialistici dedicati.

### Come usare questo capitolo
Quando in una traccia compaiono fondi UE o coesione, non partire dalla sigla. Parti dalla catena.
...
| Monitoraggio | Quali dati dimostrano avanzamento e risultati? | CUP, indicatori, cronoprogramma, importi, stati. |
| Controllo | Chi verifica e con quali documenti? | Controlli amministrativi, rendicontazione, revoca/recupero. |

Questa tabella è la tua mappa rapida per scritto, orale e caso pratico.

### Mappa BANDO del capitolo

| Lettera | Domanda | Applicazione |
|---|---|---|
| B - Bando | Il profilo cita fondi UE, coesione, programmi regionali, PNRR, progetti, monitoraggio o rendicontazione? | Attiva la catena programma-avviso-progetto-controllo. |
| A - Aree | Quali materie entrano? | Ordinamento regionale, procedimento, bilancio, contratti, contabilità, trasparenza, controlli. |
| N - Nuclei | Quali concetti non posso confondere? | Programma/progetto, beneficiario/destinatario, spesa/importo concesso, monitoraggio/rendicontazione. |
| D - Diario | Quali errori devo segnare? | Sigle senza funzione, avviso senza programma, spesa senza ammissibilità, controllo solo contabile. |
| O - Output | Che cosa devo produrre? | Scheda catena, nota istruttoria, check-list documentale, risposta orale. |
...
- stipulare convenzioni o atti di concessione;
- controllare spese e risultati;
...
1. quadro europeo e regolamenti;
2. Accordo di Partenariato;
3. Programmi nazionali e regionali;
4. priorità e obiettivi specifici;
5. azioni;
6. avvisi o procedure attuative;
...
- monitoraggio, indicatori e rendicontazione;
...
- Programma: PR FSE+ regionale.
- Avviso: percorsi formativi per giovani disoccupati.
...
- Programma: PR FESR regionale.
- Avviso: efficientamento energetico degli edifici comunali.
- Beneficiario: Comune.
- Destinatari: utenti degli edifici e comunità locale.
...
- Programma e azione;
- avviso e atto di concessione;
- periodo di ammissibilità;
- categoria di costo prevista;
- documentazione richiesta;
- regole di tracciabilità e pagamento;
- eventuale procedura di affidamento;
...
- fatture o documenti equivalenti;
- pagamenti;
- quietanze;
- rendicontazione;
- controlli.
...
| Dimensione | Domanda |
|---|---|
| Finanziaria | Quante risorse sono programmate, impegnate, spese e pagate? |
...
Una Regione che gestisce programmi deve raccogliere dati dai beneficiari, validarli secondo le regole applicabili e alimentarli nei sistemi di monitoraggio. Per il ciclo 2021-2027, la fonte consolidata richiama il ruolo di ReGiS nel Sistema Nazionale di Monitoraggio della coesione. Il capitolo 08 sviluppera ReGiS in dettaglio per il PNRR; qui basta capire che monitoraggio significa dati strutturati, non relazione narrativa.
...
1. mostra che le politiche di coesione sono verificabili a livello di progetto;
2. collega risorse programmate, spese, localizzazione, soggetti, tempi, realizzazioni e pagamenti;
3. trasforma trasparenza e monitoraggio in strumenti di controllo pubblico.
...
- il progetto approvato è stato realizzato?
- le spese sono ammissibili?
- i documenti sono completi?
- i pagamenti sono tracciabili?
- gli indicatori sono alimentati?
- eventuali modifiche sono state autorizzate o comunicate secondo regole?

Documenti tipici:

- domanda e progetto approvato;
- atto di concessione;
- convenzione o disciplinare;
- CUP e, se presenti affidamenti, CIG;
- determina o atto di affidamento;
- contratti, ordini, incarichi;
- fatture o documenti equivalenti;
- mandati, bonifici, quietanze;
...
|---|---|
| Contributo a Comune | Avviso, atto di concessione, CUP, progetto, spese, affidamenti eventuali, rendicontazione. |
| Contributo a impresa | Requisiti, regime di aiuto se applicabile, spese ammissibili, pagamento, obblighi e controlli. |
| Appalto regionale | Programmazione, copertura, CIG, procedura, contratto, esecuzione, pagamento. |
| Progetto FSE+ | Accreditamento, destinatari, registri, ore, output formativi, costi e indicatori. |

Per gli aspetti avanzati sugli aiuti di Stato e sugli appalti si rinvia ai moduli specialistici. Qui basta riconoscere il problema.

### Accordi per la coesione e risorse nazionali
Le politiche di coesione non sono fatte solo di fondi strutturali europei. Le risorse nazionali, in particolare il Fondo per lo sviluppo e la coesione, hanno un peso rilevante e seguono strumenti propri. Gli Accordi per la coesione collegano risorse nazionali, interventi o linee di azione, cronoprogrammi, responsabilità, impegni e sistema di gestione e controllo.

Per il candidato, la cautela è questa: se la traccia parla di FSC o Accordo per la coesione, non rispondere come se fosse automaticamente FESR o FSE+. Usa la stessa logica amministrativa generale, ma cambia la fonte finanziaria.

Catena FSC semplificata:

1. assegnazione e quadro nazionale;
2. Accordo per la coesione;
3. piano finanziario;
4. interventi o linee di azione;
5. cronoprogrammi;
6. responsabilità delle amministrazioni;
7. sistema di gestione e controllo;
...
> La Regione promuove interventi di sviluppo territoriale mediante le risorse europee disponibili.

Perché è debole? Non dice quali risorse, per quale programma, per quali beneficiari, con quali criteri, spese, obblighi, atti e controlli.

Formula più professionale in una nota tecnica:

> La misura deve essere attuata mediante avviso pubblico coerente con il Programma regionale di riferimento, indicando beneficiari, interventi ammissibili, dotazione finanziaria, criteri di selezione, obblighi di tracciabilità, indicatori, modalità di rendicontazione, controlli e cause di revoca.
...
|---|---|---|
| Accordo/strategia | Quadro di coerenza europeo-nazionale. | Da dove nasce la priorità? |
...
Se una risposta non contiene almeno programma, beneficiario, operazione, spesa, monitoraggio e controllo, probabilmente è incompleta.

### Caso guidato: contributo regionale a un Comune
Traccia: una Regione pubblica un avviso PR FESR per finanziare interventi di efficientamento energetico di edifici comunali. Indicare i passaggi amministrativi principali e i controlli.

Risposta debole:

> La Regione pubblica il bando, valuta le domande e paga il contributo.

Risposta professionale:

| Fase | Controllo |
|---|---|
| Programma | Verificare coerenza con PR FESR, priorità e azione. |
| Avviso | Indicare dotazione, beneficiari, interventi, spese ammissibili, criteri e termini. |
| Domanda | Controllare requisiti del Comune, progetto, CUP, quadro economico e cronoprogramma. |
| Istruttoria | Applicare criteri in modo trasparente e documentato. |
| Concessione | Formalizzare importo, obblighi, tempi, rendicontazione, revoche. |
| Esecuzione | Verificare affidamenti, eventuali CIG, contratti, SAL, varianti. |
| Rendicontazione | Controllare fatture, pagamenti, tracciabilità, output, indicatori. |
| Monitoraggio | Alimentare dati finanziari, fisici e procedurali. |
| Chiusura | Erogare saldo, registrare esito, conservare documenti, gestire eventuali recuperi. |
...
- indicatori di partecipazione e risultato;
- documentazione di spesa o output richiesti;
- controlli su realizzazione effettiva;
- eventuali revoche o riduzioni per irregolarità.
...
| Fase | Domanda | Documento o dato |
|---|---|---|
| 1. Risorsa | UE, nazionale o cofinanziata? | FESR, FSE+, JTF, FSC, cofinanziamento. |
| 2. Programma | Quale quadro finanzia? | Programma regionale/nazionale, priorità, azione. |
| 3. Selezione | Come scelgo beneficiari e progetti? | Avviso, criteri, graduatoria, concessione. |
| 4. Attuazione | Che cosa viene realizzato? | Operazione, CUP, cronoprogramma, affidamenti. |
| 5. Spesa | Che cosa viene pagato? | Fatture, pagamenti, giustificativi, ammissibilità. |
| 6. Dati | Come misuro avanzamento? | Indicatori, stati, importi, localizzazione. |
| 7. Controllo | Come chiudo correttamente? | Rendicontazione, verifiche, saldo, revoca o recupero. |
...
1. quale Programma finanzia la misura;
2. quale priorità o azione viene attivata;
3. quale avviso seleziona beneficiari e operazioni;
4. quali spese sono ammissibili;
5. quali documenti dimostrano pagamenti e risultati;
6. quali dati alimentano monitoraggio e OpenCoesione;
...
| Elemento | Misura FSE+ | Misura FESR |
|---|---|---|
| Programma |  |  |
| Beneficiario |  |  |
| Destinatari finali |  |  |
...
| Elemento | Misura FSE+ | Misura FESR |
|---|---|---|
| Programma | PR FSE+ regionale. | PR FESR regionale. |
...
| OpenCoesione trattato come gestionale interno. | Scrivo che la Regione gestisce tutto su OpenCoesione. | OpenCoesione è portale di dati e trasparenza; gestione e monitoraggio seguono sistemi e regole applicabili. |

### Checklist finale
Prima di consegnare una risposta su politiche di coesione e fondi UE, verifica:

- ho distinto fondi europei, cofinanziamento nazionale e risorse nazionali di coesione?
- ho indicato il Programma di riferimento, anche in forma generale?
- ho collegato priorità, azione, avviso e operazione?
- ho distinto beneficiario, destinatario finale e soggetto attuatore?
- ho indicato spese ammissibili e vincolo di destinazione?
- ho richiamato CUP e CIG solo quando pertinenti e senza confonderli?
- ho previsto istruttoria, concessione, obblighi, controlli e revoca?
- ho distinto monitoraggio e rendicontazione?
- ho citato OpenCoesione come portale di trasparenza e dati, non come scorciatoia gestionale?
- ho collegato la misura a bilancio, tracciabilità, pagamenti e conservazione documentale?
- ho evitato dettagli specialistici non richiesti dal bando?
...
### Note di review
- Prima della pubblicazione finale verificare pagine ufficiali aggiornate del Dipartimento per le politiche di coesione, OpenCoesione, Accordo di Partenariato, Programmi regionali e Accordi per la coesione.
- Se il bando riguarda una Regione specifica, integrare solo fonti ufficiali locali: Programma regionale FESR/FSE+, manuale o sistema di gestione e controllo, avvisi tipo, calendario bandi, linee guida rendicontazione, pagine trasparenza e OpenCoesione.
- Per aiuti di Stato, costi semplificati, audit UE, appalti specialistici, verifiche climatiche e rendicontazione avanzata rinviare al volume specialistico su appalti, PNRR e fondi UE.
- Coordinare questo capitolo con il capitolo 08 su PNRR, ReGiS, DNSH e controlli, evitando duplicazioni sui dettagli tecnici di piattaforma.
