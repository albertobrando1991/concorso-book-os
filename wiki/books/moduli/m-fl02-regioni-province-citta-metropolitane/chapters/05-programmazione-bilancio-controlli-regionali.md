---
id: chapter-m-fl02-05-programmazione-bilancio-controlli-regionali
type: book_chapter
title: "Programmazione, bilancio e controlli regionali"
status: revised_draft
domain: "concorsi pubblici italiani"
topics: ["contabilita pubblica", "bilancio regionale", "programmazione regionale", "controlli regionali", "armonizzazione contabile", "metodo bando"]
entities: ["Regione", "Corte dei conti", "Ragioneria generale dello Stato", "Servizio sanitario regionale"]
...
last_compiled_from: ["wiki/books/moduli/m-fl02-regioni-province-citta-metropolitane/index.md", "wiki/books/moduli/m-fl02-regioni-province-citta-metropolitane/chapters/03-funzioni-regionali-rapporti-stato-enti-locali.md", "wiki/books/moduli/m-fl02-regioni-province-citta-metropolitane/chapters/04-procedimenti-atti-organizzazione-amministrativa-regionale.md", "wiki/books/il-metodo-bando/chapters/contabilita-pubblica-essenziale.md", "wiki/sources/armonizzazione-contabile-enti-territoriali-d-lgs-118-2011.md", "wiki/sources/principi-costituzionali-finanza-pubblica-art-81-97-119.md", "wiki/sources/decreto-legge-10-ottobre-2012-n-174-controlli-enti-territoriali.md", "wiki/sources/corte-conti-controlli-responsabilita-agenti-contabili.md", "wiki/topics/contabilita-pubblica.md", "wiki/entities/regione.md"]
---
...
> ogni politica regionale deve essere letta come catena: obiettivo, documento di programmazione, risorsa, atto, gestione, rendiconto, controllo.

Se manca un anello, la risposta è incompleta.
...
Quando una traccia M-FL02 contiene le parole programma, piano, avviso, contributo, fondo, trasferimento, rendiconto, parifica, controllo, copertura, equilibrio, bilancio o Corte dei conti, usa questa sequenza:

| Passaggio | Domanda guida | Output |
|---|---|---|
| Programmazione | Quale priorità pubblica vuole realizzare la Regione? | DEFR, piano, programma, atto di indirizzo. |
| Autorizzazione finanziaria | Esistono risorse e stanziamenti? | Bilancio di previsione, legge di bilancio, variazione. |
| Atto gestionale | Chi attua la scelta? | Determina, avviso, concessione, impegno. |
| Esecuzione | Come si realizza la spesa o il trasferimento? | Progetto, affidamento, convenzione, liquidazione. |
| Rendicontazione | Come si dimostrano spesa e risultato? | Documenti, giustificativi, indicatori, monitoraggio. |
| Controllo | Chi verifica regolarità ed equilibri? | Uffici interni, revisori o organi equivalenti, Corte dei conti. |

La domanda da tenere accanto al testo è:

> la Regione può finanziare, impegnare o pagare questa misura senza violare programmazione, copertura, vincoli, equilibri e controlli?
...
1. la politica pubblica viene definita in legge, programma, piano o atto di indirizzo;
2. la programmazione economico-finanziaria ne ordina priorità e compatibilità;
3. il bilancio autorizza entrate e spese secondo schemi armonizzati;
4. gli uffici adottano atti di gestione: accertamenti, impegni, avvisi, concessioni, liquidazioni;
...
> il bilancio regionale non crea da solo la politica pubblica, ma rende verificabile se quella politica può essere finanziata, gestita e controllata.
...
| Concetto | Domanda | Errore da evitare |
|---|---|---|
| Copertura finanziaria | Con quali mezzi si finanzia un nuovo o maggiore onere? | Pensare che basti indicare una finalità importante. |
| Equilibrio di bilancio | Il complesso di entrate, spese, vincoli e debito resta sostenibile? | Confonderlo con la copertura del singolo intervento. |
...
La risposta è: con schemi comuni, principi applicati, piano dei conti, competenza finanziaria potenziata, rendiconto e consolidamento.

Tre parole vanno spiegate senza tecnicismi eccessivi:
...
## N-FL02-05-03 · DEFR e programmazione regionale
...
> la misura proposta è coerente con le priorità strategiche e con la programmazione economico-finanziaria della Regione?

Esempio: se la Regione vuole finanziare interventi di mobilità sostenibile, non basta pubblicare un avviso. Bisogna verificare coerenza con programmazione regionale, risorse disponibili, settore competente, eventuali vincoli europei o nazionali, bilancio e strumenti attuativi.

Il DEFR ha quindi una funzione di orientamento:

- collega mandato politico e politiche pubbliche;
- ordina priorità e obiettivi;
- prepara il bilancio;
- aiuta il controllo strategico;
- consente di valutare coerenza tra dichiarazioni politiche e risorse.
...
## N-FL02-05-04 · Bilancio di previsione e gestione
...
- DEFR e relativa nota di aggiornamento, se prevista;
- legge di stabilità regionale;
- legge regionale di bilancio o bilancio di previsione;
- variazioni di bilancio;
- assestamento;
- rendiconto generale;
- bilancio consolidato;
- relazioni, allegati e prospetti previsti dalla disciplina armonizzata e regionale.

Il candidato non deve memorizzare ogni allegato. Deve capire le funzioni.

| Documento o atto | Funzione |
|---|---|
| DEFR | Orienta scelte strategiche e finanziarie. |
| Legge di stabilità regionale | Introduce disposizioni con effetti finanziari nel periodo di bilancio, secondo la disciplina vigente. |
| Bilancio di previsione | Autorizza entrate e spese e rende gestibile la programmazione. |
| Variazione | Adegua stanziamenti a esigenze sopravvenute. |
| Assestamento | Verifica generale e riallineamento delle previsioni. |
| Rendiconto generale | Dimostra i risultati della gestione. |
| Bilancio consolidato | Rappresenta il gruppo amministrazione pubblica regionale, ove previsto. |
...
| Fase | Domanda | Atto o attività |
|---|---|---|
| Indirizzo | Quale obiettivo pubblico? | DEFR, piano, programma, delibera. |
| Risorsa | Dove sono le somme? | Bilancio, capitolo/stanziamento, eventuale variazione. |
| Procedura | Come si selezionano destinatari o interventi? | Avviso, bando, convenzione, accordo. |
...
## N-FL02-05-05 · Fondi vincolati, risorse europee e perimetro sanitario
...
> una risorsa vincolata non è denaro libero.

Quando la Regione riceve o assegna risorse vincolate, occorre verificare:
...
- CUP se progetto di investimento;
- CIG se contratto o procedura di affidamento rilevante;
- cofinanziamento;
...
La prima è quantitativa: la sanità assorbe una quota molto rilevante della finanza regionale. La seconda è qualitativa: risorse, fabbisogni, vincoli, livelli di servizio, aziende sanitarie, controlli e rendicontazione richiedono particolare tracciabilità.

Il D.Lgs. 118/2011 contiene regole sulla trasparenza dei conti sanitari e sulla finalizzazione delle risorse al finanziamento dei singoli servizi sanitari regionali. Per il candidato M-FL02 il messaggio è questo:

> nel bilancio regionale la sanità richiede perimetrazione, confronto tra entrate e spese sanitarie, verifica delle risorse e controllo dei risultati.
...
## N-FL02-05-06 · Rendiconto, controlli e parifica
...
In base alla disciplina armonizzata, il rendiconto generale regionale rappresenta risultati finanziari, economici e patrimoniali secondo schemi comuni. Il candidato deve ricordare tre funzioni:

1. informativa: mostra come sono state gestite entrate e spese;
...
> Il rendiconto dimostra la gestione della Regione; il consolidato aiuta a leggere anche il sistema degli organismi collegati, secondo la disciplina applicabile.

### Controlli interni regionali
I controlli interni servono a evitare che la legalità finanziaria sia verificata solo alla fine. Ogni Regione disciplina la propria organizzazione dei controlli nel quadro delle fonti statali, regionali e dei principi generali.

Per il candidato, i controlli interni si possono ordinare così:
...
- verifica di equilibri, indebitamento e sostenibilità;
- attenzione a partecipate e risultati degli enti sanitari;
...
## N-FL02-05-07 · Responsabilità, metodo operativo e casi
...
Un danno erariale può derivare da spese senza titolo, pagamenti non dovuti, mancata riscossione, perdita di finanziamenti, irregolare rendicontazione, uso non conforme di fondi vincolati, controlli omessi, violazione di obblighi di tracciabilità o gestione antieconomica.

La responsabilità contabile riguarda chi maneggia denaro, beni o valori pubblici ed è collegata alla resa del conto. Il Codice di giustizia contabile disciplina i giudizi davanti alla Corte dei conti, ma in questo capitolo basta il livello concorsuale:

- controllo e responsabilità sono collegati, ma distinti;
- non ogni errore amministrativo è automaticamente danno erariale;
- non ogni dipendente è agente contabile;
...
| Fase | Documento/atto | Soggetto prevalente | Controllo |
|---|---|---|---|
| Indirizzo politico | Programma, piano, indirizzi di Giunta o Consiglio | Organi regionali secondo competenza | Coerenza con statuto, legge e funzioni. |
| Programmazione finanziaria | DEFR, nota di aggiornamento, programmi settoriali | Giunta e Consiglio secondo disciplina regionale | Coerenza strategica e finanziaria. |
...
> La Regione approva il bando, riceve le domande e finanzia i Comuni.

Risposta corretta:

| Fase | Che cosa verificare | Output |
|---|---|---|
| Programmazione | Coerenza con DEFR, programma regionale e priorità energetiche. | Atto di indirizzo o programma. |
| Risorse | Stanziamento, fonte finanziaria, vincoli, eventuale cofinanziamento. | Bilancio o variazione, capitolo/stanziamento. |
| Avviso | Beneficiari, interventi, spese ammissibili, criteri, termini, obblighi. | Determina o atto di approvazione avviso. |
| Domande | Documentazione dei Comuni, progetto, CUP se investimento. | Istruttoria. |
| Graduatoria/concessione | Applicazione criteri e assunzione obblighi. | Atto gestionale, eventuale impegno. |
| Erogazione | Anticipo, stati avanzamento, saldo secondo regole. | Liquidazioni e pagamenti. |
| Rendicontazione | Spese documentate, risultati, tempi, vincoli. | Controllo documentale e sostanziale. |
| Esito | Regolarità, revoca, riduzione o recupero se necessario. | Atto di chiusura o provvedimenti successivi. |
...
La risposta deve partire da copertura ed equilibrio.

Passaggi:

1. individuare se la proposta comporta nuovi o maggiori oneri;
2. quantificare gli oneri, distinguendo spesa una tantum e spesa ricorrente;
3. indicare mezzi di copertura attendibili;
4. verificare coerenza con bilancio e programmazione;
5. valutare effetti sugli esercizi futuri;
6. evitare coperture generiche o entrate incerte;
7. considerare il successivo controllo della Corte dei conti sulle coperture delle leggi regionali.
...
|---|---|---|
| 1. Politica pubblica | Quale bisogno territoriale vuole soddisfare la Regione? | Linea strategica, piano o programma. |
| 2. DEFR | La priorità entra nella programmazione economico-finanziaria? | Obiettivo e coerenza strategica. |
| 3. Bilancio | Sono autorizzate entrate e spese? | Legge di bilancio, stanziamenti, equilibri. |
| 4. Gestione | Chi attua e con quali atti? | Determina, avviso, impegno, concessione. |
| 5. Esecuzione | Come si realizzano interventi e pagamenti? | Progetto, CUP/CIG se rilevanti, liquidazione. |
| 6. Rendicontazione | Come si dimostrano spesa e risultati? | Giustificativi, indicatori, monitoraggio. |
| 7. Controllo | Chi verifica il ciclo? | Controlli interni, Corte dei conti, parifica. |
...
1. parti da DEFR e programmi;
2. verifica legge di bilancio e stanziamenti;
3. indica atti gestionali e impegni;
4. considera vincoli e beneficiari;
5. aggiungi liquidazione, pagamento e rendicontazione;
6. chiudi con rendiconto, consolidato, controlli interni e Corte dei conti.

### Mini-esercizio
Completa la tabella collegando atto, funzione e controllo.

| Atto o documento | Funzione | Controllo da ricordare |
|---|---|---|
| DEFR |  |  |
| Legge di bilancio regionale |  |  |
| Determina di approvazione avviso |  |  |
| Atto di concessione contributo |  |  |
...
| Atto o documento | Funzione | Controllo da ricordare |
|---|---|---|
| DEFR | Programmazione economico-finanziaria. | Coerenza con indirizzi e politiche regionali. |
| Legge di bilancio regionale | Autorizzazione finanziaria. | Copertura, equilibri, vincoli e sostenibilità. |
| Determina di approvazione avviso | Avvio gestionale della procedura. | Competenza, trasparenza, criteri e disponibilità risorse. |
| Atto di concessione contributo | Attribuzione del beneficio e assunzione obblighi. | Impegno, vincoli, beneficiari, condizioni. |
| Liquidazione del saldo | Pagamento dopo verifica. | Rendicontazione, documenti, regolarità della spesa. |
| Rendiconto generale regionale | Dimostrazione dei risultati della gestione. | Controlli interni, consiliari e Corte dei conti. |
| Decisione di parifica | Controllo esterno sul rendiconto. | Legittimità, regolarità, equilibri, efficacia ed efficienza. |
...
| Ignoro il Servizio sanitario regionale. | Parlo di bilancio regionale come se fosse comunale. | Ricordo perimetrazione e peso finanziario sanitario. |
| Vedo la Corte dei conti solo come giudice. | Non cito parifica o controlli sui bilanci. | Distinguo controllo, parifica e responsabilità. |
| Attribuisco tutto agli organi politici. | Non distinguo indirizzo e gestione. | Separo Consiglio/Giunta da direzioni e dirigenti. |
...
- So spiegare perché il Servizio sanitario regionale è centrale nei conti regionali.
...
A. La copertura riguarda il singolo nuovo onere, mentre l'equilibrio considera il complesso delle entrate, delle spese e dei relativi effetti nel tempo.  
B. Sono espressioni perfettamente equivalenti.  
C. La copertura riguarda soltanto il rendiconto.  
D. L'equilibrio interessa soltanto le entrate tributarie.

**Risposta corretta: A.** La copertura individua mezzi idonei rispetto a uno specifico onere; l'equilibrio valuta la sostenibilità complessiva dei conti. Una copertura formalmente indicata non elimina la necessità di verificare attendibilità, durata ed effetti sugli esercizi interessati.

### Quiz 2

**Qual è la funzione centrale dell'armonizzazione prevista dal D.Lgs. 118/2011?**

A. Rendere confrontabili e raccordabili i sistemi contabili mediante principi e schemi comuni.  
B. Sostituire ogni legge regionale di contabilità.  
C. Eliminare la contabilità finanziaria.  
D. Affidare alla Corte dei conti la gestione del bilancio.

**Risposta corretta: A.** L'armonizzazione costruisce un linguaggio contabile comune e favorisce consolidamento, trasparenza e coordinamento. Non cancella l'autonomia organizzativa regionale né trasferisce agli organi di controllo le funzioni gestionali.

### Quiz 3

**Dove si colloca il DEFR nel ciclo regionale?**

A. Nella programmazione economico-finanziaria che raccorda indirizzi e successivi documenti di bilancio.  
B. Soltanto nella fase di pagamento.  
C. Dopo la decisione di parifica.  
D. Tra gli atti propri dell'agente contabile.

**Risposta corretta: A.** Il DEFR esplicita il quadro e gli obiettivi della programmazione regionale. Per rispondere bene occorre collegarlo al bilancio e agli atti settoriali, non descriverlo come documento isolato.
...
A. Perché fonte, finalità, spese ammissibili, avanzamento e rendicontazione devono restare collegati.  
B. Perché può essere usato liberamente per ogni spesa regionale.  
C. Perché non entra mai nel bilancio.  
D. Perché esclude ogni controllo sul beneficiario.

**Risposta corretta: A.** Il vincolo limita l'impiego delle risorse e rende essenziale documentare l'intera catena. L'eventuale collegamento a fondi europei o PNRR può aggiungere obblighi specifici, che vanno verificati sulla fonte del finanziamento.

### Quiz 6

**Che cosa rappresenta la parifica del rendiconto regionale?**

A. Un momento del controllo esterno della Corte dei conti sul rendiconto generale regionale.  
B. L'approvazione di un avviso pubblico.  
C. Un controllo preventivo su ogni determinazione dirigenziale.  
D. Il giudizio di responsabilità contro ogni funzionario.

**Risposta corretta: A.** La parifica appartiene alla funzione di controllo sul rendiconto e non coincide con il giudizio di responsabilità amministrativo-contabile. Distinguere controllo e giurisdizione evita uno degli errori più frequenti nelle prove orali.
