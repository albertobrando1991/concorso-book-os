...
La quantità nasce dalle misure, non da una percentuale intuitiva. Se una parete misura 8 metri per 3 e presenta un'apertura da 2 metri quadrati, la superficie netta didattica è `8 × 3 − 2 = 22 m²`, salvo le specifiche regole di misurazione applicabili alla voce.
...
>
> Il computo metrico determina le quantità.  
> Il CME applica i prezzi unitari alle quantità.  
> L'elenco prezzi identifica voci e prezzi.  
...
L'art. 41 collega il costo di prodotti, attrezzature e lavorazioni ai prezzari aggiornati pertinenti e disciplina le fonti utilizzabili in loro mancanza. Per usare correttamente un prezzo occorre verificare edizione, territorio, data, unità e contenuto della voce.
...
Un prezzo reperito online senza provenienza non è una fonte. Anche un prezzario ufficiale può essere inappropriato se riguarda un altro territorio, un'altra edizione o una lavorazione diversa.
...
- aula A: `8 × 6 = 48 m²`;
- aula B: `7 × 5 = 35 m²`;
- quantità progettata: `83 m²`.

Con prezzo didattico di `40 unità monetarie/m²`, il CME espone `83 × 40 = 3.320 unità monetarie`.

Al primo rilievo risultano eseguiti e accettabili `50 m²`. Il libretto conserva misure e posizione; il registro applica il prezzo contrattuale; il SAL considera l'importo progressivo didattico di `50 × 40 = 2.000`.

Al rilievo successivo emergono altri `30 m²`. La quantità progressiva è `80 m²`, non `50 + 80`. L'importo progressivo è quindi `3.200`, mentre l'incremento del periodo è `1.200`. I `3 m²` residui restano fuori dall'avanzamento finché non sono eseguiti e contabilizzati.
...
Soluzione: `12 × 4 = 48 m²`; la quantità progressiva aggiornata è `40 m²`; l'importo progressivo didattico è `1.000`, mentre l'incremento è `250`.
