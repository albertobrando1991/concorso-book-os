...
| Sezione | Titolo |
|---|---|
| FM1 | Servizi digitali inclusi |
| FM2 | Frontespizio |
| FM3 | Copyright e note editoriali |
| FM4 | Sommario |
| FM5 | Premessa |
| FM6 | Indice |

Le sezioni FM1-FM6 compaiono una sola volta all'inizio del volume. Prima di ciascun modulo compare soltanto il frontespizio del modulo con il relativo sommario.

## Parte I - Entrare nei concorsi territoriali con il Metodo BANDO

1. **[[books/vol-02-enti-locali-polizia-locale/chapters/01-come-usare-vol-02-insieme-a-vol-01|Come usare VOL-02 insieme a VOL-01]]**
   - Cosa resta nel libro base e cosa si studia nel volume specialistico.
   - Mappa dei profili: amministrativo, contabile, tecnico, servizi, PL, regionale, area vasta e camerale.
   - Errori tipici: duplicare materie comuni, ignorare regolamenti locali, studiare senza output.

2. **[[books/vol-02-enti-locali-polizia-locale/chapters/02-bando-decoder-territoriale|Bando Decoder territoriale]]**
   - Dove leggere ente, profilo, area di inquadramento, prove, materie, allegati e atti richiesti.
   - Come riconoscere bandi comunali, regionali, provinciali, metropolitani, PL e camerali.
   - Griglia: materia comune, materia delta, fonte locale, output di prova, rinvio eventuale a VOL-09/10/11.

3. **[[books/vol-02-enti-locali-polizia-locale/chapters/03-piano-30-60-90-giorni-vol-02|Piano 30/60/90 giorni per VOL-02]]**
   - Percorso breve, medio e lungo.
   - Studio parallelo di VOL-01 e VOL-02.
   - Diario degli errori territoriale: atti, verbali, contabilità, servizi, prove fisiche e casi.

## Modulo M-FL01 - Comuni, Unioni e servizi comunali

Frontespizio e sommario del modulo: [[books/vol-02-enti-locali-polizia-locale/modules/01-m-fl01-frontespizio-sommario|M-FL01 - Comuni, Unioni e servizi comunali]]

4. **[[books/moduli/m-fl01-comuni-unioni/chapters/01-tuel-operativo-autonomia-organi-funzioni-comune|TUEL operativo: autonomia, organi e funzioni del Comune]]**
   - Comune, Unione di Comuni, organi politici e apparato gestionale.
   - Consiglio, giunta, sindaco, dirigenti e responsabili di servizio.
   - Schema organi-competenze-atti.

5. **[[books/moduli/m-fl01-comuni-unioni/chapters/02-statuto-regolamenti-autonomia-normativa-locale|Statuto, regolamenti e autonomia normativa locale]]**
   - Statuto comunale e regolamenti.
   - Regolamenti su uffici, procedimento, accesso, contabilità, tributi e polizia urbana.
   - Caso: quando una regola locale cambia l'istruttoria.

6. **[[books/moduli/m-fl01-comuni-unioni/chapters/03-organizzazione-comunale-uffici-servizi-gestioni-associate|Organizzazione comunale, uffici, servizi e gestioni associate]]**
   - Macrostruttura, settori, servizi, responsabili, segretario e posizioni di responsabilità.
   - Unioni, convenzioni, gestione associata e rapporti tra enti.
   - Mappa: ufficio competente, procedimento, atto e responsabilità.

7. **[[books/moduli/m-fl01-comuni-unioni/chapters/04-deliberazioni-determinazioni-decreti-ordinanze-pareri|Deliberazioni, determinazioni, decreti, ordinanze e pareri]]**
   - Differenza tra indirizzo politico e gestione.
   - Delibera, determina, decreto sindacale, ordinanza, parere e visto.
   - Laboratorio: costruire un atto locale essenziale.

8. **[[books/moduli/m-fl01-comuni-unioni/chapters/05-procedimento-locale-protocollo-albo-urp-accesso|Procedimento locale, protocollo, albo, URP e accesso]]**
   - Procedimento amministrativo dentro l'ente locale.
   - Protocollo, fascicolo, responsabile del procedimento, albo pretorio e amministrazione trasparente.
   - Accesso documentale, civico semplice e civico generalizzato nel contesto comunale.

9. **[[books/moduli/m-fl01-comuni-unioni/chapters/06-servizi-digitali-comunali-cad-anpr-gestione-documentale|Servizi digitali comunali, CAD, ANPR e gestione documentale]]**
   - Servizi digitali al cittadino, identità digitale, domicilio digitale, PEC e firma.
   - ANPR, fascicolo, conservazione, interoperabilità e privacy.
   - Caso guidato: istanza online, protocollo, dati personali e risposta dell'ufficio.

10. **[[books/moduli/m-fl01-comuni-unioni/chapters/07-servizi-demografici-elettorali|Servizi demografici ed elettorali]]**
    - Anagrafe, stato civile, elettorale, AIRE e certificazioni.
    - Dichiarazioni sostitutive, controlli, sportello e rapporti con ANPR.
    - Caso guidato: residenza, certificazione e aggiornamento dati.
...
12. **[[books/moduli/m-fl01-comuni-unioni/chapters/09-programmazione-integrata-comunale-dup-bilancio-peg-piao-performance|Programmazione integrata comunale: DUP, bilancio, PEG, PIAO e performance]]**
    ...
    - DUP, bilancio di previsione, PEG, PIAO e ciclo della performance.
    - Tavola raccordi: obiettivo, risorsa, responsabile, indicatore.

13. **[[books/moduli/m-fl01-comuni-unioni/chapters/10-gestione-finanziaria-rendiconto-tesoreria-controlli|Gestione finanziaria, rendiconto, tesoreria e controlli]]**
    - Impegno, liquidazione, ordinazione, pagamento, residui e rendiconto.
    - Tesoreria, revisione, controlli interni, equilibri e Corte dei conti.
    - Caso contabile: dal provvedimento alla spesa.

14. **[[books/moduli/m-fl01-comuni-unioni/chapters/11-entrate-tributi-locali-patrimonio-economato-riscossione|Entrate, tributi locali, patrimonio, economato e riscossione]]**
    - IMU, TARI, canone unico, entrate patrimoniali e riscossione locale.
    - Patrimonio, inventario, economato e agenti contabili.
    - Caso guidato: da un'entrata locale all'atto di gestione.

15. **[[books/moduli/m-fl01-comuni-unioni/chapters/12-procurement-operativo-ufficio-comunale|Procurement operativo dell'ufficio comunale]]**
    - Fabbisogno, affidamento, determina, CIG, piattaforme, esecuzione e controlli.
    - Differenza tra applicazione comunale e appalti specialistici.
    - Rinvio: VOL-09 per appalti, PNRR e procurement avanzato.

16. **Territorio, patrimonio, edilizia e lavori: interfaccia amministrativa**
    - SUE, SUAP, titoli edilizi, vigilanza, patrimonio e lavori pubblici essenziali.
    - Cosa deve sapere l'amministrativo non tecnico.
    - Rinvio: VOL-10 per urbanistica, edilizia e lavori pubblici avanzati.

17. **Laboratorio teorico-pratico per i quattro profili comunali**
    - Profili amministrativo, contabile, tecnico e servizi locali.
    - Delibera, determina, nota istruttoria, caso di sportello, caso contabile e caso servizi.
    - Diario errori: competenza, termine, fonte, atto, motivazione.

## Modulo M-FL02 - Regioni, Province e Città metropolitane

Frontespizio e sommario del modulo: [[books/vol-02-enti-locali-polizia-locale/modules/02-m-fl02-frontespizio-sommario|M-FL02 - Regioni, Province e Città metropolitane]]

18. **Il sistema territoriale multilivello**
    - Regione, Provincia, Città metropolitana, Comune e rapporti con lo Stato.
    - Autonomia, sussidiarietà, differenziazione e adeguatezza.
    - Bando Decoder regionale e di area vasta.

19. **Statuti, organi e organizzazione regionale**
    - Statuto regionale, Consiglio, Giunta, Presidente e amministrazione regionale.
    - Direzioni, strutture, agenzie e enti dipendenti.
    - Schema: organo, fonte, competenza, atto.

20. **Funzioni regionali e rapporti con Stato ed enti locali**
    - Riparto di competenze, leale collaborazione e conferenze.
    - Funzioni amministrative conferite e coordinamento territoriale.
    - Caso di competenza: chi decide, chi gestisce, chi controlla.

21. **Procedimenti, atti e organizzazione amministrativa regionale**
    - Deliberazioni, decreti, determinazioni, avvisi, bandi e atti di programmazione.
    - Procedimento regionale e rapporti con cittadini, imprese ed enti locali.
    - Output: risposta sintetica e schema atto.

22. **Programmazione, bilancio e controlli regionali**
    - Programmazione, bilancio, rendiconto, controlli e responsabilità.
    - Raccordo con D.Lgs. 118/2011 e principi contabili territoriali.
    - Tavola: ciclo finanziario regionale e documenti.
...
24. **Politiche di coesione e fondi UE**
    ...
    - OpenCoesione, programmi regionali e catena documentale.
    - Rinvio: VOL-09 per fondi UE/PNRR avanzati e procurement.

25. **PNRR territoriale, ReGiS, DNSH e controlli**
    - Progetto, milestone, target, monitoraggio, rendicontazione e controlli.
    - DNSH e responsabilità dell'ente attuatore.
    - Caso: leggere un intervento territoriale e ricostruire il flusso.

26. **Province e Città metropolitane dopo la L. 56/2014**
    - Organi, funzioni fondamentali, ruolo di coordinamento e area vasta.
    - Viabilità, edilizia scolastica, pianificazione e assistenza ai Comuni.
    - Differenze operative rispetto al Comune e alla Regione.

27. **Viabilità, edilizia scolastica, territorio ed espropri**
    - Funzioni tecniche di area vasta in chiave amministrativa.
    - Programmazione, autorizzazioni, procedimenti, espropri e contenzioso essenziale.
    - Rinvio: VOL-10 per tecnica infrastrutturale avanzata.

28. **Contratti, servizi pubblici locali e società partecipate**
    - Contratti e affidamenti territoriali, servizi pubblici locali e controllo analogo.
    - Società partecipate, governance, trasparenza e performance.
    - Rinvio: VOL-09 per appalti specialistici.

29. **Laboratorio per i quattro profili regionali e di area vasta**
    - Amministrativo regionale, legislativo, tecnico territorio, fondi UE/PNRR.
