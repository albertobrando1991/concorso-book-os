...
| E11 | Capp. 4-12 e apparato | Apparato normativo/bibliografico | Media | Audit P11: il lettore trova già mappe normative e riferimenti consolidati nei capitoli controllati; le etichette variano per funzione didattica, non per assenza di fonte. | Conservare l'apparato e ricontrollare solo vigenza e layout prima della stampa. | Risolto in P11 |
| E12 | Intero volume | Workflow editoriale | Media | Audit P12: il cartaceo principale usava nove valori di `draft_stage` pur restando integralmente in review. | Workflow canonico in tre stati e allineamento del cartaceo a `editorial-review`; passaggio a `publication-ready` solo dopo chiusura dei gate. | Risolto in P12 |
...
- Criticita: la source note e' stata riallineata nel follow-up P2; resta la certificazione giuridica articolo per articolo prima della pubblicazione.
